...
const BODIES: AnyBody[] = [
  ...
  { t: 'DeckReport', accepted: false, deckName: 'Kess', cardCount: 97, issues: ['Line 4: no card named "Sol Rng".'] },
  {
    ...
    session: {
      ...
      solve: { pool: EMPTY_POOL, poolSnow: EMPTY_POOL, poolRestricted: [], sources: [], lifeAvailable: 40, eventCount: 3 },
  ...
  },
  {
    ...
    session: {
      ...
      winners: [],
      legal: [],
      solve: { pool: EMPTY_POOL, poolSnow: EMPTY_POOL, poolRestricted: [], sources: [], lifeAvailable: 40, eventCount: 5 },
      seats: [],
      stateHash: 'h',
    },
    viewHash: 'vh2',
