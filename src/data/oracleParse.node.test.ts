...
describe.skipIf(!HAVE_DB)('bulk oracle ingest', () => {
  ...
  test('the measured coverage matches the numbers pinned in D32', () => {
    expect(report.warnings).toEqual({
      ...
      // End and kin.
      'effect:auto': 9869, // D559: the Transmute line leaves the spell text (10 texts read whole - out of partial); D557: the Conspire line leaves the spell text (14 texts read whole - out of partial); D556: the Replicate line leaves the spell text (21 texts read whole - out of partial); D555: the suspect clause reads (2 texts read whole - out of partial); D554: the goad clause reads (8 texts read whole; 14 out of none, 6 of them into partial); D552: the detain clause reads (2 texts read whole - one out of none, one out of partial); D550: the Split second line leaves the spell text (33 texts read whole, out of partial); D548: the Awaken line leaves the spell text (29 texts read whole, out of partial); D543: `Double the number of ... counters on ...` reads (4 texts read whole - 7 out of none, 3 of them into partial); D541: the Madness line leaves the spell text (66 texts read whole - 66 out of partial); D540: the Foretell line leaves the spell text (27 texts read whole - 27 out of partial); D539: `Learn.` reads as the optional rummage (10 texts read whole - 6 out of none, 4 out of partial); D538: the Rebound line leaves the spell text (53 texts read whole out of partial, 6 out of none); D537: the Retrace and Jump-start lines leave the spell text (57 texts read whole - out of partial; 8 out of none: a spell made of engine-run lines alone reads whole); D536: the Storm and Cascade lines leave the spell text (130 texts read whole - 130 out of partial); D535: the Buyback line leaves the spell text (72 texts read whole - 72 out of partial); D534: the coin flip and its won and lost branches (11 texts read whole - 19 out of none, 8 into partial); D532: the compound threaten, the give-away and the owners' form (24 texts read whole - 37 out of none, 13 into partial); D531: control for good, the source's hold, the exchange and the energy sentence (44 texts read whole - 40 out of none, 4 out of partial); D515: the ask's chosen creature (3 texts read whole - 3 out of partial); D514: the object's stat as last known (7 texts read whole - 2 out of none, 5 out of partial); D512: the additional combat phase (33 texts read whole - 35 out of none, 2 into partial); D511: bolster (10 texts read whole - 2 out of none, 8 out of partial); D510: the untap choice, the mass can't-block and the wheel (92 texts read whole - 52 out of none, 40 out of partial); D509: the controller word on every target noun (87 texts read whole - 104 out of none, 17 into partial); D508: the hand put (28 texts read whole - 21 out of none, 7 out of partial: a card put from the hand onto the battlefield); D507: the referent search (63 texts read whole - 61 out of partial, 2 out of none: the search asked of the previous object's controller); D505: the mass verbs over a scope (20 spells read whole - out of none); D504: the previous object's controller (27 spells read whole - out of partial); D502: the extra turn (nine spells read whole - none into partial); D501: the spell's own fate (the fate sentence read on every printing that carries it - none into partial); D500: the object verbs; D494: the previous clause's objects; D493: the look grammar; D491: the from-hand free cast; D490: the conditional free cast; D488: populate; D487: the spell copy; D485: the token copy; D484: the prompt continuation; D483: the two-zone search; D482: the player's sacrifice (a target scope, a count); D479: the tribal target folded to the marker noun; D478: the permanent noun and the card-or-card alternative in a search; D474: the token printings rowed like cards, their makers' descriptions read; D473: the quoted tokens (Call the Scions and the Spawn spells); D439: the scoped life loss and the drain rider; D437: the spell's X; D436: the graveyard-card target; D435: the if-you-do pair; D434: the mill; D433: a targeted or scoped draw; D383: the scoped board effect - a sentence about a whole scope; D369: the payment prompt; D359: the optional search, the qualified card and the tutor's top; D343: a modal face reads mode by mode; D312: a priced reduction line is no clause either; D307: a spell's flashback line is no clause either; D306: a spell's cycling line is no clause; D301: the mass pump; D299: the counted-targets seam; D298: the graveyard-return slot; D297: subtype nouns and lists; D295: four sentences
