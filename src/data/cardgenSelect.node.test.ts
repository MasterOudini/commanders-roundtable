...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Capashen Standard', 'an Aura line outside the row shapes ({N}, Sacrifice this Aura: Draw a card.)'],
  ['Mantle of the Wolf', 'an Aura line outside the row shapes (When this Aura is put into a graveyard from the )'],
  ...
  ['Griffin Guide', 'an Aura line outside the row shapes (When enchanted creature dies, create a N/N white)'],
  ['Failed Conversion', 'an Aura line outside the row shapes (When enchanted creature dies, surveil N.)'],
  ['Wurmweaver Coil', 'an Aura line outside the row shapes ({G}{G}{G}, Sacrifice this Aura: Create a N/N gre)'],
  ['Audacity', 'an Aura line outside the row shapes (When this Aura is put into a graveyard from the )'],
  ...
  ['Elephant Guide', 'an Aura line outside the row shapes (When enchanted creature dies, create a N/N green)'],
  ['Sinister Possession', 'an Aura line outside the row shapes (Whenever enchanted creature attacks or blocks, i)'],
  ['Illuminated Wings', 'an Aura line outside the row shapes ({N}, Sacrifice this Aura: Draw a card.)'],
