...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Imperial Cosmographer', 'leaves head destination filter'],
  ['Innocent Bystander', 'trigger head not in the library'],
  ['Ivora, Insatiable Heir', 'compound trigger head'],
  ...
  ['Perimeter Enforcer', 'compound trigger head'],
  ...
  ["Ultron's Auxiliary", 'compound trigger head'],
