...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Infernal Medusa', 'a filtered head outside the closed reader (an adjective outside the list: non-Wall): Whenever this creature becomes blocked by a non-Wall creatur (D498)'],
  ...
  ['Inspiring Bard', 'a mode payload: Song of Rest — You gain 3 life. (D498)'],
  ['Oltec Archaeologists', 'a mode whose payload asks (scry) - the continuation seam (D498)'],
  ['Plundering Barbarian', 'a mode payload: Smash the Chest — Destroy target artifact. (D498)'],
