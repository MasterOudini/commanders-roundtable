...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Aetherjacket', 'effect not a row kind: Destroy another target artifact.'],
  ...
  ['Assassin Den', "effect not a row kind: Put a +1/+1 counter on target creature you control. It can't be blocked this turn."],
  ...
  ['Beetle, Legacy Criminal', 'effect not a row kind: Put a +1/+1 counter on target creature. It gains flying until end of turn.'],
  ...
  ['Dross Scorpion', 'a filtered head outside the closed reader (an adjective outside the list: this): Whenever this creature or another artifact creature dies, yo'],
  ...
  ['Fleshformer', 'effect not a row kind: ~ gets +2/+2 and gains fear until end of turn. Target creature gets -2/-2 until end of turn.'],
  ...
  ['Graverobber Spider', 'effect not a row kind: ~ gets +X/+X until end of turn, where X is the number of creature cards in your graveyard.'],
  ...
  ['Icefeather Aven', "trigger payload not a pump: Return another target creature to its owner's hand."],
  ...
  ['Living Totem', 'trigger payload not a pump: Put a +1/+1 counter on another target creature.'],
  ...
  ['Nantuko Monastery', "effect not a row kind: ~ becomes a 4/4 green and white Insect Monk creature with first strike until end of turn. It's still a land."],
  ...
  ['Pactdoll Terror', 'a filtered head outside the closed reader (an adjective outside the list: this): Whenever this creature or another artifact you control enter'],
  ...
  ["Shi'ar Soldier", "effect not a row kind: Return another target permanent you control to its owner's hand."],
  ...
  ['Smelt-Ward Ignus', 'effect not a row kind: Gain control of target creature with power 3 or less until end of turn. Untap that creature. It gains haste until end of turn.'],
  ...
  ['Suspension Field', 'trigger payload not a pump: Exile target creature with toughness 3 or greater until this'],
  ...
  ['Undead Augur', 'a filtered head outside the closed reader (an adjective outside the list: this): Whenever this creature or another Zombie you control dies, y'],
  ['Urborg Mindsucker', 'effect not a row kind: Target opponent discards a card at random.'],
  ['Vedalken Certarch', 'effect not a row kind: Tap target artifact, creature, or land.'],
  ['Vengeful Dead', 'a filtered head outside the closed reader (an adjective outside the list: this): Whenever this creature or another Zombie dies, each opponent'],
  ['Venom, Evil Unleashed', 'effect not a row kind: Put two +1/+1 counters on target creature. It gains deathtouch until end of turn.'],
  ...
  ['Zulaport Cutthroat', 'a filtered head outside the closed reader (an adjective outside the list: this): Whenever this creature or another creature you control dies,'],
  ...
  ['Ayara, First of Locthwain', 'a filtered head outside the closed reader (an adjective outside the list: ~): Whenever ~ or another black creature you control enters, eac'],
  ...
  ["Morcant's Eyes", 'effect not a row kind: Create X 2/2 black and green Elf creature tokens, where X is the number of Elf cards in your graveyard.'],
  ...
  ['Vilespawn Spider', 'effect not a row kind: Create a 1/1 green Insect creature token for each creature card in your graveyard.'],
