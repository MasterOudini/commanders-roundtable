...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Archangel of Wrath', 'a double kicker (`Kicker {B} and/or {R}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Urborg Lhurgoyf', 'a double kicker (`Kicker {U} and/or {B}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Final Flourish', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice an artifact or creature.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Rushing River', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice a land.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Bog Down', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice two lands.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Primal Growth', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice a creature.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Thornscape Battlemage', 'a double kicker (`Kicker {R} and/or {W}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Stronghold Arena', 'a double kicker (`Kicker {G} and/or {W}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Vodalian Mindsinger', 'a double kicker (`Kicker {1}{R} and/or {1}{G}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Necravolver', 'a double kicker (`Kicker {1}{G} and/or {W}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Blood Tribute', 'a kicker paid by a cost that is not mana (`Kicker—Tap an untapped Vampire you control.` - an optional additional cost; not this wave) (D529)'],
  ['Degavolver', 'a double kicker (`Kicker {1}{B} and/or {R}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Temporal Firestorm', 'a double kicker (`Kicker {1}{W} and/or {1}{U}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Stomped by the Foot', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice an artifact or creature.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Rakavolver', 'a double kicker (`Kicker {1}{W} and/or {U}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Goblin Barrage', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice an artifact or Goblin.` - an optional additional cost; not this wave) (D529)'],
  ['Dwarven Landslide', 'a kicker paid by a cost that is not mana (`Kicker—{2}{R}, Sacrifice a land.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Phyrexian Scuta', 'a kicker paid by a cost that is not mana (`Kicker—Pay 3 life.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Anavolver', 'a double kicker (`Kicker {1}{U} and/or {B}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Sunscape Battlemage', 'a double kicker (`Kicker {1}{G} and/or {2}{U}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ['Cetavolver', 'a double kicker (`Kicker {1}{R} and/or {G}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ['Thunderscape Battlemage', 'a double kicker (`Kicker {1}{B} and/or {G}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ['Wastescape Battlemage', 'a double kicker (`Kicker {G} and/or {1}{U}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ["Vayne's Treachery", 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice an artifact or creature.` - an optional additional cost; not this wave) (D529)'],
  ['Falling Timber', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice a land.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Stormscape Battlemage', 'a double kicker (`Kicker {W} and/or {2}{B}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Nightscape Battlemage', 'a double kicker (`Kicker {2}{U} and/or {2}{R}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ['Arctic Merfolk', 'a kicker paid by a cost that is not mana (`Kicker—Return a creature you control to its owner\'s hand.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Pollen Remedy', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice a land.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Vicious Offering', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice a creature.` - an optional additional cost; not this wave) (D529)'],
  ...
  ["Dralnu's Pet", 'a kicker paid by a cost that is not mana (`Kicker—{2}{B}, Discard a creature card.` - an optional additional cost; not this wave) (D529)'],
  ['Illuminate', 'a double kicker (`Kicker {2}{R} and/or {3}{U}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Magma Burst', 'a kicker paid by a cost that is not mana (`Kicker—Sacrifice two lands.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Ana Battlemage', 'a double kicker (`Kicker {2}{U} and/or {1}{B}` - two kicker costs and WHICH was paid; the cast announces one kick this wave) (D529)'],
  ...
  ['Chocobo Kick', 'a kicker paid by a cost that is not mana (`Kicker—Return a land you control to its owner\'s hand.` - an optional additional cost; not this wave) (D529)'],
  ...
  ['Glimmer of Genius', 'a spell with a line outside the vocabulary: Scry 2, then draw two cards. You get {E}{E} (two energy (D519)'],
  ...
  ['Tune the Narrative', 'a spell with a line outside the vocabulary: Draw a card. You get {E}{E} (two energy counters). (D519)'],
