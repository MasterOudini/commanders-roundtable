...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Equilibrium', 'a payload outside both readers (Pay {1}. If you do, return target creature to)'],
  ['Soul Net', 'a payload outside both readers (Pay {1}. If you do, you gain 1 life.)'],
  ['Lifesmith', 'a payload outside both readers (Pay {1}. If you do, you gain 3 life.)'],
  ['Skywise Teachings', 'a payload outside both readers (Pay {1}{U}. If you do, create a 2/2 blue Djin)'],
  ['Merfolk Seer', 'a payload outside both readers (Pay {1}{U}. If you do, draw a card.)'],
  ['Surgespanner', 'a payload outside both readers (Pay {1}{U}. If you do, return target permanen)'],
  ...
  ['Dawn of Hope', 'a payload outside both readers (Pay {2}. If you do, draw a card.)'],
  ['Papercraft Decoy', 'a payload outside both readers (Pay {2}. If you do, draw a card.)'],
  ...
  ['Inheritance', 'a payload outside both readers (Pay {3}. If you do, draw a card.)'],
  ...
  ['Flight Spellbomb', 'a payload outside both readers (Pay {U}. If you do, draw a card.)'],
  ['Origin Spellbomb', 'a payload outside both readers (Pay {W}. If you do, draw a card.)'],
  ['Serene Steward', 'a payload outside both readers (Pay {W}. If you do, put a +1/+1 counter on ta)'],
  ['Haazda Snare Squad', 'a payload outside both readers (Pay {W}. If you do, tap target creature an op)'],
  ...
  ['Straw Golem', 'a trigger head outside the row library (When an opponent casts a creature spell)'],
  ...
  ['Skittering Horror', 'a trigger head outside the row library (When you cast a creature spell)'],
  ['Skittering Monstrosity', 'a trigger head outside the row library (When you cast a creature spell)'],
  ['Skittering Skirge', 'a trigger head outside the row library (When you cast a creature spell)'],
  ['Illusory Demon', 'a trigger head outside the row library (When you cast a spell)'],
  ...
  ['Smolder Initiate', 'a trigger head outside the row library (Whenever a player casts a black spell)'],
  ['Throne of Bone', 'a trigger head outside the row library (Whenever a player casts a black spell)'],
  ['Crystal Rod', 'a trigger head outside the row library (Whenever a player casts a blue spell)'],
  ['Lapis Lazuli Talisman', 'a trigger head outside the row library (Whenever a player casts a blue spell)'],
  ['Bog-Strider Ash', 'a trigger head outside the row library (Whenever a player casts a Goblin spell)'],
  ['Malachite Talisman', 'a trigger head outside the row library (Whenever a player casts a green spell)'],
  ['Nurturer Initiate', 'a trigger head outside the row library (Whenever a player casts a green spell)'],
  ['Wooden Sphere', 'a trigger head outside the row library (Whenever a player casts a green spell)'],
  ['Hematite Talisman', 'a trigger head outside the row library (Whenever a player casts a red spell)'],
  ['Iron Star', 'a trigger head outside the row library (Whenever a player casts a red spell)'],
  ['Jeweled Torque', 'a trigger head outside the row library (Whenever a player casts a spell of the chosen colo)'],
  ['Apothecary Initiate', 'a trigger head outside the row library (Whenever a player casts a white spell)'],
  ['Auspicious Ancestor', 'a trigger head outside the row library (Whenever a player casts a white spell)'],
  ['Ivory Cup', 'a trigger head outside the row library (Whenever a player casts a white spell)'],
  ['Nacre Talisman', 'a trigger head outside the row library (Whenever a player casts a white spell)'],
  ["Urza's Chalice", 'a trigger head outside the row library (Whenever a player casts an artifact spell)'],
  ...
  ['Tablet of Epityr', 'a trigger head outside the row library (Whenever an artifact you control is put into a gra)'],
  ["Mind's Eye", 'a trigger head outside the row library (Whenever an opponent draws a card)'],
  ['Mentor of the Meek', 'a trigger head outside the row library (Whenever another creature you control with power 2)'],
  ['Voracious Tome-Skimmer', "a trigger head outside the row library (Whenever you cast a spell during an opponent's tur)"],
  ['Leaf-Crowned Visionary', 'a trigger head outside the row library (Whenever you cast an Elf spell)'],
  ...
  ['Ruthless Sniper', 'a trigger head outside the row library (Whenever you cycle or discard a card)'],
  ...
  ['Clockwork Gnomes', 'a regenerate payload the suite cannot assert'],
  ['Fiddlehead Kami', 'a regenerate payload the suite cannot assert'],
  ['Horror of Horrors', 'a regenerate payload the suite cannot assert'],
  ["Jhoira's Toolbox", 'a regenerate payload the suite cannot assert'],
  ['Loxodon Mender', 'a regenerate payload the suite cannot assert'],
  ['Metallurgeon', 'a regenerate payload the suite cannot assert'],
  ['Pteron Ghost', 'a regenerate payload the suite cannot assert'],
  ['Trolls of Tel-Jilad', 'a regenerate payload the suite cannot assert'],
  ['Vagrant Plowbeasts', 'a regenerate payload the suite cannot assert'],
  ['Welding Jar', 'a regenerate payload the suite cannot assert'],
  ...
  ['Captain Lannery Storm', 'a Vehicle head without a Crew line the engine charges'],
  ['Camera Launcher', 'ability-word activated line'],
  ['Fearless Pup', 'ability-word activated line'],
  ['Greenbelt Guardian', 'ability-word activated line'],
  ...
  ['Abyssal Nocturnus', 'trigger head not in the library'],
  ['Akki Raider', 'trigger head not in the library'],
  ['Attuned Hunter', 'trigger head not in the library'],
  ['Aven Farseer', 'trigger head not in the library'],
  ['Bakersbane Duo', 'trigger head not in the library'],
  ['Bark-Knuckle Boxer', 'trigger head not in the library'],
  ['Bloodbriar', 'trigger head not in the library'],
  ['Body Dropper', 'trigger head not in the library'],
  ['Burdened Aerialist', 'trigger head not in the library'],
  ['Burning Sun Cavalry', 'trigger head not in the library'],
  ['Cave Tiger', 'trigger head not in the library'],
  ...
  ['Courageous Goblin', 'trigger head not in the library'],
  ['Crackdown Construct', 'trigger head not in the library'],
  ['Crimson Roc', 'trigger head not in the library'],
  ['Cryptid Inspector', 'trigger head not in the library'],
  ['Cyan, Vengeful Samurai', 'trigger head not in the library'],
  ['Dimir Spybug', 'trigger head not in the library'],
  ['Dirtcowl Wurm', 'trigger head not in the library'],
  ['Eloise, Nephalia Sleuth', 'trigger head not in the library'],
  ["Ezuri's Archers", 'trigger head not in the library'],
  ['Flameblade Adept', 'trigger head not in the library'],
  ['Flamespeaker Adept', 'trigger head not in the library'],
  ['Flaming Fist Officer', 'trigger head not in the library'],
  ['Fleeting Aven', 'trigger head not in the library'],
  ['Flourishing Fox', 'trigger head not in the library'],
  ['Foe-liage', 'trigger head not in the library'],
  ['Frenzied Raider', 'trigger head not in the library'],
  ['Giant Fly', 'trigger head not in the library'],
  ["Gideon's Avenger", 'trigger head not in the library'],
  ['Gixian Infiltrator', 'trigger head not in the library'],
  ['Gleaming Geardrake', 'trigger head not in the library'],
  ['Grisly Survivor', 'trigger head not in the library'],
  ['Hekma Sentinels', 'trigger head not in the library'],
  ['High-Rise Sawjack', 'trigger head not in the library'],
  ['Hobgoblin, Mantled Marauder', 'trigger head not in the library'],
  ['Horror of the Broken Lands', 'trigger head not in the library'],
  ['Imperial Cosmographer', 'trigger head not in the library'],
  ['Innocent Bystander', 'trigger head not in the library'],
  ['Ivora, Insatiable Heir', 'trigger head not in the library'],
  ['Junkblade Bruiser', 'trigger head not in the library'],
  ['Kazarov, Sengir Pureblood', 'trigger head not in the library'],
  ['Lightless Evangel', 'trigger head not in the library'],
  ['Marvel Boy, Noh-Varr', 'trigger head not in the library'],
  ['Meddling Youths', 'trigger head not in the library'],
  ['Molder Beast', 'trigger head not in the library'],
  ['Netcaster Spider', 'trigger head not in the library'],
  ['Ninth Bridge Patrol', 'trigger head not in the library'],
  ['Ongoing Investigation', 'trigger head not in the library'],
  ['Overzealous Muscle', 'trigger head not in the library'],
  ['Owlin Historian', 'trigger head not in the library'],
  ['Paired Tactician', 'trigger head not in the library'],
  ['Pangosaur', 'trigger head not in the library'],
  ['Perimeter Enforcer', 'trigger head not in the library'],
  ['Pirate Peddlers', 'trigger head not in the library'],
  ['Pitiless Vizier', 'trigger head not in the library'],
  ['Prickly Marmoset', 'trigger head not in the library'],
  ['Psychic Frog', 'trigger head not in the library'],
  ['Pygmy Troll', 'trigger head not in the library'],
  ['Rabid Wolverines', 'trigger head not in the library'],
  ['Resolute Veggiesaur', 'trigger head not in the library'],
  ['Rot Farm Mortipede', 'trigger head not in the library'],
  ['Ruby, Daring Tracker', 'trigger head not in the library'],
  ['Savior of the Sleeping', 'trigger head not in the library'],
  ['Search the Premises', 'trigger head not in the library'],
  ['Seasoned Consultant', 'trigger head not in the library'],
  ['Seasoned Warrenguard', 'trigger head not in the library'],
  ['Shadowstorm Vizier', 'trigger head not in the library'],
  ['Skystinger', 'trigger head not in the library'],
  ['Slaughter-Priest of Mogis', 'trigger head not in the library'],
  ['Snarespinner', 'trigger head not in the library'],
  ['Spirit Mascot', 'trigger head not in the library'],
  ['Stoic Champion', 'trigger head not in the library'],
  ['Super Shredder', 'trigger head not in the library'],
  ['Tel-Jilad Wolf', 'trigger head not in the library'],
  ['Territorial Gorger', 'trigger head not in the library'],
  ['The Thing, Ben Grimm', 'trigger head not in the library'],
  ['Twilight Drover', 'trigger head not in the library'],
  ["Ultron's Auxiliary", 'trigger head not in the library'],
  ['Ulvenwald Mysteries', 'trigger head not in the library'],
  ['Vampire Scrivener', 'trigger head not in the library'],
  ['Vengeful Townsfolk', 'trigger head not in the library'],
  ['Vengeful Warchief', 'trigger head not in the library'],
  ['Viashino Weaponsmith', 'trigger head not in the library'],
  ['Vulturous Zombie', 'trigger head not in the library'],
  ['Wake Thrasher', 'trigger head not in the library'],
  ['Wandertale Mentor', 'trigger head not in the library'],
  ['Warped Researcher', 'trigger head not in the library'],
  ['Wax-Wane Witness', 'trigger head not in the library'],
  ['Woolly Spider', 'trigger head not in the library'],
  ['Child of Gaea', 'trigger payload outside both readers'],
  ['Crystal Seer', 'trigger payload outside both readers'],
  ['Daru Mender', 'trigger payload outside both readers'],
  ...
  ["Freyalise's Charm", 'trigger payload outside both readers'],
  ['Horizon Seed', 'trigger payload outside both readers'],
  ['Justice, Vance Astrovik', 'trigger payload outside both readers'],
  ['Oreplate Pangolin', 'trigger payload outside both readers'],
