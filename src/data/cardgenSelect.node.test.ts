...
const REFUSED: ReadonlyMap<string, string> = new Map([
  ...
  ['Beledros Witherbloom', 'a mass verb over a permanent scope with no witness: Untap all lands you control. (D505)'],
  ['Domri, City Smasher', 'a mass verb over your own permanents on a row whose card is not a creature (no witness on p1): Put three +1/+1 counters on each creature you cont (D505)'],
  ['Acid-Spewer Dragon', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other Dragon creature (D505)'],
  ['Action News Crew', 'a mass verb over your own creatures on a row whose card its cost sends away (no witness on p1): Put a +1/+1 counter on each creature you control. (D505)'],
  ['Aragorn and Arwen, Wed', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other creature you con (D505)'],
  ['Belltoll Dragon', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other Dragon creature (D505)'],
  ['Biomathematician', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each Fractal you control. (D505)'],
  ['Chimeric Idol', 'a mass verb over a permanent scope with no witness: Tap all lands you control. (D505)'],
  ['Citizen V, Helmut Zemo', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each Villain you control. (D505)'],
  ['Copperhorn Scout', 'a mass verb over a scope the suite has no witness for (not this wave): Untap each other creature you control. (D505)'],
  ['Githzerai Monk', 'trigger payload not a pump: Tap all creatures you don\'t control. (D505)'],
  ['Havengul Runebinder', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each Zombie creature you co (D505)'],
  ['Herdchaser Dragon', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other Dragon creature (D505)'],
  ['Iron Monger, Sadistic Tycoon', 'trigger head not in the library: Whenever a creature you control connives, put a +1/+1 counter on each (D505)'],
  ['Shieldhide Dragon', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other Dragon creature (D505)'],
  ['Shrieking Mogg', 'a mass verb over a scope the suite has no witness for (not this wave): Tap all other creatures. (D505)'],
  ['Silt Crawler', 'a mass verb over a permanent scope with no witness: Tap all lands you control. (D505)'],
  ['Spider-Man, Miles Morales', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other creature you con (D505)'],
  ['Stormwing Dragon', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each other Dragon creature (D505)'],
  ['Thundermare', 'a mass verb over a scope the suite has no witness for (not this wave): Tap all other creatures. (D505)'],
  ['Timbermare', 'a mass verb over a scope the suite has no witness for (not this wave): Tap all other creatures. (D505)'],
  ['Troublesome Spirit', 'a mass verb over a permanent scope with no witness: Tap all lands you control. (D505)'],
  ['Unstoppable Plan', 'a mass verb over a scope the suite has no witness for (not this wave): Untap all nonland permanents you control. (D505)'],
  ['Wilderness Reclamation', 'a mass verb over a permanent scope with no witness: Untap all lands you control. (D505)'],
  ['Avenger of Zendikar', 'a mass verb over a scope the suite has no witness for (not this wave): Put a +1/+1 counter on each Plant creature you con (D505)'],
  ['Lo and Li, Royal Advisors', 'trigger head not in the library: Whenever an opponent discards a card or mills one or more cards, put a (D505)'],
  ['Myr Galvanizer', 'a mass verb over a scope the suite has no witness for (not this wave): Untap each other Myr you control. (D505)'],
  ['Sky Hussar', 'ability-word activated line: Forecast — Tap two untapped white and/or (D505)'],
  ['Camellia, the Seedmiser', 'a filtered head outside the closed reader (an adjective outside the list: one): Whenever you sacrifice one or more Foods, create a 1/1 green (D505)'],
  ['Felidar Retreat', 'a mass verb over your own permanents on a row whose card is not a creature (no witness on p1): Put a +1/+1 counter on each creature you control. (D505)'],
  ['Kumena, Tyrant of Orazca', 'a tap cost of the scope subtype beside a tribal mass counter (the tappers and the yes fixture are one name) (D505)'],
  ['Urtet, Remnant of Memnarch', 'a mass verb over a scope the suite has no witness for (not this wave): Untap each Myr you control. (D505)'],
  ['Hylda of the Icy Crown', 'trigger head not in the library: Whenever you tap an untapped creature an opponent controls, you may pa (D505)'],
  ...
  ['Chaos Terminator Lord', 'trigger payload not a pump: Another target creature you control gains double strike unti (D503)'],
  ...
  ['Plasmancer', 'trigger payload not a pump: Search your library for a basic Swamp card, reveal it, put i (D503)'],
