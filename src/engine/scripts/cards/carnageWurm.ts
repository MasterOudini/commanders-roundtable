// `Carnage Wurm` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CARNAGE_WURM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CARNAGE_WURM, "Bloodthirst 3 (If an opponent was dealt damage this turn, this creature enters with three +1/+1 counters on it.)\nTrample (This creature can deal excess combat damage to the player or planeswalker it's attacking.)");
...
export const CARNAGE_WURM_SCRIPT: CardScript = {
  oracleId: CARNAGE_WURM.oracleId,
  name: CARNAGE_WURM.name,
  replacements: [
    {
