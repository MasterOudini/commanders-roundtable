// `Sunrise Sovereign` - a layer-6 anthem: "Other Giant creatures you control get +2/+2 and have trample". A StaticDef in the shape of the
...
import { SUNRISE_SOVEREIGN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SUNRISE_SOVEREIGN, "Other Giant creatures you control get +2/+2 and have trample.");
const TEXT = PRINTED;

export const SUNRISE_SOVEREIGN_SCRIPT: CardScript = {
  oracleId: SUNRISE_SOVEREIGN.oracleId,
  name: SUNRISE_SOVEREIGN.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
      ...
      appliesTo: (ctx, self, candidate, chars) => {
        ...
        if (!chars.typeLine.subtypes.includes("Giant")) return false;
        return true;
      },
      modify: (chars) => {
