// `Windbrisk Raptor` - a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WINDBRISK_RAPTOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WINDBRISK_RAPTOR, "Flying\nAttacking creatures you control have lifelink.");
const LINES = PRINTED.split('\n');

export const WINDBRISK_RAPTOR_SCRIPT: CardScript = {
  oracleId: WINDBRISK_RAPTOR.oracleId,
  name: WINDBRISK_RAPTOR.name,
  statics: [
    {
