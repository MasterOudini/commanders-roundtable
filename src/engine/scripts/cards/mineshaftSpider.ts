// `Mineshaft Spider` - a etb trigger mill
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MINESHAFT_SPIDER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MINESHAFT_SPIDER, "Reach\nWhen this creature enters, you may mill two cards. (You may put the top two cards of your library into your graveyard.)");
const LINES = PRINTED.split('\n');

export const MINESHAFT_SPIDER_SCRIPT: CardScript = {
  oracleId: MINESHAFT_SPIDER.oracleId,
  name: MINESHAFT_SPIDER.name,
  triggers: [
    {
      abilityId: 'etb-1',
