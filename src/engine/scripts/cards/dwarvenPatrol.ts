// `Dwarven Patrol` - a static noUntap, a castSpell trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DWARVEN_PATROL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DWARVEN_PATROL, "This creature doesn't untap during your untap step.\nWhenever you cast a nonred spell, untap this creature.");
const LINES = PRINTED.split('\n');

export const DWARVEN_PATROL_SCRIPT: CardScript = {
  oracleId: DWARVEN_PATROL.oracleId,
  name: DWARVEN_PATROL.name,
  triggers: [
    {
      ...
      label: () => "Dwarven Patrol - untapSelf",
