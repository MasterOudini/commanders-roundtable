// `Fervor` - a layer-6 grant: "Creatures you control have haste. (They can attack and {T} as soon as they come under your control.)". A StaticDef in the shape of the
...
import { FERVOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FERVOR, "Creatures you control have haste. (They can attack and {T} as soon as they come under your control.)");
const TEXT = PRINTED;

export const FERVOR_SCRIPT: CardScript = {
  oracleId: FERVOR.oracleId,
  name: FERVOR.name,
  statics: [
    {
      abilityId: 'grant',
