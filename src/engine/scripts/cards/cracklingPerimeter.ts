// `Crackling Perimeter` - an activation damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CRACKLING_PERIMETER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CRACKLING_PERIMETER, "Tap an untapped Gate you control: This enchantment deals 1 damage to each opponent.");

export const CRACKLING_PERIMETER_SCRIPT: CardScript = {
  oracleId: CRACKLING_PERIMETER.oracleId,
  name: CRACKLING_PERIMETER.name,
  activated: [
    {
      ref: `${CRACKLING_PERIMETER.oracleId}#a0`,
      text: PRINTED,
