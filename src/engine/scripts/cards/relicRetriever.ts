// `Relic Retriever` - a eachEndStep trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { RELIC_RETRIEVER } from '../../../data/fixtures/engineCards';
...
export const RELIC_RETRIEVER_SCRIPT: CardScript = {
  oracleId: RELIC_RETRIEVER.oracleId,
  name: RELIC_RETRIEVER.name,
  triggers: [
    {
