// `Tempting Witch` — a Food on entry; two mana, the tap and a Food sold for
// 3 life off a player.

import { TEMPTING_WITCH } from '../../../data/fixtures/engineCards';
...
export const TEMPTING_WITCH_SCRIPT: CardScript = {
  oracleId: TEMPTING_WITCH.oracleId,
  name: TEMPTING_WITCH.name,
  triggers: [
    {
      abilityId: 'enters',
      text: ENTERS,
