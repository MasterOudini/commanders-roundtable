// `Aquitect's Defenses` - a etb trigger attachedTemp, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AQUITECT_S_DEFENSES } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AQUITECT_S_DEFENSES, "Flash\nEnchant creature you control\nWhen this Aura enters, enchanted creature gains hexproof until end of turn. (It can't be the target of spells or abilities your opponents control.)\nEnchanted creature gets +1/+2.");
const LINES = PRINTED.split('\n');

export const AQUITECTS_DEFENSES_SCRIPT: CardScript = {
  oracleId: AQUITECT_S_DEFENSES.oracleId,
  name: AQUITECT_S_DEFENSES.name,
  triggers: [
    {
      abilityId: 'etb-2',
      ...
      label: () => "Aquitect's Defenses - attachedTemp",
