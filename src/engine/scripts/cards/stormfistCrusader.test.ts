// `Stormfist Crusader` - every printed ability proven in its own game: the cost's mark, the pump
...
import { STORMFIST_CRUSADER_SCRIPT } from './stormfistCrusader';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Stormfist Crusader";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Stormfist Crusader"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([STORMFIST_CRUSADER_SCRIPT]),
...
describe("Stormfist Crusader", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Each player draws a card and loses 1 life.\"", () => {
    const { g, life0, hand0, p2life0, p2hand0 } = armed(0);
