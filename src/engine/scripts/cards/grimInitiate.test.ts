// `Grim Initiate` - every printed ability proven in its own game: the cost's mark, the pump
...
import { GRIM_INITIATE_SCRIPT } from './grimInitiate';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Grim Initiate";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Grim Initiate"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GRIM_INITIATE_SCRIPT]),
...
describe("Grim Initiate", () => {
  test("When this creature dies: the vocabulary resolves \"Amass Zombies 1.\"", () => {
