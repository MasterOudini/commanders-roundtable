// `Lightning Mare` - a static cantBeCountered, a static cantBeBlockedBy, an activation pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LIGHTNING_MARE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LIGHTNING_MARE, "This spell can't be countered.\nThis creature can't be blocked by blue creatures.\n{1}{R}: This creature gets +1/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const LIGHTNING_MARE_SCRIPT: CardScript = {
  oracleId: LIGHTNING_MARE.oracleId,
  name: LIGHTNING_MARE.name,
  activated: [
    {
      ref: `${LIGHTNING_MARE.oracleId}#a0`,
