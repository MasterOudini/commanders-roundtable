// `Cathar's Shield` - an Equipment: the equipped creature gets +0/+3 and has vigilance.
...
import { CATHAR_S_SHIELD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CATHAR_S_SHIELD, "Equipped creature gets +0/+3 and has vigilance.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const CATHARS_SHIELD_SCRIPT: CardScript = {
  oracleId: CATHAR_S_SHIELD.oracleId,
  name: CATHAR_S_SHIELD.name,
  statics: [
    {
