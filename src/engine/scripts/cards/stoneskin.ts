// `Stoneskin` - an Aura (Enchant creature): the enchanted creature gets +0/+10.
...
import { STONESKIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STONESKIN, "Flash\nEnchant creature\nEnchanted creature gets +0/+10.");
const LINES = PRINTED.split('\n');

export const STONESKIN_SCRIPT: CardScript = {
  oracleId: STONESKIN.oracleId,
  name: STONESKIN.name,
  statics: [
    {
