// `Enclave Elite` - a static entersWithCountersPer
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ENCLAVE_ELITE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ENCLAVE_ELITE, "Multikicker {1}{U} (You may pay an additional {1}{U} any number of times as you cast this spell.)\nIslandwalk (This creature can't be blocked as long as defending player controls an Island.)\nThis creature enters with a +1/+1 counter on it for each time it was kicked.");
const LINES = PRINTED.split('\n');

export const ENCLAVE_ELITE_SCRIPT: CardScript = {
  oracleId: ENCLAVE_ELITE.oracleId,
  name: ENCLAVE_ELITE.name,
  replacements: [
    {
