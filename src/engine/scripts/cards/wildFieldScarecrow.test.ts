// `Wild-Field Scarecrow` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Wild-Field Scarecrow", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([WILD_FIELD_SCARECROW_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Wild-Field Scarecrow", () => {
  test("{2}, Sacrifice this creature: the vocabulary resolves \"Search your library for up to two basic land cards, reveal them, put them into your hand, then shuffle.\"", () => {
