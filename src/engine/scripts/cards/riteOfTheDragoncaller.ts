// `Rite of the Dragoncaller` — "Whenever you cast an instant or sorcery
// spell, create a 5/5 red Dragon creature token with flying." Murmuring
// Mystic's filter paying Dragon Roost's Dragon. D241.

import { RITE_OF_THE_DRAGONCALLER } from '../../../data/fixtures/engineCards';
...
export const RITE_OF_THE_DRAGONCALLER_SCRIPT: CardScript = {
  oracleId: RITE_OF_THE_DRAGONCALLER.oracleId,
  name: RITE_OF_THE_DRAGONCALLER.name,
  triggers: [
    {
      abilityId: 'cast',
      text: TEXT,
      ...
      label: () => 'Rite of the Dragoncaller — create a 5/5 Dragon with flying',
