// `Foundry Screecher` - a conditional static (as long as you control an artifact) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FOUNDRY_SCREECHER } from '../../../data/fixtures/engineCards';
...
export const FOUNDRY_SCREECHER_SCRIPT: CardScript = {
  oracleId: FOUNDRY_SCREECHER.oracleId,
  name: FOUNDRY_SCREECHER.name,
  statics: [
    {
