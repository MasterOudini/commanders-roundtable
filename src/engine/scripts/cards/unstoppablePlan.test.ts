// `Unstoppable Plan` - every printed ability proven in its own game: the cost's mark, the pump
...
import { UNSTOPPABLE_PLAN_SCRIPT } from './unstoppablePlan';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Unstoppable Plan";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Unstoppable Plan", "Runeclaw Bear"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([UNSTOPPABLE_PLAN_SCRIPT]),
...
describe("Unstoppable Plan", () => {
  test("At the beginning of your end step: the vocabulary resolves \"Untap all nonland permanents you control.\"", () => {
