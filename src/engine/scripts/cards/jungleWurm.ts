// `Jungle Wurm` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { JUNGLE_WURM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(JUNGLE_WURM, "Whenever this creature becomes blocked, it gets -1/-1 until end of turn for each creature blocking it beyond the first.");
...
export const JUNGLE_WURM_SCRIPT: CardScript = {
  oracleId: JUNGLE_WURM.oracleId,
  name: JUNGLE_WURM.name,
  triggers: [
    {
      abilityId: 'pump-0',
      ...
      label: () => "Jungle Wurm - blocked, it pumped until end of turn",
