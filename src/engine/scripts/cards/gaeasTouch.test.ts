// `Gaea's Touch` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Gaea's Touch", "Grizzly Bears", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GAEAS_TOUCH_SCRIPT]),
...
describe("Gaea's Touch", () => {
  test("{0}: the vocabulary resolves \"You may put a basic Forest card from your hand onto the battlefield.\"", () => {
