// `Shivan Gorge` - an activation damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SHIVAN_GORGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHIVAN_GORGE, "{T}: Add {C}.\n{2}{R}, {T}: Shivan Gorge deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const SHIVAN_GORGE_SCRIPT: CardScript = {
  oracleId: SHIVAN_GORGE.oracleId,
  name: SHIVAN_GORGE.name,
  activated: [
    {
      ref: `${SHIVAN_GORGE.oracleId}#a1`,
