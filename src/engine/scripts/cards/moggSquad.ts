// `Mogg Squad` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { MOGG_SQUAD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MOGG_SQUAD, "This creature gets -1/-1 for each other creature on the battlefield.");
...
export const MOGG_SQUAD_SCRIPT: CardScript = {
  oracleId: MOGG_SQUAD.oracleId,
  name: MOGG_SQUAD.name,
  statics: [
    {
      abilityId: 'pump-0',
