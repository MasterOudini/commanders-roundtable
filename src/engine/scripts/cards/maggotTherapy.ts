// `Maggot Therapy` - an Aura (Enchant creature): the enchanted creature gets +2/-2.
...
import { MAGGOT_THERAPY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAGGOT_THERAPY, "Flash\nEnchant creature\nEnchanted creature gets +2/-2.");
const LINES = PRINTED.split('\n');

export const MAGGOT_THERAPY_SCRIPT: CardScript = {
  oracleId: MAGGOT_THERAPY.oracleId,
  name: MAGGOT_THERAPY.name,
  statics: [
    {
