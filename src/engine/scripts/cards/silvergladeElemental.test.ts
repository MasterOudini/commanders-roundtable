// `Silverglade Elemental` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Silverglade Elemental", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SILVERGLADE_ELEMENTAL_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Silverglade Elemental", () => {
