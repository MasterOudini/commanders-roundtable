// `Siegecraft` - an Aura (Enchant creature): the enchanted creature gets +2/+4.
...
import { SIEGECRAFT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SIEGECRAFT, "Enchant creature\nEnchanted creature gets +2/+4.");
const LINES = PRINTED.split('\n');

export const SIEGECRAFT_SCRIPT: CardScript = {
  oracleId: SIEGECRAFT.oracleId,
  name: SIEGECRAFT.name,
  statics: [
    {
