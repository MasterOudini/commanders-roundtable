// `Jackhammer` - an Equipment: the equipped creature gets +2/+0.
...
import { JACKHAMMER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(JACKHAMMER, "Equipped creature gets +2/+0.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const JACKHAMMER_SCRIPT: CardScript = {
  oracleId: JACKHAMMER.oracleId,
