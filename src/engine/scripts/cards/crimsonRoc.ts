// `Crimson Roc` - a blocks trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CRIMSON_ROC } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CRIMSON_ROC, "Flying\nWhenever this creature blocks a creature without flying, this creature gets +1/+0 and gains first strike until end of turn.");
const LINES = PRINTED.split('\n');

export const CRIMSON_ROC_SCRIPT: CardScript = {
  oracleId: CRIMSON_ROC.oracleId,
  name: CRIMSON_ROC.name,
  triggers: [
    {
      abilityId: 'blocks-1',
      ...
      label: () => "Crimson Roc - it pumped until end of turn",
