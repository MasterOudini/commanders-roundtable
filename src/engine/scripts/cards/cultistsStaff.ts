// `Cultist's Staff` - an Equipment: the equipped creature gets +2/+2.
...
import { CULTIST_S_STAFF } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CULTIST_S_STAFF, "Equipped creature gets +2/+2.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const CULTISTS_STAFF_SCRIPT: CardScript = {
  oracleId: CULTIST_S_STAFF.oracleId,
  name: CULTIST_S_STAFF.name,
  statics: [
    {
