// `Honed Khopesh` - an Equipment: the equipped creature gets +1/+1.
...
import { HONED_KHOPESH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HONED_KHOPESH, "Equipped creature gets +1/+1.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const HONED_KHOPESH_SCRIPT: CardScript = {
  oracleId: HONED_KHOPESH.oracleId,
  name: HONED_KHOPESH.name,
  statics: [
    {
