// `Feebleness` - an Aura (Enchant creature): the enchanted creature gets -2/-1.
...
import { FEEBLENESS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FEEBLENESS, "Flash\nEnchant creature\nEnchanted creature gets -2/-1.");
const LINES = PRINTED.split('\n');

export const FEEBLENESS_SCRIPT: CardScript = {
  oracleId: FEEBLENESS.oracleId,
  name: FEEBLENESS.name,
  statics: [
    {
