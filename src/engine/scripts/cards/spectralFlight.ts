// `Spectral Flight` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has flying.
...
import { SPECTRAL_FLIGHT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPECTRAL_FLIGHT, "Enchant creature\nEnchanted creature gets +2/+2 and has flying.");
const LINES = PRINTED.split('\n');

export const SPECTRAL_FLIGHT_SCRIPT: CardScript = {
  oracleId: SPECTRAL_FLIGHT.oracleId,
  name: SPECTRAL_FLIGHT.name,
  statics: [
    {
