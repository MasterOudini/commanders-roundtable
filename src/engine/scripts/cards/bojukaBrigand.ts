// `Bojuka Brigand` - a static cantBlock, a selfOrAnotherAllyEnters trigger selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BOJUKA_BRIGAND } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BOJUKA_BRIGAND, "This creature can't block.\nWhenever this creature or another Ally you control enters, you may put a +1/+1 counter on this creature.");
const LINES = PRINTED.split('\n');

export const BOJUKA_BRIGAND_SCRIPT: CardScript = {
  oracleId: BOJUKA_BRIGAND.oracleId,
  name: BOJUKA_BRIGAND.name,
  triggers: [
    {
      ...
      label: () => "Bojuka Brigand - a counter on it",
