// `Earth Servant` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { EARTH_SERVANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(EARTH_SERVANT, "This creature gets +0/+1 for each Mountain you control.");
...
export const EARTH_SERVANT_SCRIPT: CardScript = {
  oracleId: EARTH_SERVANT.oracleId,
  name: EARTH_SERVANT.name,
  statics: [
    {
      abilityId: 'pump-0',
