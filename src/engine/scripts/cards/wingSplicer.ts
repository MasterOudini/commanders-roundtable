// `Wing Splicer` - "When this creature enters, create a 3/3 colorless Phyrexian
// Golem artifact creature token" and the layer-6 grant "Golem creatures you
// control have flying" (a StaticDef in the shape of the engine's Levitation,
// D300) - the token it makes is a Golem it reaches.

import { WING_SPLICER } from '../../../data/fixtures/engineCards';
...
export const WING_SPLICER_SCRIPT: CardScript = {
  oracleId: WING_SPLICER.oracleId,
  name: WING_SPLICER.name,
  triggers: [
    {
      abilityId: 'etb',
      ...
      label: () => 'Wing Splicer - create a 3/3 Phyrexian Golem token',
