// `Spiteful Motives` - an Aura (Enchant creature): the enchanted creature gets +3/+0 and has firstStrike.
...
import { SPITEFUL_MOTIVES } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPITEFUL_MOTIVES, "Flash (You may cast this spell any time you could cast an instant.)\nEnchant creature\nEnchanted creature gets +3/+0 and has first strike.");
const LINES = PRINTED.split('\n');

export const SPITEFUL_MOTIVES_SCRIPT: CardScript = {
  oracleId: SPITEFUL_MOTIVES.oracleId,
  name: SPITEFUL_MOTIVES.name,
  statics: [
    {
