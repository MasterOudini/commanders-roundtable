// `Untamed Kavu` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { UNTAMED_KAVU } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(UNTAMED_KAVU, "Kicker {3} (You may pay an additional {3} as you cast this spell.)\nVigilance, trample\nIf this creature was kicked, it enters with three +1/+1 counters on it.");
const LINES = PRINTED.split('\n');


export const UNTAMED_KAVU_SCRIPT: CardScript = {
  oracleId: UNTAMED_KAVU.oracleId,
  name: UNTAMED_KAVU.name,
  replacements: [
    {
