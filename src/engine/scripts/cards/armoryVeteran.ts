// `Armory Veteran` - a conditional static (as long as this creature is equipped) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ARMORY_VETERAN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARMORY_VETERAN, "As long as this creature is equipped, it has menace. (It can't be blocked except by two or more creatures.)");
...
export const ARMORY_VETERAN_SCRIPT: CardScript = {
  oracleId: ARMORY_VETERAN.oracleId,
  name: ARMORY_VETERAN.name,
  statics: [
    {
