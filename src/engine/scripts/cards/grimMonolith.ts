// `Grim Monolith` - a static noUntap, an activation untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GRIM_MONOLITH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GRIM_MONOLITH, "This artifact doesn't untap during your untap step.\n{T}: Add {C}{C}{C}.\n{4}: Untap this artifact.");
const LINES = PRINTED.split('\n');

export const GRIM_MONOLITH_SCRIPT: CardScript = {
  oracleId: GRIM_MONOLITH.oracleId,
  name: GRIM_MONOLITH.name,
  activated: [
    {
      ref: `${GRIM_MONOLITH.oracleId}#a1`,
