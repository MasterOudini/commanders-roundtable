// `Pin to the Earth` - an Aura (Enchant creature): the enchanted creature gets -6/+0.
...
import { PIN_TO_THE_EARTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PIN_TO_THE_EARTH, "Enchant creature\nEnchanted creature gets -6/-0.");
const LINES = PRINTED.split('\n');

export const PIN_TO_THE_EARTH_SCRIPT: CardScript = {
  oracleId: PIN_TO_THE_EARTH.oracleId,
  name: PIN_TO_THE_EARTH.name,
  statics: [
    {
