// `Undercity Sewers` — the reminder-FIRST surveil land: the mana reminder is printed
...
import { UNDERCITY_SEWERS } from '../../../data/fixtures/engineCards';
...
export const UNDERCITY_SEWERS_SCRIPT: CardScript = {
  oracleId: UNDERCITY_SEWERS.oracleId,
  name: UNDERCITY_SEWERS.name,
  triggers: [
    {
      ...
      label: () => 'Undercity Sewers — surveil 1',
