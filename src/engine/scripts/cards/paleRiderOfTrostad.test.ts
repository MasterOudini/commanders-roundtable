// `Pale Rider of Trostad` - every printed ability proven in its own game: the cost's mark, the pump
...
import { PALE_RIDER_OF_TROSTAD_SCRIPT } from './paleRiderOfTrostad';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Pale Rider of Trostad";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Pale Rider of Trostad"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([PALE_RIDER_OF_TROSTAD_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Pale Rider of Trostad", () => {
  test("When this creature enters: the vocabulary resolves \"Discard a card.\"", () => {
