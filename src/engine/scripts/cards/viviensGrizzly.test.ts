// `Vivien's Grizzly` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Vivien's Grizzly", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([VIVIENS_GRIZZLY_SCRIPT]),
...
describe("Vivien's Grizzly", () => {
  test("{3}{G}: the vocabulary resolves \"Look at the top card of your library. If it's a creature or planeswalker card, you may reveal it and put it into your hand. If you don't put the card into your hand, put it on the bottom of your library.\"", () => {
    const { g } = armed(0);
