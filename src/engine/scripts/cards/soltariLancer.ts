// `Soltari Lancer` - a conditional static (as long as it's attacking) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SOLTARI_LANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SOLTARI_LANCER, "Shadow (This creature can block or be blocked by only creatures with shadow.)\nThis creature has first strike as long as it's attacking.");
...
export const SOLTARI_LANCER_SCRIPT: CardScript = {
  oracleId: SOLTARI_LANCER.oracleId,
  name: SOLTARI_LANCER.name,
  statics: [
    {
