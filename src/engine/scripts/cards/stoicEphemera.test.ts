// `Stoic Ephemera` - every printed ability proven in its own game: the cost's mark, the pump
...
import { STOIC_EPHEMERA_SCRIPT } from './stoicEphemera';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Stoic Ephemera";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Stoic Ephemera"], ["Cyclops of One-Eyed Pass", "Grizzly Bears"]],
    scripts: createRegistry([STOIC_EPHEMERA_SCRIPT]),
...
describe("Stoic Ephemera", () => {
  test("When this creature blocks: the vocabulary resolves \"Sacrifice ~ at end of combat.\"", () => {
