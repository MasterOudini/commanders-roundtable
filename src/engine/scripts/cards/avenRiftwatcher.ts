// `Aven Riftwatcher` - a etb trigger gainLife, a leavesBattlefield trigger gainLife
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AVEN_RIFTWATCHER } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Aven Riftwatcher - gain life",
