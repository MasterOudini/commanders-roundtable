// `Kor Halberd` - an Equipment: the equipped creature gets +1/+1 and has vigilance.
...
import { KOR_HALBERD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KOR_HALBERD, "Equipped creature gets +1/+1 and has vigilance.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const KOR_HALBERD_SCRIPT: CardScript = {
  oracleId: KOR_HALBERD.oracleId,
  name: KOR_HALBERD.name,
  statics: [
    {
