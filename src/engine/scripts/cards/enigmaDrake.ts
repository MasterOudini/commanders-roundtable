// `Enigma Drake` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ENIGMA_DRAKE } from '../../../data/fixtures/engineCards';
...
export const ENIGMA_DRAKE_SCRIPT: CardScript = {
  oracleId: ENIGMA_DRAKE.oracleId,
  name: ENIGMA_DRAKE.name,
  statics: [
    {
      abilityId: 'cda-1',
