// `Crow of Dark Tidings` - a etb trigger mill, a dies trigger mill
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CROW_OF_DARK_TIDINGS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CROW_OF_DARK_TIDINGS, "Flying\nWhen this creature enters or dies, mill two cards. (Put the top two cards of your library into your graveyard.)");
const LINES = PRINTED.split('\n');

export const CROW_OF_DARK_TIDINGS_SCRIPT: CardScript = {
  oracleId: CROW_OF_DARK_TIDINGS.oracleId,
  name: CROW_OF_DARK_TIDINGS.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Crow of Dark Tidings - mill",
