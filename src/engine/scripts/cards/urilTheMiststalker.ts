// `Uril, the Miststalker` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { URIL_THE_MISTSTALKER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(URIL_THE_MISTSTALKER, "Hexproof (This creature can't be the target of spells or abilities your opponents control.)\nUril gets +2/+2 for each Aura attached to it.");
...
export const URIL_THE_MISTSTALKER_SCRIPT: CardScript = {
  oracleId: URIL_THE_MISTSTALKER.oracleId,
  name: URIL_THE_MISTSTALKER.name,
  statics: [
    {
      abilityId: 'pump-1',
