// `Regal Caracal` - a static anthem, a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { REGAL_CARACAL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(REGAL_CARACAL, "Other Cats you control get +1/+1 and have lifelink. (Damage dealt by those creatures also causes you to gain that much life.)\nWhen this creature enters, create two 1/1 white Cat creature tokens with lifelink.");
const LINES = PRINTED.split('\n');
const TOKEN_L1 = tokenRef("Cat|1/1|W|Creature|lifelink");

export const REGAL_CARACAL_SCRIPT: CardScript = {
  oracleId: REGAL_CARACAL.oracleId,
  name: REGAL_CARACAL.name,
  triggers: [
    {
      abilityId: 'etb-1',
