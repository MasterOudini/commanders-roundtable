// `Devoted Duelist` - a secondSpell trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DEVOTED_DUELIST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DEVOTED_DUELIST, "Haste\nFlurry — Whenever you cast your second spell each turn, this creature deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const DEVOTED_DUELIST_SCRIPT: CardScript = {
  oracleId: DEVOTED_DUELIST.oracleId,
  name: DEVOTED_DUELIST.name,
  triggers: [
    {
      ...
      label: () => "Devoted Duelist - damageOpponents",
