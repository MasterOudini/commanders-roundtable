// `Arboreal Grazer` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Arboreal Grazer", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ARBOREAL_GRAZER_SCRIPT]),
...
describe("Arboreal Grazer", () => {
  test("When this creature enters: the vocabulary resolves \"Put a land card from your hand onto the battlefield tapped.\"", () => {
