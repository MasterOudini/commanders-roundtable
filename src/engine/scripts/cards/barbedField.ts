// `Barbed Field` - the permanent it is attached to HAS a quoted
...
import { BARBED_FIELD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BARBED_FIELD, "Enchant land\nEnchanted land has \"{T}: This land deals 1 damage to any target.\"");
const LINES = PRINTED.split('\n');

const GRANT = grantedActivated("{T}: This land deals 1 damage to any target.", `${BARBED_FIELD.oracleId}#g1`, BARBED_FIELD.name);
const VOCAB = vocabularyEffects("This land deals 1 damage to any target.", BARBED_FIELD.name);
const VOCAB_T = vocabularyTargets("This land deals 1 damage to any target.");

export const BARBED_FIELD_SCRIPT: CardScript = {
  oracleId: BARBED_FIELD.oracleId,
  name: BARBED_FIELD.name,
  statics: [
    {
      abilityId: 'grant-1',
