// `Lush Oasis` - a etb trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LUSH_OASIS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LUSH_OASIS, "This land enters tapped.\nWhen this land enters, it deals 1 damage to target opponent.\n{T}: Add {G} or {U}.");
const LINES = PRINTED.split('\n');

export const LUSH_OASIS_SCRIPT: CardScript = {
  oracleId: LUSH_OASIS.oracleId,
  name: LUSH_OASIS.name,
  triggers: [
    {
      abilityId: 'etb-1',
