// `Radiant's Dragoons` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Radiant's Dragoons", "Forest", "Forest", "Forest", "Plains"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RADIANTS_DRAGOONS_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Radiant's Dragoons", () => {
  test("When this creature enters: 5 life is gained", () => {
