// `Messenger's Speed` - an Aura (Enchant creature): the enchanted creature has trample, haste.
...
import { MESSENGER_S_SPEED } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MESSENGER_S_SPEED, "Enchant creature\nEnchanted creature has trample and haste.");
const LINES = PRINTED.split('\n');

export const MESSENGERS_SPEED_SCRIPT: CardScript = {
  oracleId: MESSENGER_S_SPEED.oracleId,
  name: MESSENGER_S_SPEED.name,
  statics: [
    {
