// `Cabal Paladin` - a castSpell trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CABAL_PALADIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CABAL_PALADIN, "Whenever you cast a historic spell, this creature deals 2 damage to each opponent. (Artifacts, legendaries, and Sagas are historic.)");

export const CABAL_PALADIN_SCRIPT: CardScript = {
  oracleId: CABAL_PALADIN.oracleId,
  name: CABAL_PALADIN.name,
  triggers: [
    {
      ...
      label: () => "Cabal Paladin - damageOpponents",
