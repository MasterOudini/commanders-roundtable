// `Felhide Petrifier` - a layer-6 grant: "Other Minotaur creatures you control have deathtouch". A StaticDef in the shape of the
...
import { FELHIDE_PETRIFIER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FELHIDE_PETRIFIER, "Deathtouch\nOther Minotaur creatures you control have deathtouch.");
const TEXT = PRINTED.split('\n')[1] as string;

export const FELHIDE_PETRIFIER_SCRIPT: CardScript = {
  oracleId: FELHIDE_PETRIFIER.oracleId,
  name: FELHIDE_PETRIFIER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
