// `Storm Fleet Aerialist` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STORM_FLEET_AERIALIST } from '../../../data/fixtures/engineCards';
...
export const STORM_FLEET_AERIALIST_SCRIPT: CardScript = {
  oracleId: STORM_FLEET_AERIALIST.oracleId,
  name: STORM_FLEET_AERIALIST.name,
  replacements: [
    {
