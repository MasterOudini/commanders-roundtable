// `Deathcap Cultivator` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DEATHCAP_CULTIVATOR } from '../../../data/fixtures/engineCards';
...
export const DEATHCAP_CULTIVATOR_SCRIPT: CardScript = {
  oracleId: DEATHCAP_CULTIVATOR.oracleId,
  name: DEATHCAP_CULTIVATOR.name,
  statics: [
    {
