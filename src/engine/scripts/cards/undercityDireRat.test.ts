// `Undercity Dire Rat` - every printed ability proven in its own game: the cost's mark, the pump
...
import { UNDERCITY_DIRE_RAT_SCRIPT } from './undercityDireRat';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Undercity Dire Rat";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Undercity Dire Rat"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([UNDERCITY_DIRE_RAT_SCRIPT]),
...
describe("Undercity Dire Rat", () => {
  test("Rat Tail — When this creature dies: 1 token made", () => {
