// `Sinuous Vermin` - an activation vocab, a conditional static (as long as this creature is monstrous) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SINUOUS_VERMIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SINUOUS_VERMIN, "{3}{B}{B}: Monstrosity 3. (If this creature isn't monstrous, put three +1/+1 counters on it and it becomes monstrous.)\nAs long as this creature is monstrous, it has menace. (It can't be blocked except by two or more creatures.)");
const LINES = PRINTED.split('\n');

const VOCAB_A0 = vocabularyEffects("Monstrosity 3.", SINUOUS_VERMIN.name);
...
export const SINUOUS_VERMIN_SCRIPT: CardScript = {
  oracleId: SINUOUS_VERMIN.oracleId,
  name: SINUOUS_VERMIN.name,
  activated: [
    {
      ref: `${SINUOUS_VERMIN.oracleId}#a0`,
