// `Solstice Zealot` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SOLSTICE_ZEALOT_SCRIPT } from './solsticeZealot';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Solstice Zealot";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Solstice Zealot", "Coral Eel"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SOLSTICE_ZEALOT_SCRIPT]),
...
describe("Solstice Zealot", () => {
  ...
  test("{T}, Pay {E}: the declared creature is tapped", () => {
