// `Mystic Penitent` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MYSTIC_PENITENT } from '../../../data/fixtures/engineCards';
...
export const MYSTIC_PENITENT_SCRIPT: CardScript = {
  oracleId: MYSTIC_PENITENT.oracleId,
  name: MYSTIC_PENITENT.name,
  statics: [
    {
