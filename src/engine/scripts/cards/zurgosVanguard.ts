// `Zurgo's Vanguard` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ZURGO_S_VANGUARD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ZURGO_S_VANGUARD, "Mobilize 1 (Whenever this creature attacks, create a tapped and attacking 1/1 red Warrior creature token. Sacrifice it at the beginning of the next end step.)\nZurgo's Vanguard's power is equal to the number of creatures you control.");
...
export const ZURGOS_VANGUARD_SCRIPT: CardScript = {
  oracleId: ZURGO_S_VANGUARD.oracleId,
  name: ZURGO_S_VANGUARD.name,
  statics: [
    {
      abilityId: 'cda-1',
