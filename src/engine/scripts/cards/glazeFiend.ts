// `Glaze Fiend` - a anotherCreatureEnters trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GLAZE_FIEND } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GLAZE_FIEND, "Flying\nWhenever another artifact you control enters, this creature gets +2/+2 until end of turn.");
const LINES = PRINTED.split('\n');

export const GLAZE_FIEND_SCRIPT: CardScript = {
  oracleId: GLAZE_FIEND.oracleId,
  name: GLAZE_FIEND.name,
  triggers: [
    {
      ...
      label: () => "Glaze Fiend - it pumped until end of turn",
