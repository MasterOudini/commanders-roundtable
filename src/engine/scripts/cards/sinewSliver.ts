// `Sinew Sliver` - a layer-6 anthem: "All Sliver creatures get +1/+1". A StaticDef in the shape of the
...
import { SINEW_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SINEW_SLIVER, "All Sliver creatures get +1/+1.");
const TEXT = PRINTED;

export const SINEW_SLIVER_SCRIPT: CardScript = {
  oracleId: SINEW_SLIVER.oracleId,
  name: SINEW_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
