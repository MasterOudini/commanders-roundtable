// `Slimebind` - an Aura (Enchant creature): the enchanted creature gets -4/+0.
...
import { SLIMEBIND } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SLIMEBIND, "Flash (You may cast this spell any time you could cast an instant.)\nEnchant creature\nEnchanted creature gets -4/-0.");
const LINES = PRINTED.split('\n');

export const SLIMEBIND_SCRIPT: CardScript = {
  oracleId: SLIMEBIND.oracleId,
  name: SLIMEBIND.name,
  statics: [
    {
