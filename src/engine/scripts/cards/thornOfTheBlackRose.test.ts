// `Thorn of the Black Rose` - every printed ability proven in its own game: the cost's mark, the pump
...
import { THORN_OF_THE_BLACK_ROSE_SCRIPT } from './thornOfTheBlackRose';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Thorn of the Black Rose";
...
describe("Thorn of the Black Rose", () => {
