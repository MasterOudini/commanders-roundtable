// `Wings of Hope` - an Aura (Enchant creature): the enchanted creature gets +1/+3 and has flying.
...
import { WINGS_OF_HOPE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WINGS_OF_HOPE, "Enchant creature\nEnchanted creature gets +1/+3 and has flying.");
const LINES = PRINTED.split('\n');

export const WINGS_OF_HOPE_SCRIPT: CardScript = {
  oracleId: WINGS_OF_HOPE.oracleId,
  name: WINGS_OF_HOPE.name,
  statics: [
    {
