// `Striking Sliver` - a layer-6 grant: "Sliver creatures you control have first strike. (They deal combat damage before creatures without first strike.)". A StaticDef in the shape of the
...
import { STRIKING_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STRIKING_SLIVER, "Sliver creatures you control have first strike. (They deal combat damage before creatures without first strike.)");
const TEXT = PRINTED;

export const STRIKING_SLIVER_SCRIPT: CardScript = {
  oracleId: STRIKING_SLIVER.oracleId,
  name: STRIKING_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
