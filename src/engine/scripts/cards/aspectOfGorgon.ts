// `Aspect of Gorgon` - an Aura (Enchant creature): the enchanted creature gets +1/+3 and has deathtouch.
...
import { ASPECT_OF_GORGON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ASPECT_OF_GORGON, "Enchant creature\nEnchanted creature gets +1/+3 and has deathtouch. (Any amount of damage it deals to a creature is enough to destroy it.)");
const LINES = PRINTED.split('\n');

export const ASPECT_OF_GORGON_SCRIPT: CardScript = {
  oracleId: ASPECT_OF_GORGON.oracleId,
  name: ASPECT_OF_GORGON.name,
  statics: [
    {
