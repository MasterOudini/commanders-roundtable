// `Generous Ent` - a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GENEROUS_ENT } from '../../../data/fixtures/engineCards';
