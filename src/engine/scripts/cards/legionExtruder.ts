// `Legion Extruder` - a etb trigger damageTarget, an activation token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LEGION_EXTRUDER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LEGION_EXTRUDER, "When this artifact enters, it deals 2 damage to any target.\n{2}, {T}, Sacrifice another artifact: Create a 3/3 colorless Golem artifact creature token.");
const LINES = PRINTED.split('\n');
const TOKEN_0 = tokenRef("Golem|3/3||Artifact Creature|");

export const LEGION_EXTRUDER_SCRIPT: CardScript = {
  oracleId: LEGION_EXTRUDER.oracleId,
  name: LEGION_EXTRUDER.name,
  activated: [
    {
      ref: `${LEGION_EXTRUDER.oracleId}#a0`,
  ...
  triggers: [
    {
      ...
      label: () => "Legion Extruder - damageTarget",
