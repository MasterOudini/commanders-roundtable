// `Instruments of War` - a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { INSTRUMENTS_OF_WAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(INSTRUMENTS_OF_WAR, "Flash\nAs this artifact enters, choose a creature type.\nCreatures you control of the chosen type get +1/+1.");
const LINES = PRINTED.split('\n');

export const INSTRUMENTS_OF_WAR_SCRIPT: CardScript = {
  oracleId: INSTRUMENTS_OF_WAR.oracleId,
  name: INSTRUMENTS_OF_WAR.name,
  statics: [
    {
