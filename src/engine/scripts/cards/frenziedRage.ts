// `Frenzied Rage` - an Aura (Enchant creature): the enchanted creature gets +2/+1 and has menace.
...
import { FRENZIED_RAGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FRENZIED_RAGE, "Enchant creature\nEnchanted creature gets +2/+1 and has menace. (It can't be blocked except by two or more creatures.)");
const LINES = PRINTED.split('\n');

export const FRENZIED_RAGE_SCRIPT: CardScript = {
  oracleId: FRENZIED_RAGE.oracleId,
  name: FRENZIED_RAGE.name,
  statics: [
    {
