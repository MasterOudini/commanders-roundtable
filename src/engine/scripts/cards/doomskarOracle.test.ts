// `Doomskar Oracle` - every printed ability proven in its own game: the cost's mark, the pump
...
import { DOOMSKAR_ORACLE_SCRIPT } from './doomskarOracle';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Doomskar Oracle";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Doomskar Oracle", "Pyretic Ritual", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DOOMSKAR_ORACLE_SCRIPT]),
...
describe("Doomskar Oracle", () => {
  test("Whenever you cast your second spell each turn: 2 life is gained", () => {
