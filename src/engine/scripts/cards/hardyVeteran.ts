// `Hardy Veteran` - a conditional static (as long as it's your turn) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { HARDY_VETERAN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HARDY_VETERAN, "During your turn, this creature gets +0/+2.");
...
export const HARDY_VETERAN_SCRIPT: CardScript = {
  oracleId: HARDY_VETERAN.oracleId,
  name: HARDY_VETERAN.name,
  statics: [
    {
