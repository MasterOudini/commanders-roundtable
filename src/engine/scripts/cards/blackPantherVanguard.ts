// `Black Panther, Vanguard` - a anotherCreatureEnters trigger token, a anotherCreatureEnters trigger pumping its controller's creatures
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLACK_PANTHER_VANGUARD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLACK_PANTHER_VANGUARD, "Whenever another nontoken Hero you control enters, choose one —\n• Create a 1/1 white Soldier creature token.\n• Creatures you control get +1/+1 until end of turn.");
const LINES = PRINTED.split('\n');
const TOKEN_L0_m0 = tokenRef("Soldier|1/1|W|Creature|");

const MODES_L0 = [
  { text: "Create a 1/1 white Soldier creature token.", targets: vocabularyTargets("Create a 1/1 white Soldier creature token.") },
...
export const BLACK_PANTHER_VANGUARD_SCRIPT: CardScript = {
  oracleId: BLACK_PANTHER_VANGUARD.oracleId,
  name: BLACK_PANTHER_VANGUARD.name,
  triggers: [
    {
      ...
      label: () => "Black Panther, Vanguard - choose one",
