// `Candlelight Vigil` - an Aura (Enchant creature): the enchanted creature gets +3/+2 and has vigilance.
...
import { CANDLELIGHT_VIGIL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CANDLELIGHT_VIGIL, "Enchant creature\nEnchanted creature gets +3/+2 and has vigilance.");
const LINES = PRINTED.split('\n');

export const CANDLELIGHT_VIGIL_SCRIPT: CardScript = {
  oracleId: CANDLELIGHT_VIGIL.oracleId,
  name: CANDLELIGHT_VIGIL.name,
  statics: [
    {
