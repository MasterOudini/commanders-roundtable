// `Spitting Sliver` - a layer-6 grant: "All Sliver creatures have first strike". A StaticDef in the shape of the
...
import { SPITTING_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPITTING_SLIVER, "All Sliver creatures have first strike.");
const TEXT = PRINTED;

export const SPITTING_SLIVER_SCRIPT: CardScript = {
  oracleId: SPITTING_SLIVER.oracleId,
  name: SPITTING_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
