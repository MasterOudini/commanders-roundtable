// `Jacques le Vert` - a layer-6 anthem: "Green creatures you control get +0/+2". A StaticDef in the shape of the
...
import { JACQUES_LE_VERT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(JACQUES_LE_VERT, "Green creatures you control get +0/+2.");
const TEXT = PRINTED;

export const JACQUES_LE_VERT_SCRIPT: CardScript = {
  oracleId: JACQUES_LE_VERT.oracleId,
  name: JACQUES_LE_VERT.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
