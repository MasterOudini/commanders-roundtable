// `Bronze Sword` - an Equipment: the equipped creature gets +2/+0.
...
import { BRONZE_SWORD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BRONZE_SWORD, "Equipped creature gets +2/+0.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const BRONZE_SWORD_SCRIPT: CardScript = {
  oracleId: BRONZE_SWORD.oracleId,
  name: BRONZE_SWORD.name,
  statics: [
    {
