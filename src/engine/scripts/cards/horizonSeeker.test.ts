// `Horizon Seeker` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Horizon Seeker", "Grizzly Bears", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([HORIZON_SEEKER_SCRIPT]),
...
describe("Horizon Seeker", () => {
  test("Boast — {1}{G}: the vocabulary resolves \"Search your library for a basic land card, reveal it, put it into your hand, then shuffle.\" - refused unless this creature attacked this turn", () => {
