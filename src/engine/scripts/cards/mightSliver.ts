// `Might Sliver` - a layer-6 anthem: "All Sliver creatures get +2/+2". A StaticDef in the shape of the
...
import { MIGHT_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MIGHT_SLIVER, "All Sliver creatures get +2/+2.");
const TEXT = PRINTED;

export const MIGHT_SLIVER_SCRIPT: CardScript = {
  oracleId: MIGHT_SLIVER.oracleId,
  name: MIGHT_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
