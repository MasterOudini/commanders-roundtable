// `Cryptolith Rite` - every permanent in its scope HAS a quoted
...
import { CRYPTOLITH_RITE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CRYPTOLITH_RITE, "Creatures you control have \"{T}: Add one mana of any color.\"");

const GRANT = grantedMana("{T}: Add one mana of any color.", CRYPTOLITH_RITE.name);

export const CRYPTOLITH_RITE_SCRIPT: CardScript = {
