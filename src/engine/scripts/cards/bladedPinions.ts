// `Bladed Pinions` - an Equipment: the equipped creature has flying, firstStrike.
...
import { BLADED_PINIONS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLADED_PINIONS, "Equipped creature has flying and first strike.\nEquip {2}");
const LINES = PRINTED.split('\n');

export const BLADED_PINIONS_SCRIPT: CardScript = {
  oracleId: BLADED_PINIONS.oracleId,
  name: BLADED_PINIONS.name,
  statics: [
    {
