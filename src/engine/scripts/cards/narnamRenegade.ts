// `Narnam Renegade` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NARNAM_RENEGADE } from '../../../data/fixtures/engineCards';
...
export const NARNAM_RENEGADE_SCRIPT: CardScript = {
  oracleId: NARNAM_RENEGADE.oracleId,
  name: NARNAM_RENEGADE.name,
  replacements: [
    {
