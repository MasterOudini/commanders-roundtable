// `Spinewoods Armadillo` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Spinewoods Armadillo", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SPINEWOODS_ARMADILLO_SCRIPT]),
...
describe("Spinewoods Armadillo", () => {
  test("{1}{G}, Discard this card: the vocabulary resolves \"Search your library for a basic land card or a Desert card, reveal it, put it into your hand, then shuffle. You gain 3 life.\"", () => {
