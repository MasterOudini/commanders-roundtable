// `Bulette` - a endStep trigger selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BULETTE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BULETTE, "At the beginning of your end step, if a creature died this turn, put a +1/+1 counter on this creature.");
...
export const BULETTE_SCRIPT: CardScript = {
  oracleId: BULETTE.oracleId,
  name: BULETTE.name,
  triggers: [
    {
      abilityId: 'endStep-0',
