// `Mighty Emergence` - a creatureEnters trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MIGHTY_EMERGENCE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MIGHTY_EMERGENCE, "Whenever a creature you control with power 5 or greater enters, you may put two +1/+1 counters on it.");

const VOCAB_L0 = vocabularyEffects("Put two +1/+1 counters on target creature.", MIGHTY_EMERGENCE.name);
const VOCAB_T_L0 = vocabularyTargets("Put two +1/+1 counters on target creature.");

export const MIGHTY_EMERGENCE_SCRIPT: CardScript = {
  oracleId: MIGHTY_EMERGENCE.oracleId,
  name: MIGHTY_EMERGENCE.name,
  triggers: [
    {
      ...
      label: () => "Mighty Emergence - Put two +1/+1 counters on target creature.",
