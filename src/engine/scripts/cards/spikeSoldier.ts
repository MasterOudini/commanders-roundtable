// `Spike Soldier` - a static entersWithCounters, an activation counterOnTarget, an activation pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPIKE_SOLDIER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPIKE_SOLDIER, "This creature enters with three +1/+1 counters on it.\n{2}, Remove a +1/+1 counter from this creature: Put a +1/+1 counter on target creature.\nRemove a +1/+1 counter from this creature: This creature gets +2/+2 until end of turn.");
const LINES = PRINTED.split('\n');

export const SPIKE_SOLDIER_SCRIPT: CardScript = {
  oracleId: SPIKE_SOLDIER.oracleId,
  name: SPIKE_SOLDIER.name,
  activated: [
    {
      ref: `${SPIKE_SOLDIER.oracleId}#a0`,
