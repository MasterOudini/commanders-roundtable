// `Drone` - a leavesBattlefield trigger drain
...
const PRINTED = printed(DRONE_CFACAC5F_TOKEN, "Deathtouch\nWhen this creature leaves the battlefield, each opponent loses 2 life and you gain 2 life.");
const LINES = PRINTED.split('\n');

export const DRONE_TOKENCFACAC5F_SCRIPT: CardScript = {
  oracleId: DRONE_CFACAC5F_TOKEN.oracleId,
  name: DRONE_CFACAC5F_TOKEN.name,
  triggers: [
    {
