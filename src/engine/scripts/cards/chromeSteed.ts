// `Chrome Steed` - a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CHROME_STEED } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CHROME_STEED, "Metalcraft — This creature gets +2/+2 as long as you control three or more artifacts.");
...
export const CHROME_STEED_SCRIPT: CardScript = {
  oracleId: CHROME_STEED.oracleId,
  name: CHROME_STEED.name,
  statics: [
    {
