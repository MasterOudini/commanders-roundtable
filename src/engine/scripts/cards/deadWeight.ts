// `Dead Weight` - an Aura (Enchant creature): the enchanted creature gets -2/-2.
...
import { DEAD_WEIGHT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DEAD_WEIGHT, "Enchant creature\nEnchanted creature gets -2/-2.");
const LINES = PRINTED.split('\n');

export const DEAD_WEIGHT_SCRIPT: CardScript = {
  oracleId: DEAD_WEIGHT.oracleId,
