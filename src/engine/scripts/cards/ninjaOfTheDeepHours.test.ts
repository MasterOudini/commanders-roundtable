// `Ninja of the Deep Hours` - every printed ability proven in its own game: the cost's mark, the pump
...
import { NINJA_OF_THE_DEEP_HOURS_SCRIPT } from './ninjaOfTheDeepHours';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Ninja of the Deep Hours";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ninja of the Deep Hours"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([NINJA_OF_THE_DEEP_HOURS_SCRIPT]),
...
describe("Ninja of the Deep Hours", () => {
