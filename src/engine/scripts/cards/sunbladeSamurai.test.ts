// `Sunblade Samurai` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Sunblade Samurai", "Plains"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SUNBLADE_SAMURAI_SCRIPT]),
...
describe("Sunblade Samurai", () => {
  test("Channel — {2}, Discard this card: the vocabulary resolves \"Search your library for a basic Plains card, reveal it, put it into your hand, then shuffle. You gain 2 life.\"", () => {
