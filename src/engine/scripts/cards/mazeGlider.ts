// `Maze Glider` - a layer-6 grant: "Multicolored creatures you control have flying". A StaticDef in the shape of the
...
import { MAZE_GLIDER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAZE_GLIDER, "Flying\nMulticolored creatures you control have flying.");
const TEXT = PRINTED.split('\n')[1] as string;

export const MAZE_GLIDER_SCRIPT: CardScript = {
  oracleId: MAZE_GLIDER.oracleId,
  name: MAZE_GLIDER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
