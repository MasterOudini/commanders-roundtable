// `Zulaport Cutthroat` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ZULAPORT_CUTTHROAT_SCRIPT } from './zulaportCutthroat';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Zulaport Cutthroat";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Zulaport Cutthroat", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ZULAPORT_CUTTHROAT_SCRIPT]),
