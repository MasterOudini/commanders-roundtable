// `Kaervek, the Spiteful` - a layer-6 anthem: "Other creatures get -1/-1". A StaticDef in the shape of the
...
import { KAERVEK_THE_SPITEFUL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KAERVEK_THE_SPITEFUL, "Other creatures get -1/-1.");
const TEXT = PRINTED;

export const KAERVEK_THE_SPITEFUL_SCRIPT: CardScript = {
  oracleId: KAERVEK_THE_SPITEFUL.oracleId,
  name: KAERVEK_THE_SPITEFUL.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
