// `Kavu Scout` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { KAVU_SCOUT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KAVU_SCOUT, "Domain — This creature gets +1/+0 for each basic land type among lands you control.");
...
export const KAVU_SCOUT_SCRIPT: CardScript = {
  oracleId: KAVU_SCOUT.oracleId,
  name: KAVU_SCOUT.name,
  statics: [
    {
      abilityId: 'pump-0',
