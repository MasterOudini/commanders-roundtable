// `Snarespinner` - a blocks trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SNARESPINNER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SNARESPINNER, "Reach\nWhenever this creature blocks a creature with flying, this creature gets +2/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const SNARESPINNER_SCRIPT: CardScript = {
  oracleId: SNARESPINNER.oracleId,
  name: SNARESPINNER.name,
  triggers: [
    {
      abilityId: 'blocks-1',
      ...
      label: () => "Snarespinner - it pumped until end of turn",
