// `Giant Spectacle` - an Aura (Enchant creature): the enchanted creature gets +2/+1 and has menace.
...
import { GIANT_SPECTACLE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GIANT_SPECTACLE, "Enchant creature\nEnchanted creature gets +2/+1 and has menace.");
const LINES = PRINTED.split('\n');

export const GIANT_SPECTACLE_SCRIPT: CardScript = {
  oracleId: GIANT_SPECTACLE.oracleId,
  name: GIANT_SPECTACLE.name,
  statics: [
    {
