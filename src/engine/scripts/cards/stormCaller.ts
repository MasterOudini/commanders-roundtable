// `Storm Caller` - a etb trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STORM_CALLER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STORM_CALLER, "When this creature enters, it deals 2 damage to each opponent.");

export const STORM_CALLER_SCRIPT: CardScript = {
  oracleId: STORM_CALLER.oracleId,
  name: STORM_CALLER.name,
  triggers: [
    {
      abilityId: 'etb-0',
      text: PRINTED,
      ...
      label: () => "Storm Caller - damageOpponents",
