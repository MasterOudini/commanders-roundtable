// `Savage Hunger` - an Aura (Enchant creature): the enchanted creature gets +1/+0 and has trample.
...
import { SAVAGE_HUNGER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SAVAGE_HUNGER, "Enchant creature\nEnchanted creature gets +1/+0 and has trample.\nCycling {2} ({2}, Discard this card: Draw a card.)");
const LINES = PRINTED.split('\n');

export const SAVAGE_HUNGER_SCRIPT: CardScript = {
  oracleId: SAVAGE_HUNGER.oracleId,
  name: SAVAGE_HUNGER.name,
  statics: [
    {
