// `Trynn, Champion of Freedom` - a endStep trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TRYNN_CHAMPION_OF_FREEDOM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TRYNN_CHAMPION_OF_FREEDOM, "Partner with Silvar, Devourer of the Free (When this creature enters, target player may put Silvar into their hand from their library, then shuffle.)\nAt the beginning of your end step, if you attacked this turn, create a 1/1 white Human Soldier creature token.");
...
export const TRYNN_CHAMPION_OF_FREEDOM_SCRIPT: CardScript = {
  oracleId: TRYNN_CHAMPION_OF_FREEDOM.oracleId,
  name: TRYNN_CHAMPION_OF_FREEDOM.name,
  triggers: [
    {
      abilityId: 'endStep-1',
      ...
      label: () => "Trynn, Champion of Freedom - token",
