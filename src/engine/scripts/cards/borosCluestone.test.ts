// `Boros Cluestone` — the sacrifice-draw, spent at activation.

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { BOROS_CLUESTONE_SCRIPT } from './borosCluestone';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CLUESTONE = 'Boros Cluestone';
...
function game(): { g: Game; stone: InstanceId } {
  const g = startedGame({
    players: 2,
    decks: [[CLUESTONE], []],
    scripts: createRegistry([BOROS_CLUESTONE_SCRIPT]),
  });
