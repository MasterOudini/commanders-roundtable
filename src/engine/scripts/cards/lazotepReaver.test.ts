// `Lazotep Reaver` - every printed ability proven in its own game: the cost's mark, the pump
...
import { LAZOTEP_REAVER_SCRIPT } from './lazotepReaver';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Lazotep Reaver";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Lazotep Reaver"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([LAZOTEP_REAVER_SCRIPT]),
...
describe("Lazotep Reaver", () => {
  test("When this creature enters: the vocabulary resolves \"Amass Zombies 1.\"", () => {
