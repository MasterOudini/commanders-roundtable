// `Elvish Pioneer` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Elvish Pioneer", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ELVISH_PIONEER_SCRIPT]),
...
describe("Elvish Pioneer", () => {
  test("When this creature enters: the vocabulary resolves \"Put a basic land card from your hand onto the battlefield tapped.\"", () => {
