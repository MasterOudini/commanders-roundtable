// `Torens, Fist of the Angels` - every printed ability proven in its own game: the cost's mark, the pump
...
import { TORENS_FIST_OF_THE_ANGELS_SCRIPT } from './torensFistOfTheAngels';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Torens, Fist of the Angels";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Torens, Fist of the Angels", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([TORENS_FIST_OF_THE_ANGELS_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Torens, Fist of the Angels", () => {
