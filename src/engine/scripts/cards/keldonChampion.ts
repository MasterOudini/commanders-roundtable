// `Keldon Champion` - a etb trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { KELDON_CHAMPION } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Keldon Champion - damageTarget",
