// `Prodigious Growth` - an Aura (Enchant creature): the enchanted creature gets +7/+7 and has trample.
...
import { PRODIGIOUS_GROWTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PRODIGIOUS_GROWTH, "Enchant creature\nEnchanted creature gets +7/+7 and has trample.");
const LINES = PRINTED.split('\n');

export const PRODIGIOUS_GROWTH_SCRIPT: CardScript = {
  oracleId: PRODIGIOUS_GROWTH.oracleId,
  name: PRODIGIOUS_GROWTH.name,
  statics: [
    {
