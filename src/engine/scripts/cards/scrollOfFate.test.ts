// `Scroll of Fate` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Scroll of Fate", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SCROLL_OF_FATE_SCRIPT]),
...
describe("Scroll of Fate", () => {
  test("{T}: the vocabulary resolves \"Manifest a card from your hand.\"", () => {
