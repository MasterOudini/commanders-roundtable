// `Victual Sliver` - every permanent in its scope HAS a quoted
...
import { VICTUAL_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VICTUAL_SLIVER, "All Slivers have \"{2}, Sacrifice this permanent: You gain 4 life.\"");

const GRANT = grantedActivated("{2}, Sacrifice this permanent: You gain 4 life.", `${VICTUAL_SLIVER.oracleId}#g0`, VICTUAL_SLIVER.name);
const VOCAB = vocabularyEffects("You gain 4 life.", VICTUAL_SLIVER.name);
const VOCAB_T = vocabularyTargets("You gain 4 life.");

export const VICTUAL_SLIVER_SCRIPT: CardScript = {
  oracleId: VICTUAL_SLIVER.oracleId,
  name: VICTUAL_SLIVER.name,
  statics: [
    {
      abilityId: 'grant-0',
      text: PRINTED,
