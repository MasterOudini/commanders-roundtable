// `Battle Sliver` - a layer-6 anthem: "Sliver creatures you control get +2/+0". A StaticDef in the shape of the
...
import { BATTLE_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BATTLE_SLIVER, "Sliver creatures you control get +2/+0.");
const TEXT = PRINTED;

export const BATTLE_SLIVER_SCRIPT: CardScript = {
  oracleId: BATTLE_SLIVER.oracleId,
  name: BATTLE_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
