// `Night Market Aeronaut` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NIGHT_MARKET_AERONAUT } from '../../../data/fixtures/engineCards';
...
export const NIGHT_MARKET_AERONAUT_SCRIPT: CardScript = {
  oracleId: NIGHT_MARKET_AERONAUT.oracleId,
  name: NIGHT_MARKET_AERONAUT.name,
  replacements: [
    {
