// `Giant Strength` - an Aura (Enchant creature): the enchanted creature gets +2/+2.
...
import { GIANT_STRENGTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GIANT_STRENGTH, "Enchant creature\nEnchanted creature gets +2/+2.");
const LINES = PRINTED.split('\n');

export const GIANT_STRENGTH_SCRIPT: CardScript = {
  oracleId: GIANT_STRENGTH.oracleId,
  name: GIANT_STRENGTH.name,
  statics: [
    {
