// `Leonin Vanguard` - every printed ability proven in its own game: the cost's mark, the pump
...
import { LEONIN_VANGUARD_SCRIPT } from './leoninVanguard';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Leonin Vanguard";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Leonin Vanguard", "Grizzly Bears", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([LEONIN_VANGUARD_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Leonin Vanguard", () => {
  test("At the beginning of combat on your turn: the vocabulary resolves \"~ gets +1/+1 until end of turn and you gain 1 life.\"", () => {
