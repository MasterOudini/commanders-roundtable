// `Rock Basilisk` - a blocksOrBecomesBlockedBy trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ROCK_BASILISK } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ROCK_BASILISK, "Whenever this creature blocks or becomes blocked by a non-Wall creature, destroy that creature at end of combat.");

const VOCAB_L0 = vocabularyEffects("Destroy target creature at end of combat.", ROCK_BASILISK.name);
const VOCAB_T_L0 = vocabularyTargets("Destroy target creature at end of combat.");

export const ROCK_BASILISK_SCRIPT: CardScript = {
  oracleId: ROCK_BASILISK.oracleId,
  name: ROCK_BASILISK.name,
  triggers: [
    {
      ...
      label: () => "Rock Basilisk - Destroy target creature at end of combat.",
