// `Kinsbaile Cavalier` - a layer-6 grant: "Knight creatures you control have double strike". A StaticDef in the shape of the
...
import { KINSBAILE_CAVALIER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KINSBAILE_CAVALIER, "Knight creatures you control have double strike.");
const TEXT = PRINTED;

export const KINSBAILE_CAVALIER_SCRIPT: CardScript = {
  oracleId: KINSBAILE_CAVALIER.oracleId,
  name: KINSBAILE_CAVALIER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
