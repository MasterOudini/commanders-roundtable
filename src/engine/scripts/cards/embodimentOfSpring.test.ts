// `Embodiment of Spring` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Embodiment of Spring", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([EMBODIMENT_OF_SPRING_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Embodiment of Spring", () => {
  test("{1}{G}, {T}, Sacrifice this creature: the vocabulary resolves \"Search your library for a basic land card, put it onto the battlefield tapped, then shuffle.\"", () => {
