// `Sangrite Backlash` - an Aura (Enchant creature): the enchanted creature gets +3/-3.
...
import { SANGRITE_BACKLASH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SANGRITE_BACKLASH, "Enchant creature\nEnchanted creature gets +3/-3.");
const LINES = PRINTED.split('\n');

export const SANGRITE_BACKLASH_SCRIPT: CardScript = {
  oracleId: SANGRITE_BACKLASH.oracleId,
  name: SANGRITE_BACKLASH.name,
  statics: [
    {
