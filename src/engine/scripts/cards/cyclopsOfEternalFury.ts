// `Cyclops of Eternal Fury` - a layer-6 grant: "Creatures you control have haste". A StaticDef in the shape of the
...
import { CYCLOPS_OF_ETERNAL_FURY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CYCLOPS_OF_ETERNAL_FURY, "Creatures you control have haste.");
const TEXT = PRINTED;

export const CYCLOPS_OF_ETERNAL_FURY_SCRIPT: CardScript = {
  oracleId: CYCLOPS_OF_ETERNAL_FURY.oracleId,
  name: CYCLOPS_OF_ETERNAL_FURY.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
