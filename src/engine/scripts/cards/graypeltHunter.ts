// `Graypelt Hunter` - a selfOrAnotherAllyEnters trigger selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GRAYPELT_HUNTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GRAYPELT_HUNTER, "Trample\nWhenever this creature or another Ally you control enters, you may put a +1/+1 counter on this creature.");
const LINES = PRINTED.split('\n');

export const GRAYPELT_HUNTER_SCRIPT: CardScript = {
  oracleId: GRAYPELT_HUNTER.oracleId,
  name: GRAYPELT_HUNTER.name,
  triggers: [
    {
      ...
      label: () => "Graypelt Hunter - a counter on it",
