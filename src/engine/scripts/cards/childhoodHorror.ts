// `Childhood Horror` - a static threshold, a static cantBlock
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CHILDHOOD_HORROR } from '../../../data/fixtures/engineCards';
...
export const CHILDHOOD_HORROR_SCRIPT: CardScript = {
  oracleId: CHILDHOOD_HORROR.oracleId,
  name: CHILDHOOD_HORROR.name,
  combat: [
    {
