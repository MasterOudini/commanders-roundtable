// `Steelform Sliver` - a layer-6 anthem: "Sliver creatures you control get +0/+1". A StaticDef in the shape of the
...
import { STEELFORM_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STEELFORM_SLIVER, "Sliver creatures you control get +0/+1.");
const TEXT = PRINTED;

export const STEELFORM_SLIVER_SCRIPT: CardScript = {
  oracleId: STEELFORM_SLIVER.oracleId,
  name: STEELFORM_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
