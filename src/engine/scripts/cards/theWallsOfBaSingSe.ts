// `The Walls of Ba Sing Se` - a layer-6 grant: "Other permanents you control have indestructible". A StaticDef in the shape of the
...
import { THE_WALLS_OF_BA_SING_SE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(THE_WALLS_OF_BA_SING_SE, "Defender\nOther permanents you control have indestructible.");
const TEXT = PRINTED.split('\n')[1] as string;

export const THE_WALLS_OF_BA_SING_SE_SCRIPT: CardScript = {
  oracleId: THE_WALLS_OF_BA_SING_SE.oracleId,
  name: THE_WALLS_OF_BA_SING_SE.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
