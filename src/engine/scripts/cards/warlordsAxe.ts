// `Warlord's Axe` - an Equipment: the equipped creature gets +3/+1.
...
import { WARLORD_S_AXE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WARLORD_S_AXE, "Equipped creature gets +3/+1.\nEquip {4} ({4}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const WARLORDS_AXE_SCRIPT: CardScript = {
  oracleId: WARLORD_S_AXE.oracleId,
  name: WARLORD_S_AXE.name,
  statics: [
    {
