// `Adelbert Steiner` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { ADELBERT_STEINER } from '../../../data/fixtures/engineCards';
...
export const ADELBERT_STEINER_SCRIPT: CardScript = {
  oracleId: ADELBERT_STEINER.oracleId,
  name: ADELBERT_STEINER.name,
  statics: [
    {
      abilityId: 'pump-1',
