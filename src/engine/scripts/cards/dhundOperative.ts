// `Dhund Operative` - a conditional static (as long as you control an artifact) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DHUND_OPERATIVE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DHUND_OPERATIVE, "As long as you control an artifact, this creature gets +1/+0 and has deathtouch.");
...
export const DHUND_OPERATIVE_SCRIPT: CardScript = {
  oracleId: DHUND_OPERATIVE.oracleId,
  name: DHUND_OPERATIVE.name,
  statics: [
    {
