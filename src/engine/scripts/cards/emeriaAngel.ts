// `Emeria Angel` - a landfall trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { EMERIA_ANGEL } from '../../../data/fixtures/engineCards';
