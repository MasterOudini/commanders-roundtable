// `Victual Sliver` - the carrier proven end to end (D367): the recipient HAS the quoted
...
import { VICTUAL_SLIVER_SCRIPT } from './victualSliver';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Victual Sliver";
...
function board(): { g: Game; self: InstanceId; host: InstanceId; no: InstanceId } {
  const g = startedGame({
    players: 2,
    decks: [["Victual Sliver","Metallic Sliver"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([VICTUAL_SLIVER_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Victual Sliver", () => {
  test("grants {2}, Sacrifice this permanent: You gain 4 life. to Metallic Sliver, and to nothing outside the scope", () => {
