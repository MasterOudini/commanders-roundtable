// `Filthy Cur` - a isDealtCombatDamage trigger vocab, a isDealtNoncombatDamage trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FILTHY_CUR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FILTHY_CUR, "Whenever this creature is dealt damage, you lose that much life.");

const VOCAB_L0 = vocabularyEffects("You lose that much life.", FILTHY_CUR.name, { memo: true });
const VOCAB_T_L0 = vocabularyTargets("You lose that much life.");

export const FILTHY_CUR_SCRIPT: CardScript = {
  oracleId: FILTHY_CUR.oracleId,
  name: FILTHY_CUR.name,
  triggers: [
    {
      ...
      label: () => "Filthy Cur - You lose that much life.",
