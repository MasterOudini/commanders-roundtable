// `Bloodscale Prowler` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLOODSCALE_PROWLER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLOODSCALE_PROWLER, "Bloodthirst 1 (If an opponent was dealt damage this turn, this creature enters with a +1/+1 counter on it.)");
...
export const BLOODSCALE_PROWLER_SCRIPT: CardScript = {
  oracleId: BLOODSCALE_PROWLER.oracleId,
  name: BLOODSCALE_PROWLER.name,
  replacements: [
    {
