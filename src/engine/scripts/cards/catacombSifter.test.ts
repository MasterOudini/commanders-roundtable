// `Catacomb Sifter` - every printed ability proven in its own game: the cost's mark, the pump
...
import { CATACOMB_SIFTER_SCRIPT } from './catacombSifter';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Catacomb Sifter";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Catacomb Sifter", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CATACOMB_SIFTER_SCRIPT]),
...
describe("Catacomb Sifter", () => {
  ...
  test("Whenever another creature you control dies: scry 1 asks, and the cards stay on top", () => {
