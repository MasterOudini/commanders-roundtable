// `Veteran Armorer` - a layer-6 anthem: "Other creatures you control get +0/+1". A StaticDef in the shape of the
...
import { VETERAN_ARMORER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VETERAN_ARMORER, "Other creatures you control get +0/+1.");
const TEXT = PRINTED;

export const VETERAN_ARMORER_SCRIPT: CardScript = {
  oracleId: VETERAN_ARMORER.oracleId,
  name: VETERAN_ARMORER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
