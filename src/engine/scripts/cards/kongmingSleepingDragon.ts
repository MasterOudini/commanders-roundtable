// `Kongming, "Sleeping Dragon"` - a layer-6 anthem: "Other creatures you control get +1/+1". A StaticDef in the shape of the
...
import { KONGMING_SLEEPING_DRAGON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KONGMING_SLEEPING_DRAGON, "Other creatures you control get +1/+1.");
const TEXT = PRINTED;

export const KONGMING_SLEEPING_DRAGON_SCRIPT: CardScript = {
  oracleId: KONGMING_SLEEPING_DRAGON.oracleId,
  name: KONGMING_SLEEPING_DRAGON.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
