// `Greataxe` - an Equipment: the equipped creature gets +4/+0.
...
import { GREATAXE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GREATAXE, "Equipped creature gets +4/+0.\nEquip {5} ({5}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const GREATAXE_SCRIPT: CardScript = {
  oracleId: GREATAXE.oracleId,
  name: GREATAXE.name,
  statics: [
    {
