// `Wizard` - a castNoncreature trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WIZARD_04AE24BF_TOKEN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WIZARD_04AE24BF_TOKEN, "Whenever you cast a noncreature spell, this token deals 1 damage to each opponent.");

export const WIZARD_TOKEN04AE24BF_SCRIPT: CardScript = {
  oracleId: WIZARD_04AE24BF_TOKEN.oracleId,
  name: WIZARD_04AE24BF_TOKEN.name,
  triggers: [
    {
