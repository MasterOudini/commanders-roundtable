// `Gretchen Titchwillow` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Gretchen Titchwillow", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GRETCHEN_TITCHWILLOW_SCRIPT]),
...
describe("Gretchen Titchwillow", () => {
  test("{2}{G}{U}: the vocabulary resolves \"Draw a card. You may put a land card from your hand onto the battlefield.\"", () => {
