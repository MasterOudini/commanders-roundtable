// `Loam Dweller` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Loam Dweller", "Cloud Spirit", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([LOAM_DWELLER_SCRIPT]),
...
describe("Loam Dweller", () => {
  test("Whenever you cast a Spirit or Arcane spell: the vocabulary resolves \"Put a land card from your hand onto the battlefield tapped.\"", () => {
