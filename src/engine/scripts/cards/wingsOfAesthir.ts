// `Wings of Aesthir` - an Aura (Enchant creature): the enchanted creature gets +1/+0 and has flying, firstStrike.
...
import { WINGS_OF_AESTHIR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WINGS_OF_AESTHIR, "Enchant creature\nEnchanted creature gets +1/+0 and has flying and first strike.");
const LINES = PRINTED.split('\n');

export const WINGS_OF_AESTHIR_SCRIPT: CardScript = {
  oracleId: WINGS_OF_AESTHIR.oracleId,
  name: WINGS_OF_AESTHIR.name,
  statics: [
    {
