// `Divine Transformation` - an Aura (Enchant creature): the enchanted creature gets +3/+3.
...
import { DIVINE_TRANSFORMATION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DIVINE_TRANSFORMATION, "Enchant creature\nEnchanted creature gets +3/+3.");
const LINES = PRINTED.split('\n');

export const DIVINE_TRANSFORMATION_SCRIPT: CardScript = {
  oracleId: DIVINE_TRANSFORMATION.oracleId,
  name: DIVINE_TRANSFORMATION.name,
  statics: [
    {
