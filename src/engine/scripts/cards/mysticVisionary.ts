// `Mystic Visionary` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MYSTIC_VISIONARY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MYSTIC_VISIONARY, "Threshold — This creature has flying as long as there are seven or more cards in your graveyard.");
...
export const MYSTIC_VISIONARY_SCRIPT: CardScript = {
  oracleId: MYSTIC_VISIONARY.oracleId,
  name: MYSTIC_VISIONARY.name,
  statics: [
    {
