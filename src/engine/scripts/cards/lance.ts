// `Lance` - an Aura (Enchant creature): the enchanted creature has firstStrike.
...
import { LANCE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LANCE, "Enchant creature\nEnchanted creature has first strike.");
const LINES = PRINTED.split('\n');

export const LANCE_SCRIPT: CardScript = {
  oracleId: LANCE.oracleId,
  name: LANCE.name,
  statics: [
    {
