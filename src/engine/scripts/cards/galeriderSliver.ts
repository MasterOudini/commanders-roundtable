// `Galerider Sliver` - a layer-6 grant: "Sliver creatures you control have flying". A StaticDef in the shape of the
...
import { GALERIDER_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GALERIDER_SLIVER, "Sliver creatures you control have flying.");
const TEXT = PRINTED;

export const GALERIDER_SLIVER_SCRIPT: CardScript = {
  oracleId: GALERIDER_SLIVER.oracleId,
  name: GALERIDER_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
