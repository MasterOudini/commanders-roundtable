// `Serra's Guardian` - a layer-6 grant: "Other creatures you control have vigilance". A StaticDef in the shape of the
...
import { SERRA_S_GUARDIAN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SERRA_S_GUARDIAN, "Flying (This creature can't be blocked except by creatures with flying or reach.)\nVigilance (Attacking doesn't cause this creature to tap.)\nOther creatures you control have vigilance.");
const TEXT = PRINTED.split('\n')[2] as string;

export const SERRAS_GUARDIAN_SCRIPT: CardScript = {
  oracleId: SERRA_S_GUARDIAN.oracleId,
  name: SERRA_S_GUARDIAN.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
