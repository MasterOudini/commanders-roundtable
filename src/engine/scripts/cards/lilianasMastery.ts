// `Liliana's Mastery` - a static anthem, a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LILIANA_S_MASTERY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LILIANA_S_MASTERY, "Zombies you control get +1/+1.\nWhen this enchantment enters, create two 2/2 black Zombie creature tokens.");
const LINES = PRINTED.split('\n');
const TOKEN_L1 = tokenRef("Zombie|2/2|B|Creature|");

export const LILIANAS_MASTERY_SCRIPT: CardScript = {
  oracleId: LILIANA_S_MASTERY.oracleId,
  name: LILIANA_S_MASTERY.name,
  triggers: [
    {
      abilityId: 'etb-1',
