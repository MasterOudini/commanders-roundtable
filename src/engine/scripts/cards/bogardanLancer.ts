// `Bogardan Lancer` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BOGARDAN_LANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BOGARDAN_LANCER, "Bloodthirst 1 (If an opponent was dealt damage this turn, this creature enters with a +1/+1 counter on it.)\nFlanking (Whenever a creature without flanking blocks this creature, the blocking creature gets -1/-1 until end of turn.)");
...
export const BOGARDAN_LANCER_SCRIPT: CardScript = {
  oracleId: BOGARDAN_LANCER.oracleId,
  name: BOGARDAN_LANCER.name,
  replacements: [
    {
