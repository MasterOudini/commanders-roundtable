// `Gixian Skullflayer` - every printed ability proven in its own game: the cost's mark, the pump
...
import { GIXIAN_SKULLFLAYER_SCRIPT } from './gixianSkullflayer';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Gixian Skullflayer";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Gixian Skullflayer", "Grizzly Bears", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GIXIAN_SKULLFLAYER_SCRIPT]),
...
describe("Gixian Skullflayer", () => {
  test("At the beginning of your upkeep: it gets 1 +1/+1 counter", () => {
