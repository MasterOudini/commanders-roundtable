// `Short Sword` - an Equipment: the equipped creature gets +1/+1.
...
import { SHORT_SWORD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHORT_SWORD, "Equipped creature gets +1/+1.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const SHORT_SWORD_SCRIPT: CardScript = {
  oracleId: SHORT_SWORD.oracleId,
