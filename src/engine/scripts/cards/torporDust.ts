// `Torpor Dust` - an Aura (Enchant creature): the enchanted creature gets -3/+0.
...
import { TORPOR_DUST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TORPOR_DUST, "Flash\nEnchant creature\nEnchanted creature gets -3/-0.");
const LINES = PRINTED.split('\n');

export const TORPOR_DUST_SCRIPT: CardScript = {
  oracleId: TORPOR_DUST.oracleId,
  name: TORPOR_DUST.name,
  statics: [
    {
