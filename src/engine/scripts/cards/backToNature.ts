// `Back to Nature` — "Destroy all enchantments." Armageddon's shape one type
...
const TEXT = printed(BACK_TO_NATURE, 'Destroy all enchantments.');

export const BACK_TO_NATURE_SCRIPT: CardScript = {
  oracleId: BACK_TO_NATURE.oracleId,
  name: BACK_TO_NATURE.name,
  spell: {
    text: TEXT,
