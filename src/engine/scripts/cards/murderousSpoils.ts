// `Murderous Spoils` - a scripted spell: the target clause is the parser's and the validator's
// (D294's adjectives), the rider is this script's. Generated from one table row (D295).

import { MURDEROUS_SPOILS } from '../../../data/fixtures/engineCards';
...
const TEXT = printed(MURDEROUS_SPOILS, "Destroy target nonblack creature. It can't be regenerated. You gain control of all Equipment that were attached to it. (This effect lasts indefinitely.)");

export const MURDEROUS_SPOILS_SCRIPT: CardScript = {
  oracleId: MURDEROUS_SPOILS.oracleId,
  name: MURDEROUS_SPOILS.name,
  spell: {
    text: TEXT,
