// `Remnant Elemental` - a landfall trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { REMNANT_ELEMENTAL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(REMNANT_ELEMENTAL, "Reach\nLandfall — Whenever a land you control enters, this creature gets +2/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const REMNANT_ELEMENTAL_SCRIPT: CardScript = {
  oracleId: REMNANT_ELEMENTAL.oracleId,
  name: REMNANT_ELEMENTAL.name,
  triggers: [
    {
      ...
      label: () => "Remnant Elemental - it pumped until end of turn",
