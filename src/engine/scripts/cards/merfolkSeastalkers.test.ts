// `Merfolk Seastalkers` — {2}{U} taps their ground creature; the flyer is
// refused ("without flying", D289).

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { MERFOLK_SEASTALKERS_SCRIPT } from './merfolkSeastalkers';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = 'Merfolk Seastalkers';
...
function placed(): { g: Game; hawk: InstanceId; bears: InstanceId } {
  const g = startedGame({ players: 2, decks: [[CARD], [HAWK, BEARS]], scripts: createRegistry([MERFOLK_SEASTALKERS_SCRIPT]) });
