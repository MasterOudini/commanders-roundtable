// `Balduvian War-Makers` - a becomesBlocked trigger rampage
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BALDUVIAN_WAR_MAKERS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BALDUVIAN_WAR_MAKERS, "Haste\nRampage 1 (Whenever this creature becomes blocked, it gets +1/+1 until end of turn for each creature blocking it beyond the first.)");
const LINES = PRINTED.split('\n');

export const BALDUVIAN_WAR_MAKERS_SCRIPT: CardScript = {
  oracleId: BALDUVIAN_WAR_MAKERS.oracleId,
  name: BALDUVIAN_WAR_MAKERS.name,
  triggers: [
    {
      ...
      label: () => "Balduvian War-Makers - rampage",
