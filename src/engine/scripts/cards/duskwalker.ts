// `Duskwalker` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DUSKWALKER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DUSKWALKER, "Kicker {3}{B} (You may pay an additional {3}{B} as you cast this spell.)\nIf this creature was kicked, it enters with two +1/+1 counters on it and with fear. (It can't be blocked except by artifact creatures and/or black creatures.)");
const LINES = PRINTED.split('\n');


export const DUSKWALKER_SCRIPT: CardScript = {
  oracleId: DUSKWALKER.oracleId,
