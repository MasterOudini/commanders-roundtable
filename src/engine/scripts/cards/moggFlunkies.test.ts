// `Mogg Flunkies` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MOGG_FLUNKIES_SCRIPT } from './moggFlunkies';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Mogg Flunkies";
