// `Strength of Unity` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { STRENGTH_OF_UNITY } from '../../../data/fixtures/engineCards';
...
export const STRENGTH_OF_UNITY_SCRIPT: CardScript = {
  oracleId: STRENGTH_OF_UNITY.oracleId,
  name: STRENGTH_OF_UNITY.name,
  statics: [
    {
      abilityId: 'pump-1',
