// `Concordant Crossroads` - a layer-6 grant: "All creatures have haste". A StaticDef in the shape of the
...
import { CONCORDANT_CROSSROADS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CONCORDANT_CROSSROADS, "All creatures have haste.");
const TEXT = PRINTED;

export const CONCORDANT_CROSSROADS_SCRIPT: CardScript = {
  oracleId: CONCORDANT_CROSSROADS.oracleId,
  name: CONCORDANT_CROSSROADS.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
