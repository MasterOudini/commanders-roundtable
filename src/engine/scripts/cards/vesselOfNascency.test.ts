// `Vessel of Nascency` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Vessel of Nascency", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([VESSEL_OF_NASCENCY_SCRIPT]),
...
describe("Vessel of Nascency", () => {
  test("{1}{G}, Sacrifice this enchantment: the vocabulary resolves \"Reveal the top four cards of your library. You may put an artifact, creature, enchantment, land, or planeswalker card from among them into your hand. Put the rest into your graveyard.\"", () => {
