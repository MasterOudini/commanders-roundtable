// `Ruthless Predation` — Epic Confrontation's EXACT text on a second id:
// the +1/+2 pump, then the fight with the pump already counted. D242.

import { RUTHLESS_PREDATION } from '../../../data/fixtures/engineCards';
...
export const RUTHLESS_PREDATION_SCRIPT: CardScript = {
  oracleId: RUTHLESS_PREDATION.oracleId,
  name: RUTHLESS_PREDATION.name,
  spell: {
    text: TEXT,
