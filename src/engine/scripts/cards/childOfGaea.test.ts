// `Child of Gaea` - every printed ability proven in its own game: the cost's mark, the pump
...
import { CHILD_OF_GAEA_SCRIPT } from './childOfGaea';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Child of Gaea";

type Armed = { g: Game; self: InstanceId; no: InstanceId; life0: number; hand0: number; board0: number; p2life0: number; gy0: number; lib0: number; payL1_p1_0: InstanceId; payL1_p1_1: InstanceId };
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Child of Gaea", "Infernal Grasp", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CHILD_OF_GAEA_SCRIPT]),
  });
  holdEverywhere(g);
  ...
  return { g, self, no, life0, hand0, board0, p2life0, gy0, lib0, payL1_p1_0, payL1_p1_1 };
}

describe("Child of Gaea", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {G}{G}.\" - the price is declined", () => {
  ...
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {G}{G}.\" - the price is paid", () => {
  ...
  test("{1}{G}: it regenerates from the Bolt", () => {
