// `Glorious Anthem` - a layer-6 anthem: "Creatures you control get +1/+1". A StaticDef in the shape of the
...
import { GLORIOUS_ANTHEM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GLORIOUS_ANTHEM, "Creatures you control get +1/+1.");
const TEXT = PRINTED;

export const GLORIOUS_ANTHEM_SCRIPT: CardScript = {
  oracleId: GLORIOUS_ANTHEM.oracleId,
  name: GLORIOUS_ANTHEM.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
