// `Junún Efreet` - every printed ability proven in its own game: the cost's mark, the pump
...
import { JUN_NEFREET_SCRIPT } from './junNEfreet';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Junún Efreet";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Junún Efreet", "Swamp", "Swamp"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([JUN_NEFREET_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Junún Efreet", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {B}{B}.\" - the price is declined", () => {
  ...
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {B}{B}.\" - the price is paid", () => {
