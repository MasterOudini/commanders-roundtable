// `Merciless Enforcers` - an activation damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MERCILESS_ENFORCERS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MERCILESS_ENFORCERS, "Lifelink\n{3}{B}: This creature deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const MERCILESS_ENFORCERS_SCRIPT: CardScript = {
  oracleId: MERCILESS_ENFORCERS.oracleId,
  name: MERCILESS_ENFORCERS.name,
  activated: [
    {
      ref: `${MERCILESS_ENFORCERS.oracleId}#a0`,
