// `Generous Visitor` — "Whenever you cast an enchantment spell, put a +1/+1
// counter on target creature." Briarknit Kami's targeted cast-watcher (D165)
// with Argothian Enchantress' TYPE filter — asked of the face actually cast.
// M6.4t, D176.

import { GENEROUS_VISITOR } from '../../../data/fixtures/engineCards';
...
export const GENEROUS_VISITOR_SCRIPT: CardScript = {
  oracleId: GENEROUS_VISITOR.oracleId,
  name: GENEROUS_VISITOR.name,
  triggers: [
    {
      abilityId: 'cast',
      text: TEXT,
      ...
      label: () => 'Generous Visitor — +1/+1 counter on target creature',
