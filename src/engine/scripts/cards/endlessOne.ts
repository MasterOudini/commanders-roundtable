// `Endless One` - a static entersWithCountersX
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ENDLESS_ONE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ENDLESS_ONE, "This creature enters with X +1/+1 counters on it.");

export const ENDLESS_ONE_SCRIPT: CardScript = {
  oracleId: ENDLESS_ONE.oracleId,
  name: ENDLESS_ONE.name,
  replacements: [
    {
