// `Serra's Embrace` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has flying, vigilance.
...
import { SERRA_S_EMBRACE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SERRA_S_EMBRACE, "Enchant creature\nEnchanted creature gets +2/+2 and has flying and vigilance. (Attacking doesn't cause it to tap.)");
const LINES = PRINTED.split('\n');

export const SERRAS_EMBRACE_SCRIPT: CardScript = {
  oracleId: SERRA_S_EMBRACE.oracleId,
  name: SERRA_S_EMBRACE.name,
  statics: [
    {
