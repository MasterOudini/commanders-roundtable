// `Armor Sliver` - every permanent in its scope HAS a quoted
...
import { ARMOR_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARMOR_SLIVER, "All Sliver creatures have \"{2}: This creature gets +0/+1 until end of turn.\"");

const GRANT = grantedActivated("{2}: This creature gets +0/+1 until end of turn.", `${ARMOR_SLIVER.oracleId}#g0`, ARMOR_SLIVER.name);
const VOCAB = vocabularyEffects("This creature gets +0/+1 until end of turn.", ARMOR_SLIVER.name);
const VOCAB_T = vocabularyTargets("This creature gets +0/+1 until end of turn.");

export const ARMOR_SLIVER_SCRIPT: CardScript = {
  oracleId: ARMOR_SLIVER.oracleId,
  name: ARMOR_SLIVER.name,
  statics: [
    {
      abilityId: 'grant-0',
      text: PRINTED,
