// `Filigree Attendant` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FILIGREE_ATTENDANT } from '../../../data/fixtures/engineCards';
...
export const FILIGREE_ATTENDANT_SCRIPT: CardScript = {
  oracleId: FILIGREE_ATTENDANT.oracleId,
  name: FILIGREE_ATTENDANT.name,
  statics: [
    {
      abilityId: 'cda-1',
