// `Convalescent Care` - every printed ability proven in its own game: the cost's mark, the pump
...
import { CONVALESCENT_CARE_SCRIPT } from './convalescentCare';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Convalescent Care";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Convalescent Care"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CONVALESCENT_CARE_SCRIPT]),
...
describe("Convalescent Care", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"You gain 3 life and draw a card.\"", () => {
