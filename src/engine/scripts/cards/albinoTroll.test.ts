// `Albino Troll` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Albino Troll", "Lightning Bolt", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ALBINO_TROLL_SCRIPT]),
  });
  holdEverywhere(g);
