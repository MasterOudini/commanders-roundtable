// `Benalish Lancer` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BENALISH_LANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BENALISH_LANCER, "Kicker {2}{W} (You may pay an additional {2}{W} as you cast this spell.)\nIf this creature was kicked, it enters with two +1/+1 counters on it and with first strike.");
const LINES = PRINTED.split('\n');


export const BENALISH_LANCER_SCRIPT: CardScript = {
  oracleId: BENALISH_LANCER.oracleId,
  name: BENALISH_LANCER.name,
  replacements: [
    {
