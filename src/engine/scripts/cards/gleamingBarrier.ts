...
// The dies-Treasure shape; line 1 is Defender (Tier 2). M6.4t, D176.

import { GLEAMING_BARRIER } from '../../../data/fixtures/engineCards';
...
export const GLEAMING_BARRIER_SCRIPT: CardScript = {
  oracleId: GLEAMING_BARRIER.oracleId,
  name: GLEAMING_BARRIER.name,
  triggers: [
    {
      abilityId: 'dies',
      text: TEXT,
      ...
      label: () => 'Gleaming Barrier — create a Treasure',
