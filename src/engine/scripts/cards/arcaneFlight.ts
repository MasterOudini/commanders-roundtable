// `Arcane Flight` - an Aura (Enchant creature): the enchanted creature gets +1/+1 and has flying.
...
import { ARCANE_FLIGHT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARCANE_FLIGHT, "Enchant creature\nEnchanted creature gets +1/+1 and has flying.");
const LINES = PRINTED.split('\n');

export const ARCANE_FLIGHT_SCRIPT: CardScript = {
  oracleId: ARCANE_FLIGHT.oracleId,
  name: ARCANE_FLIGHT.name,
  statics: [
    {
