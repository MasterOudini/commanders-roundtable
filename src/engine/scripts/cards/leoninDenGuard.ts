// `Leonin Den-Guard` - a conditional static (as long as this creature is equipped) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LEONIN_DEN_GUARD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LEONIN_DEN_GUARD, "As long as this creature is equipped, it gets +1/+1 and has vigilance.");
...
export const LEONIN_DEN_GUARD_SCRIPT: CardScript = {
  oracleId: LEONIN_DEN_GUARD.oracleId,
  name: LEONIN_DEN_GUARD.name,
  statics: [
    {
