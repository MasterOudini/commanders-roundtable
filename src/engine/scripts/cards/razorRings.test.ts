// `Razor Rings` — 4 damage to my attacking Bears (2/2): it dies and the 2
// excess become my life; a creature at home is refused (D291).

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { RAZOR_RINGS_SCRIPT } from './razorRings';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const SPELL = 'Razor Rings';
...
function aimed(): { g: Game; att: InstanceId; home: InstanceId; life: number } {
  const g = startedGame({ players: 2, decks: [[SPELL, BEARS, BEARS], []], scripts: createRegistry([RAZOR_RINGS_SCRIPT]) });
...
describe('Razor Rings', () => {
  test('the 2/2 dies to 4 and the 2 excess are gained', () => {
