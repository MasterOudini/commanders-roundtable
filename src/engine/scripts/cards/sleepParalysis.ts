// `Sleep Paralysis` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SLEEP_PARALYSIS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SLEEP_PARALYSIS, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const SLEEP_PARALYSIS_SCRIPT: CardScript = {
  oracleId: SLEEP_PARALYSIS.oracleId,
  name: SLEEP_PARALYSIS.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Sleep Paralysis - tapAttached",
