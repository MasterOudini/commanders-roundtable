// `Ezuri's Brigade` - a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { EZURI_S_BRIGADE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(EZURI_S_BRIGADE, "Metalcraft — As long as you control three or more artifacts, this creature gets +4/+4 and has trample.");
...
export const EZURIS_BRIGADE_SCRIPT: CardScript = {
  oracleId: EZURI_S_BRIGADE.oracleId,
  name: EZURI_S_BRIGADE.name,
  statics: [
    {
