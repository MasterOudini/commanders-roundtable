// `Champion of Rhonas` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Champion of Rhonas", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CHAMPION_OF_RHONAS_SCRIPT]),
...
describe("Champion of Rhonas", () => {
  test("You may exert this creature as it attacks. When you do: the vocabulary resolves \"Put a creature card from your hand onto the battlefield.\"", () => {
