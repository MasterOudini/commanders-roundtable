// `Aeronaut's Wings` - an Equipment: the equipped creature gets +1/+0 and has flying.
...
import { AERONAUT_S_WINGS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AERONAUT_S_WINGS, "Equipped creature gets +1/+0 and has flying.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const AERONAUTS_WINGS_SCRIPT: CardScript = {
  oracleId: AERONAUT_S_WINGS.oracleId,
  name: AERONAUT_S_WINGS.name,
  statics: [
    {
