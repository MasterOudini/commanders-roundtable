// `Slipstream Eel` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SLIPSTREAM_EEL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SLIPSTREAM_EEL, "This creature can't attack unless defending player controls an Island.\nCycling {1}{U} ({1}{U}, Discard this card: Draw a card.)");
...
export const SLIPSTREAM_EEL_SCRIPT: CardScript = {
  oracleId: SLIPSTREAM_EEL.oracleId,
  name: SLIPSTREAM_EEL.name,
  combat: [
    {
