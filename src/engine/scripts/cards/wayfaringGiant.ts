// `Wayfaring Giant` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { WAYFARING_GIANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WAYFARING_GIANT, "Domain — This creature gets +1/+1 for each basic land type among lands you control.");
...
export const WAYFARING_GIANT_SCRIPT: CardScript = {
  oracleId: WAYFARING_GIANT.oracleId,
  name: WAYFARING_GIANT.name,
  statics: [
    {
      abilityId: 'pump-0',
