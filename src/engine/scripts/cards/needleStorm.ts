...
const TEXT = printed(NEEDLE_STORM, 'Needle Storm deals 4 damage to each creature with flying.');

export const NEEDLE_STORM_SCRIPT: CardScript = {
  oracleId: NEEDLE_STORM.oracleId,
  name: NEEDLE_STORM.name,
  spell: {
    text: TEXT,
