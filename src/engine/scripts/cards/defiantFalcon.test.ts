// `Defiant Falcon` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Defiant Falcon", "Children of Korlis"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DEFIANT_FALCON_SCRIPT]),
