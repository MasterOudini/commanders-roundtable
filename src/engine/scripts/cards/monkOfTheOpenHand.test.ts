// `Monk of the Open Hand` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MONK_OF_THE_OPEN_HAND_SCRIPT } from './monkOfTheOpenHand';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Monk of the Open Hand";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Monk of the Open Hand", "Pyretic Ritual", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MONK_OF_THE_OPEN_HAND_SCRIPT]),
...
describe("Monk of the Open Hand", () => {
  test("Flurry of Blows — Whenever you cast your second spell each turn: it gets 1 +1/+1 counter", () => {
