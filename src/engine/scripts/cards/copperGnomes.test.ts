// `Copper Gnomes` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Copper Gnomes", "Sol Ring", "Sol Ring"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([COPPER_GNOMES_SCRIPT]),
...
describe("Copper Gnomes", () => {
  test("{4}, Sacrifice this creature: the vocabulary resolves \"You may put an artifact card from your hand onto the battlefield.\"", () => {
