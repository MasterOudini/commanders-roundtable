// `Kite Shield` - an Equipment: the equipped creature gets +0/+3.
...
import { KITE_SHIELD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KITE_SHIELD, "Equipped creature gets +0/+3.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const KITE_SHIELD_SCRIPT: CardScript = {
  oracleId: KITE_SHIELD.oracleId,
  name: KITE_SHIELD.name,
  statics: [
    {
