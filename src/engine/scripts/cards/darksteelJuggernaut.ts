// `Darksteel Juggernaut` - a static cdaCount, a static mustAttack
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DARKSTEEL_JUGGERNAUT } from '../../../data/fixtures/engineCards';
...
export const DARKSTEEL_JUGGERNAUT_SCRIPT: CardScript = {
  oracleId: DARKSTEEL_JUGGERNAUT.oracleId,
  name: DARKSTEEL_JUGGERNAUT.name,
  combat: [
    {
