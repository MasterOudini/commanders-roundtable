// `Goblin War Paint` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has haste.
...
import { GOBLIN_WAR_PAINT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GOBLIN_WAR_PAINT, "Enchant creature\nEnchanted creature gets +2/+2 and has haste.");
const LINES = PRINTED.split('\n');

export const GOBLIN_WAR_PAINT_SCRIPT: CardScript = {
  oracleId: GOBLIN_WAR_PAINT.oracleId,
  name: GOBLIN_WAR_PAINT.name,
  statics: [
    {
