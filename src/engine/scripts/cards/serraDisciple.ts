// `Serra Disciple` - a castSpell trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SERRA_DISCIPLE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SERRA_DISCIPLE, "Flying, first strike\nWhenever you cast a historic spell, this creature gets +1/+1 until end of turn. (Artifacts, legendaries, and Sagas are historic.)");
const LINES = PRINTED.split('\n');

export const SERRA_DISCIPLE_SCRIPT: CardScript = {
  oracleId: SERRA_DISCIPLE.oracleId,
  name: SERRA_DISCIPLE.name,
  triggers: [
    {
      ...
      label: () => "Serra Disciple - it pumped until end of turn",
