// `Dragonmaster Outcast` - every printed ability proven in its own game: the cost's mark, the pump
...
import { DRAGONMASTER_OUTCAST_SCRIPT } from './dragonmasterOutcast';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Dragonmaster Outcast";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Dragonmaster Outcast", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DRAGONMASTER_OUTCAST_SCRIPT]),
