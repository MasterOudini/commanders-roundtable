// `Behemoth Sledge` - an Equipment: the equipped creature gets +2/+2 and has trample, lifelink.
...
import { BEHEMOTH_SLEDGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BEHEMOTH_SLEDGE, "Equipped creature gets +2/+2 and has trample and lifelink.\nEquip {3}");
const LINES = PRINTED.split('\n');

export const BEHEMOTH_SLEDGE_SCRIPT: CardScript = {
  oracleId: BEHEMOTH_SLEDGE.oracleId,
  name: BEHEMOTH_SLEDGE.name,
  statics: [
    {
