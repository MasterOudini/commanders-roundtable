// `Molting Snakeskin` - the permanent it is attached to HAS a quoted
...
import { MOLTING_SNAKESKIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MOLTING_SNAKESKIN, "Enchant creature\nEnchanted creature gets +2/+0 and has \"{2}{B}: Regenerate this creature.\"");
const LINES = PRINTED.split("\n");

const GRANT = grantedActivated("{2}{B}: Regenerate this creature.", `${MOLTING_SNAKESKIN.oracleId}#g1`, MOLTING_SNAKESKIN.name);
const VOCAB = vocabularyEffects("Regenerate this creature.", MOLTING_SNAKESKIN.name);
const VOCAB_T = vocabularyTargets("Regenerate this creature.");

export const MOLTING_SNAKESKIN_SCRIPT: CardScript = {
  oracleId: MOLTING_SNAKESKIN.oracleId,
  name: MOLTING_SNAKESKIN.name,
  statics: [
    {
