// `Tiger Claws` - an Aura (Enchant creature): the enchanted creature gets +1/+1 and has trample.
...
import { TIGER_CLAWS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TIGER_CLAWS, "Flash\nEnchant creature\nEnchanted creature gets +1/+1 and has trample.");
const LINES = PRINTED.split('\n');

export const TIGER_CLAWS_SCRIPT: CardScript = {
  oracleId: TIGER_CLAWS.oracleId,
  name: TIGER_CLAWS.name,
  statics: [
    {
