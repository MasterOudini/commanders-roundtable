// `Phantasmal Bear` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PHANTASMAL_BEAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PHANTASMAL_BEAR, "When this creature becomes the target of a spell or ability, sacrifice it.");

export const PHANTASMAL_BEAR_SCRIPT: CardScript = {
  oracleId: PHANTASMAL_BEAR.oracleId,
  name: PHANTASMAL_BEAR.name,
  triggers: [
    {
      ...
      label: () => "Phantasmal Bear - sacrificeSelf",
