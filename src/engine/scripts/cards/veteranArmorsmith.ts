// `Veteran Armorsmith` - a layer-6 anthem: "Other Soldier creatures you control get +0/+1". A StaticDef in the shape of the
...
import { VETERAN_ARMORSMITH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VETERAN_ARMORSMITH, "Other Soldier creatures you control get +0/+1.");
const TEXT = PRINTED;

export const VETERAN_ARMORSMITH_SCRIPT: CardScript = {
  oracleId: VETERAN_ARMORSMITH.oracleId,
  name: VETERAN_ARMORSMITH.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
