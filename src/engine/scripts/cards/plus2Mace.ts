// `+2 Mace` - an Equipment: the equipped creature gets +2/+2.
...
import { PLUS_2_MACE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PLUS_2_MACE, "Equipped creature gets +2/+2.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const PLUS2_MACE_SCRIPT: CardScript = {
  oracleId: PLUS_2_MACE.oracleId,
  name: PLUS_2_MACE.name,
  statics: [
    {
