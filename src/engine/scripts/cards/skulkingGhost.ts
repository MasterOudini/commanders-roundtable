// `Skulking Ghost` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SKULKING_GHOST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SKULKING_GHOST, "Flying\nWhen this creature becomes the target of a spell or ability, sacrifice it.");
const LINES = PRINTED.split('\n');

export const SKULKING_GHOST_SCRIPT: CardScript = {
  oracleId: SKULKING_GHOST.oracleId,
  name: SKULKING_GHOST.name,
  triggers: [
    {
      ...
      label: () => "Skulking Ghost - sacrificeSelf",
