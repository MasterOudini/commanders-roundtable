// `Loyal Subordinate` - a combatOnYourTurn trigger loseLifeOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LOYAL_SUBORDINATE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LOYAL_SUBORDINATE, "Menace (This creature can't be blocked except by two or more creatures.)\nLieutenant — At the beginning of combat on your turn, if you control your commander, each opponent loses 3 life.");
...
export const LOYAL_SUBORDINATE_SCRIPT: CardScript = {
  oracleId: LOYAL_SUBORDINATE.oracleId,
  name: LOYAL_SUBORDINATE.name,
  triggers: [
    {
      ...
      label: () => "Loyal Subordinate - loseLifeOpponents",
