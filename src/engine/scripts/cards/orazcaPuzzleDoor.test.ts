// `Orazca Puzzle-Door` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ORAZCA_PUZZLE_DOOR_SCRIPT } from './orazcaPuzzleDoor';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Orazca Puzzle-Door";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Orazca Puzzle-Door"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ORAZCA_PUZZLE_DOOR_SCRIPT]),
...
describe("Orazca Puzzle-Door", () => {
  test("{1}, {T}, Sacrifice this artifact: the vocabulary resolves \"Look at the top two cards of your library. Put one of those cards into your hand and the other into your graveyard.\"", () => {
