// `Untamed Hunger` - an Aura (Enchant creature): the enchanted creature gets +2/+1 and has menace.
...
import { UNTAMED_HUNGER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(UNTAMED_HUNGER, "Enchant creature\nEnchanted creature gets +2/+1 and has menace. (It can't be blocked except by two or more creatures.)");
const LINES = PRINTED.split('\n');

export const UNTAMED_HUNGER_SCRIPT: CardScript = {
  oracleId: UNTAMED_HUNGER.oracleId,
  name: UNTAMED_HUNGER.name,
  statics: [
    {
