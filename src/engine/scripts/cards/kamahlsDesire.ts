// `Kamahl's Desire` - a static attachedStatic, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { KAMAHL_S_DESIRE } from '../../../data/fixtures/engineCards';
...
export const KAMAHLS_DESIRE_SCRIPT: CardScript = {
  oracleId: KAMAHL_S_DESIRE.oracleId,
  name: KAMAHL_S_DESIRE.name,
  statics: [
    {
