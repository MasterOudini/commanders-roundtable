// `Frilled Sparkshooter` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FRILLED_SPARKSHOOTER } from '../../../data/fixtures/engineCards';
...
export const FRILLED_SPARKSHOOTER_SCRIPT: CardScript = {
  oracleId: FRILLED_SPARKSHOOTER.oracleId,
  name: FRILLED_SPARKSHOOTER.name,
  replacements: [
    {
