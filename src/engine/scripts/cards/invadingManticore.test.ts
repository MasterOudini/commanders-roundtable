// `Invading Manticore` - every printed ability proven in its own game: the cost's mark, the pump
...
import { INVADING_MANTICORE_SCRIPT } from './invadingManticore';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Invading Manticore";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Invading Manticore"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([INVADING_MANTICORE_SCRIPT]),
...
describe("Invading Manticore", () => {
  test("When this creature enters: the vocabulary resolves \"Amass Zombies 2.\"", () => {
