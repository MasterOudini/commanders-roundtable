// `Detained by Legionnaires` - cast on Grizzly Bears it attaches and the enchanted creature cannot attack or block;
...
import { DETAINED_BY_LEGIONNAIRES_SCRIPT } from './detainedByLegionnaires';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Detained by Legionnaires";
...
function board(): { g: Game; self: InstanceId; host: InstanceId; other: InstanceId } {
  const g = startedGame({
    ...
    scripts: createRegistry([DETAINED_BY_LEGIONNAIRES_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Detained by Legionnaires", () => {
