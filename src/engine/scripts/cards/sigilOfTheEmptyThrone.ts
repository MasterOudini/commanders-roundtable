// `Sigil of the Empty Throne` — "Whenever you cast an enchantment spell,
// create a 4/4 white Angel creature token with flying." Satyr
// Enchanter's filter paying the NEW Angel pin. D247.

import { SIGIL_OF_THE_EMPTY_THRONE } from '../../../data/fixtures/engineCards';
...
export const SIGIL_OF_THE_EMPTY_THRONE_SCRIPT: CardScript = {
  oracleId: SIGIL_OF_THE_EMPTY_THRONE.oracleId,
  name: SIGIL_OF_THE_EMPTY_THRONE.name,
  triggers: [
    {
      abilityId: 'cast-angel',
      text: TEXT,
      event: 'SpellCast',
      ...
      label: () => 'Sigil of the Empty Throne — create a 4/4 Angel with flying',
