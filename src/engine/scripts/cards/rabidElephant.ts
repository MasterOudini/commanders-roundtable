// `Rabid Elephant` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { RABID_ELEPHANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(RABID_ELEPHANT, "Whenever this creature becomes blocked, it gets +2/+2 until end of turn for each creature blocking it.");
...
export const RABID_ELEPHANT_SCRIPT: CardScript = {
  oracleId: RABID_ELEPHANT.oracleId,
  name: RABID_ELEPHANT.name,
  triggers: [
    {
      abilityId: 'pump-0',
      ...
      label: () => "Rabid Elephant - blocked, it pumped until end of turn",
