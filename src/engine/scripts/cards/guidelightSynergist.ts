// `Guidelight Synergist` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { GUIDELIGHT_SYNERGIST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GUIDELIGHT_SYNERGIST, "Flying\nThis creature gets +1/+0 for each artifact you control.");
...
export const GUIDELIGHT_SYNERGIST_SCRIPT: CardScript = {
  oracleId: GUIDELIGHT_SYNERGIST.oracleId,
  name: GUIDELIGHT_SYNERGIST.name,
  statics: [
    {
      abilityId: 'pump-1',
