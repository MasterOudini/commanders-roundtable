// `Grixis Slavedriver` - a leavesBattlefield trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GRIXIS_SLAVEDRIVER } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Grixis Slavedriver - token",
