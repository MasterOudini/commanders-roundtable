// `Vampire Outcasts` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { VAMPIRE_OUTCASTS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VAMPIRE_OUTCASTS, "Bloodthirst 2 (If an opponent was dealt damage this turn, this creature enters with two +1/+1 counters on it.)\nLifelink (Damage dealt by this creature also causes you to gain that much life.)");
...
export const VAMPIRE_OUTCASTS_SCRIPT: CardScript = {
  oracleId: VAMPIRE_OUTCASTS.oracleId,
  name: VAMPIRE_OUTCASTS.name,
  replacements: [
    {
