// `Blanchwood Armor` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { BLANCHWOOD_ARMOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLANCHWOOD_ARMOR, "Enchant creature\nEnchanted creature gets +1/+1 for each Forest you control.");
...
export const BLANCHWOOD_ARMOR_SCRIPT: CardScript = {
  oracleId: BLANCHWOOD_ARMOR.oracleId,
  name: BLANCHWOOD_ARMOR.name,
  statics: [
    {
      abilityId: 'pump-1',
