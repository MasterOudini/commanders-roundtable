// `Sentinel Sliver` - a layer-6 grant: "Sliver creatures you control have vigilance. (Attacking doesn't cause them to tap.)". A StaticDef in the shape of the
...
import { SENTINEL_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SENTINEL_SLIVER, "Sliver creatures you control have vigilance. (Attacking doesn't cause them to tap.)");
const TEXT = PRINTED;

export const SENTINEL_SLIVER_SCRIPT: CardScript = {
  oracleId: SENTINEL_SLIVER.oracleId,
  name: SENTINEL_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
