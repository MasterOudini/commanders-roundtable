// `Marked by Honor` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has vigilance.
...
import { MARKED_BY_HONOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MARKED_BY_HONOR, "Enchant creature\nEnchanted creature gets +2/+2 and has vigilance. (Attacking doesn't cause it to tap.)");
const LINES = PRINTED.split('\n');

export const MARKED_BY_HONOR_SCRIPT: CardScript = {
  oracleId: MARKED_BY_HONOR.oracleId,
  name: MARKED_BY_HONOR.name,
  statics: [
    {
