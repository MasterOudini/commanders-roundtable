// `Plated Sliver` - a layer-6 anthem: "All Sliver creatures get +0/+1". A StaticDef in the shape of the
...
import { PLATED_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PLATED_SLIVER, "All Sliver creatures get +0/+1.");
const TEXT = PRINTED;

export const PLATED_SLIVER_SCRIPT: CardScript = {
  oracleId: PLATED_SLIVER.oracleId,
  name: PLATED_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
