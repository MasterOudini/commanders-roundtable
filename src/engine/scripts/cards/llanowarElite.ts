// `Llanowar Elite` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LLANOWAR_ELITE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LLANOWAR_ELITE, "Kicker {8} (You may pay an additional {8} as you cast this spell.)\nTrample\nIf this creature was kicked, it enters with five +1/+1 counters on it.");
const LINES = PRINTED.split('\n');


export const LLANOWAR_ELITE_SCRIPT: CardScript = {
  oracleId: LLANOWAR_ELITE.oracleId,
  name: LLANOWAR_ELITE.name,
  replacements: [
    {
