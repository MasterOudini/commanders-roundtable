// `Sylvok Battle-Chair` - a etb trigger germ, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SYLVOK_BATTLE_CHAIR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SYLVOK_BATTLE_CHAIR, "For Mirrodin! (When this Equipment enters, create a 2/2 red Rebel creature token, then attach this to it.)\nEquipped creature gets +4/+4 and has trample.\nEquip {5}{G}{G}");
const LINES = PRINTED.split('\n');
const TOKEN_L0 = tokenRef("Rebel|2/2|R|Creature|");

export const SYLVOK_BATTLE_CHAIR_SCRIPT: CardScript = {
  oracleId: SYLVOK_BATTLE_CHAIR.oracleId,
  name: SYLVOK_BATTLE_CHAIR.name,
  triggers: [
    {
      abilityId: 'etb-0',
      ...
      label: () => "Sylvok Battle-Chair - germ",
