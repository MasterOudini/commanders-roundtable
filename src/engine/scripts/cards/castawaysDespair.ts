// `Castaway's Despair` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CASTAWAY_S_DESPAIR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CASTAWAY_S_DESPAIR, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const CASTAWAYS_DESPAIR_SCRIPT: CardScript = {
  oracleId: CASTAWAY_S_DESPAIR.oracleId,
  name: CASTAWAY_S_DESPAIR.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Castaway's Despair - tapAttached",
