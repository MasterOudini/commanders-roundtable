// `Spellheart Chimera` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPELLHEART_CHIMERA } from '../../../data/fixtures/engineCards';
...
export const SPELLHEART_CHIMERA_SCRIPT: CardScript = {
  oracleId: SPELLHEART_CHIMERA.oracleId,
  name: SPELLHEART_CHIMERA.name,
  statics: [
    {
      abilityId: 'cda-1',
