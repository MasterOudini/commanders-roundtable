// `Elvish Berserker` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { ELVISH_BERSERKER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ELVISH_BERSERKER, "Whenever this creature becomes blocked, it gets +1/+1 until end of turn for each creature blocking it.");
...
export const ELVISH_BERSERKER_SCRIPT: CardScript = {
  oracleId: ELVISH_BERSERKER.oracleId,
  name: ELVISH_BERSERKER.name,
  triggers: [
    {
      abilityId: 'pump-0',
      ...
      label: () => "Elvish Berserker - blocked, it pumped until end of turn",
