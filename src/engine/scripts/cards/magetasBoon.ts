// `Mageta's Boon` - an Aura (Enchant creature): the enchanted creature gets +1/+2.
...
import { MAGETA_S_BOON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAGETA_S_BOON, "Flash\nEnchant creature\nEnchanted creature gets +1/+2.");
const LINES = PRINTED.split('\n');

export const MAGETAS_BOON_SCRIPT: CardScript = {
  oracleId: MAGETA_S_BOON.oracleId,
  name: MAGETA_S_BOON.name,
  statics: [
    {
