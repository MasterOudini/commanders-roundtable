// `Blessed Orator` - a layer-6 anthem: "Other creatures you control get +0/+1". A StaticDef in the shape of the
...
import { BLESSED_ORATOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLESSED_ORATOR, "Other creatures you control get +0/+1.");
const TEXT = PRINTED;

export const BLESSED_ORATOR_SCRIPT: CardScript = {
  oracleId: BLESSED_ORATOR.oracleId,
  name: BLESSED_ORATOR.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
