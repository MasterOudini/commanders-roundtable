// `Madrush Cyclops` - a layer-6 grant: "Creatures you control have haste". A StaticDef in the shape of the
...
import { MADRUSH_CYCLOPS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MADRUSH_CYCLOPS, "Creatures you control have haste.");
const TEXT = PRINTED;

export const MADRUSH_CYCLOPS_SCRIPT: CardScript = {
  oracleId: MADRUSH_CYCLOPS.oracleId,
  name: MADRUSH_CYCLOPS.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
