// `Angel of Sanctions` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ANGEL_OF_SANCTIONS_SCRIPT } from './angelOfSanctions';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Angel of Sanctions";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Angel of Sanctions"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ANGEL_OF_SANCTIONS_SCRIPT]),
...
describe("Angel of Sanctions", () => {
  test("When this creature enters: the vocabulary resolves \"Exile target nonland permanent an opponent controls until this creature leaves the battlefield.\"", () => {
