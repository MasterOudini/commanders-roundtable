// `Stromkirk Captain` - a layer-6 anthem: "Other Vampire creatures you control get +1/+1 and have first strike". A StaticDef in the shape of the
...
import { STROMKIRK_CAPTAIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STROMKIRK_CAPTAIN, "First strike\nOther Vampire creatures you control get +1/+1 and have first strike.");
const TEXT = PRINTED.split('\n')[1] as string;

export const STROMKIRK_CAPTAIN_SCRIPT: CardScript = {
  oracleId: STROMKIRK_CAPTAIN.oracleId,
  name: STROMKIRK_CAPTAIN.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
      ...
      appliesTo: (ctx, self, candidate, chars) => {
        ...
        if (!chars.typeLine.subtypes.includes("Vampire")) return false;
        return true;
      },
      modify: (chars) => {
