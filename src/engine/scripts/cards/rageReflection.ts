// `Rage Reflection` - a layer-6 grant: "Creatures you control have double strike". A StaticDef in the shape of the
...
import { RAGE_REFLECTION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(RAGE_REFLECTION, "Creatures you control have double strike.");
const TEXT = PRINTED;

export const RAGE_REFLECTION_SCRIPT: CardScript = {
  oracleId: RAGE_REFLECTION.oracleId,
  name: RAGE_REFLECTION.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
