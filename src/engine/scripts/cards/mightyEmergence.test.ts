// `Mighty Emergence` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MIGHTY_EMERGENCE_SCRIPT } from './mightyEmergence';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Mighty Emergence";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Mighty Emergence", "Grizzly Bears", "Kalakscion, Hunger Tyrant"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MIGHTY_EMERGENCE_SCRIPT]),
...
describe("Mighty Emergence", () => {
  test("Whenever a creature you control with power 5 or greater enters: the vocabulary resolves \"Put two +1/+1 counters on target creature.\"", () => {
