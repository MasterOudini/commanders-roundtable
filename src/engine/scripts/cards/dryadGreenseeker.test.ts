// `Dryad Greenseeker` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Dryad Greenseeker", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DRYAD_GREENSEEKER_SCRIPT]),
...
describe("Dryad Greenseeker", () => {
  test("{T}: the vocabulary resolves \"Look at the top card of your library. If it's a land card, you may reveal it and put it into your hand.\"", () => {
