// `Signal Pest` - a attacks trigger battleCry, a static cantBeBlockedBy
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SIGNAL_PEST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SIGNAL_PEST, "Battle cry (Whenever this creature attacks, each other attacking creature gets +1/+0 until end of turn.)\nThis creature can't be blocked except by creatures with flying or reach.");
const LINES = PRINTED.split('\n');

export const SIGNAL_PEST_SCRIPT: CardScript = {
  oracleId: SIGNAL_PEST.oracleId,
  name: SIGNAL_PEST.name,
  triggers: [
    {
      abilityId: 'attacks-0',
