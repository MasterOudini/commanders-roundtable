// `Winged Sliver` - a layer-6 grant: "All Sliver creatures have flying". A StaticDef in the shape of the
...
import { WINGED_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WINGED_SLIVER, "All Sliver creatures have flying.");
const TEXT = PRINTED;

export const WINGED_SLIVER_SCRIPT: CardScript = {
  oracleId: WINGED_SLIVER.oracleId,
  name: WINGED_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
