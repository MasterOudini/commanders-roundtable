// `Bonesplitter` - an Equipment: the equipped creature gets +2/+0.
...
import { BONESPLITTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BONESPLITTER, "Equipped creature gets +2/+0.\nEquip {1}");
const LINES = PRINTED.split('\n');

export const BONESPLITTER_SCRIPT: CardScript = {
  oracleId: BONESPLITTER.oracleId,
  name: BONESPLITTER.name,
  statics: [
    {
