// `Putrid Imp` - an activation pumping itself, a static threshold, a static cantBlock
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PUTRID_IMP } from '../../../data/fixtures/engineCards';
...
export const PUTRID_IMP_SCRIPT: CardScript = {
  oracleId: PUTRID_IMP.oracleId,
  name: PUTRID_IMP.name,
  activated: [
    {
      ref: `${PUTRID_IMP.oracleId}#a0`,
