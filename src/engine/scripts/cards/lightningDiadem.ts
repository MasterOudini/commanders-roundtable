// `Lightning Diadem` - a etb trigger damageTarget, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LIGHTNING_DIADEM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LIGHTNING_DIADEM, "Enchant creature\nWhen this Aura enters, it deals 2 damage to any target.\nEnchanted creature gets +2/+2.");
const LINES = PRINTED.split('\n');

export const LIGHTNING_DIADEM_SCRIPT: CardScript = {
  oracleId: LIGHTNING_DIADEM.oracleId,
  name: LIGHTNING_DIADEM.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Lightning Diadem - damageTarget",
