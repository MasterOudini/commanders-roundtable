// `Morska, Undersea Sleuth` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MORSKA_UNDERSEA_SLEUTH_SCRIPT } from './morskaUnderseaSleuth';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Morska, Undersea Sleuth";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Morska, Undersea Sleuth", "Divination"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MORSKA_UNDERSEA_SLEUTH_SCRIPT]),
...
describe("Morska, Undersea Sleuth", () => {
  ...
  test("Whenever you draw your second card each turn: it gets 2 +1/+1 counters", () => {
