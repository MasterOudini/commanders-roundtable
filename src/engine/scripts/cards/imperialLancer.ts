// `Imperial Lancer` - a conditional static (as long as you control a Dinosaur) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { IMPERIAL_LANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(IMPERIAL_LANCER, "This creature has double strike as long as you control a Dinosaur.");
...
export const IMPERIAL_LANCER_SCRIPT: CardScript = {
  oracleId: IMPERIAL_LANCER.oracleId,
  name: IMPERIAL_LANCER.name,
  statics: [
    {
