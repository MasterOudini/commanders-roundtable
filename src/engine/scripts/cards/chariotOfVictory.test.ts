// `Chariot of Victory` - equipped to Grizzly Bears the creature has firstStrike, trample, haste; the Cyclops is untouched;
...
import { CHARIOT_OF_VICTORY_SCRIPT } from './chariotOfVictory';
import { advanceUntil, deps, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import { derive } from '../../derive';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Chariot of Victory";
...
function kw(g: Game, id: InstanceId): ReadonlySet<string> {
  const d = deps(createRegistry([CHARIOT_OF_VICTORY_SCRIPT]));
...
function board(): { g: Game; self: InstanceId; host: InstanceId; second: InstanceId; other: InstanceId } {
  const g = startedGame({
    ...
    scripts: createRegistry([CHARIOT_OF_VICTORY_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Chariot of Victory", () => {
  test("equipped to Grizzly Bears: attached, and the creature has firstStrike, trample, haste; the Cyclops is untouched", () => {
