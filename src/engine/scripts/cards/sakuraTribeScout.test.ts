// `Sakura-Tribe Scout` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Sakura-Tribe Scout", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SAKURA_TRIBE_SCOUT_SCRIPT]),
...
describe("Sakura-Tribe Scout", () => {
  test("{T}: the vocabulary resolves \"You may put a land card from your hand onto the battlefield.\"", () => {
