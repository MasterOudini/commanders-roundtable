// `Shifting Wall` - a static entersWithCountersX
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SHIFTING_WALL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHIFTING_WALL, "Defender (This creature can't attack.)\nThis creature enters with X +1/+1 counters on it.");
const LINES = PRINTED.split('\n');

export const SHIFTING_WALL_SCRIPT: CardScript = {
  oracleId: SHIFTING_WALL.oracleId,
  name: SHIFTING_WALL.name,
  replacements: [
    {
