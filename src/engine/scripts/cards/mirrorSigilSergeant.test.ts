// `Mirror-Sigil Sergeant` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MIRROR_SIGIL_SERGEANT_SCRIPT } from './mirrorSigilSergeant';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Mirror-Sigil Sergeant";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Mirror-Sigil Sergeant", "Aegis Turtle"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MIRROR_SIGIL_SERGEANT_SCRIPT]),
...
describe("Mirror-Sigil Sergeant", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Create a token that's a copy of this creature.\"", () => {
