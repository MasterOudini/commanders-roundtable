// `Tuktuk Grunts` - a selfOrAnotherAllyEnters trigger selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TUKTUK_GRUNTS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TUKTUK_GRUNTS, "Haste\nWhenever this creature or another Ally you control enters, you may put a +1/+1 counter on this creature.");
const LINES = PRINTED.split('\n');

export const TUKTUK_GRUNTS_SCRIPT: CardScript = {
  oracleId: TUKTUK_GRUNTS.oracleId,
  name: TUKTUK_GRUNTS.name,
  triggers: [
    {
      ...
      label: () => "Tuktuk Grunts - a counter on it",
