// `Nimbus Swimmer` - a static entersWithCountersX
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NIMBUS_SWIMMER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIMBUS_SWIMMER, "Flying\nThis creature enters with X +1/+1 counters on it.");
const LINES = PRINTED.split('\n');

export const NIMBUS_SWIMMER_SCRIPT: CardScript = {
  oracleId: NIMBUS_SWIMMER.oracleId,
  name: NIMBUS_SWIMMER.name,
  replacements: [
    {
