// `Veteran's Sidearm` - an Equipment: the equipped creature gets +1/+1.
...
import { VETERAN_S_SIDEARM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VETERAN_S_SIDEARM, "Equipped creature gets +1/+1.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const VETERANS_SIDEARM_SCRIPT: CardScript = {
  oracleId: VETERAN_S_SIDEARM.oracleId,
  name: VETERAN_S_SIDEARM.name,
  statics: [
    {
