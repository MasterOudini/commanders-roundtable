// `Cloudshredder Sliver` - a layer-6 grant: "Sliver creatures you control have flying and haste". A StaticDef in the shape of the
...
import { CLOUDSHREDDER_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CLOUDSHREDDER_SLIVER, "Sliver creatures you control have flying and haste.");
const TEXT = PRINTED;

export const CLOUDSHREDDER_SLIVER_SCRIPT: CardScript = {
  oracleId: CLOUDSHREDDER_SLIVER.oracleId,
  name: CLOUDSHREDDER_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
