// `Madcap Skills` - an Aura (Enchant creature): the enchanted creature gets +3/+0 and has menace.
...
import { MADCAP_SKILLS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MADCAP_SKILLS, "Enchant creature\nEnchanted creature gets +3/+0 and has menace.");
const LINES = PRINTED.split('\n');

export const MADCAP_SKILLS_SCRIPT: CardScript = {
  oracleId: MADCAP_SKILLS.oracleId,
  name: MADCAP_SKILLS.name,
  statics: [
    {
