// `Stonecoil Serpent` - a static entersWithCountersX
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STONECOIL_SERPENT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STONECOIL_SERPENT, "Reach, trample, protection from multicolored\nThis creature enters with X +1/+1 counters on it.");
const LINES = PRINTED.split('\n');

export const STONECOIL_SERPENT_SCRIPT: CardScript = {
  oracleId: STONECOIL_SERPENT.oracleId,
  name: STONECOIL_SERPENT.name,
  replacements: [
    {
