// `Spike Rogue` - a static entersWithCounters, an activation counterOnTarget, an activation selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPIKE_ROGUE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPIKE_ROGUE, "This creature enters with two +1/+1 counters on it.\n{2}, Remove a +1/+1 counter from this creature: Put a +1/+1 counter on target creature.\n{2}, Remove a +1/+1 counter from a creature you control: Put a +1/+1 counter on this creature.");
const LINES = PRINTED.split('\n');

export const SPIKE_ROGUE_SCRIPT: CardScript = {
  oracleId: SPIKE_ROGUE.oracleId,
  name: SPIKE_ROGUE.name,
  activated: [
    {
      ref: `${SPIKE_ROGUE.oracleId}#a0`,
