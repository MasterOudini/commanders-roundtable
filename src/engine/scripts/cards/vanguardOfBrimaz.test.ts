// `Vanguard of Brimaz` - every printed ability proven in its own game: the cost's mark, the pump
...
import { VANGUARD_OF_BRIMAZ_SCRIPT } from './vanguardOfBrimaz';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Vanguard of Brimaz";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Vanguard of Brimaz", "Giant Growth"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([VANGUARD_OF_BRIMAZ_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Vanguard of Brimaz", () => {
  test("Heroic — Whenever you cast a spell that targets this creature: 1 token made", () => {
