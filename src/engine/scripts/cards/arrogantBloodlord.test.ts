// `Arrogant Bloodlord` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ARROGANT_BLOODLORD_SCRIPT } from './arrogantBloodlord';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Arrogant Bloodlord";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Arrogant Bloodlord"], ["Cyclops of One-Eyed Pass", "Memnite"]],
    scripts: createRegistry([ARROGANT_BLOODLORD_SCRIPT]),
...
describe("Arrogant Bloodlord", () => {
  test("Whenever this creature blocks or becomes blocked by a creature with power 1 or less: the vocabulary resolves \"Destroy ~ at end of combat.\"", () => {
