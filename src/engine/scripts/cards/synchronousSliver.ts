// `Synchronous Sliver` - a layer-6 grant: "All Sliver creatures have vigilance". A StaticDef in the shape of the
...
import { SYNCHRONOUS_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SYNCHRONOUS_SLIVER, "All Sliver creatures have vigilance.");
const TEXT = PRINTED;

export const SYNCHRONOUS_SLIVER_SCRIPT: CardScript = {
  oracleId: SYNCHRONOUS_SLIVER.oracleId,
  name: SYNCHRONOUS_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
