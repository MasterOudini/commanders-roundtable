// `Uncle Istvan` - a CONTINUOUS prevention effect (CR 615, D385): a `PreventionDef` the
...
import { UNCLE_ISTVAN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(UNCLE_ISTVAN, "Prevent all damage that would be dealt to this creature by creatures.");

export const UNCLE_ISTVAN_SCRIPT: CardScript = {
  oracleId: UNCLE_ISTVAN.oracleId,
  name: UNCLE_ISTVAN.name,
  prevention: [
    {
      abilityId: 'prevent-0',
      text: PRINTED,
