// `Honor of the Pure` - a layer-6 anthem: "White creatures you control get +1/+1". A StaticDef in the shape of the
...
import { HONOR_OF_THE_PURE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HONOR_OF_THE_PURE, "White creatures you control get +1/+1.");
const TEXT = PRINTED;

export const HONOR_OF_THE_PURE_SCRIPT: CardScript = {
  oracleId: HONOR_OF_THE_PURE.oracleId,
  name: HONOR_OF_THE_PURE.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
