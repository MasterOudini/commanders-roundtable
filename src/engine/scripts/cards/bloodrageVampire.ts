// `Bloodrage Vampire` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLOODRAGE_VAMPIRE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLOODRAGE_VAMPIRE, "Bloodthirst 1 (If an opponent was dealt damage this turn, this creature enters with a +1/+1 counter on it.)");
...
export const BLOODRAGE_VAMPIRE_SCRIPT: CardScript = {
  oracleId: BLOODRAGE_VAMPIRE.oracleId,
  name: BLOODRAGE_VAMPIRE.name,
  replacements: [
    {
