// `Garrulous Sycophant` - every printed ability proven in its own game: the cost's mark, the pump
...
import { GARRULOUS_SYCOPHANT_SCRIPT } from './garrulousSycophant';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Garrulous Sycophant";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Garrulous Sycophant"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GARRULOUS_SYCOPHANT_SCRIPT]),
...
describe("Garrulous Sycophant", () => {
  test("At the beginning of your end step: each opponent loses 1 life and 1 is gained", () => {
