// `Armored Galleon` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ARMORED_GALLEON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARMORED_GALLEON, "This creature can't attack unless defending player controls an Island.");
...
export const ARMORED_GALLEON_SCRIPT: CardScript = {
  oracleId: ARMORED_GALLEON.oracleId,
  name: ARMORED_GALLEON.name,
  combat: [
    {
