// `Kitesail` - an Equipment: the equipped creature gets +1/+0 and has flying.
...
import { KITESAIL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KITESAIL, "Equipped creature gets +1/+0 and has flying.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const KITESAIL_SCRIPT: CardScript = {
  oracleId: KITESAIL.oracleId,
  name: KITESAIL.name,
  statics: [
    {
