// `Vedalken Heretic` - a dealsDamageOpponent trigger draw
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { VEDALKEN_HERETIC } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VEDALKEN_HERETIC, "Whenever this creature deals damage to an opponent, you may draw a card.");

export const VEDALKEN_HERETIC_SCRIPT: CardScript = {
  oracleId: VEDALKEN_HERETIC.oracleId,
  name: VEDALKEN_HERETIC.name,
  triggers: [
    {
