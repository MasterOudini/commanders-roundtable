// `Cartouche of Solidarity` - an Aura (Enchant creature you control): the enchanted creature (on entering: 1 token); gets +1/+1 and has firstStrike.
...
import { CARTOUCHE_OF_SOLIDARITY } from '../../../data/fixtures/engineCards';
...
const TOKEN = tokenRef("Warrior|1/1|W|Creature|vigilance");

export const CARTOUCHE_OF_SOLIDARITY_SCRIPT: CardScript = {
  oracleId: CARTOUCHE_OF_SOLIDARITY.oracleId,
  name: CARTOUCHE_OF_SOLIDARITY.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Cartouche of Solidarity - create a token",
