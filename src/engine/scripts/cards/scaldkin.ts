// `Scaldkin` - an activation damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SCALDKIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SCALDKIN, "Flying\n{2}{R}, Sacrifice this creature: It deals 2 damage to any target.");
const LINES = PRINTED.split('\n');

export const SCALDKIN_SCRIPT: CardScript = {
  oracleId: SCALDKIN.oracleId,
  name: SCALDKIN.name,
  activated: [
    {
      ref: `${SCALDKIN.oracleId}#a0`,
