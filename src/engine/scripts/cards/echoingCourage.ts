// `Echoing Courage` — "Target creature and all other creatures with the
...
export const ECHOING_COURAGE_SCRIPT: CardScript = {
  oracleId: ECHOING_COURAGE.oracleId,
  name: ECHOING_COURAGE.name,
  spell: {
    text: TEXT,
