// `Bone Saw` - an Equipment: the equipped creature gets +1/+0.
...
import { BONE_SAW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BONE_SAW, "Equipped creature gets +1/+0.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const BONE_SAW_SCRIPT: CardScript = {
  oracleId: BONE_SAW.oracleId,
  name: BONE_SAW.name,
  statics: [
    {
