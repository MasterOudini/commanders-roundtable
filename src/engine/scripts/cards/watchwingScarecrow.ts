// `Watchwing Scarecrow` - a conditional static (as long as you control a white creature) threshold, a conditional static (as long as you control a blue creature) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WATCHWING_SCARECROW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WATCHWING_SCARECROW, "This creature has vigilance as long as you control a white creature.\nThis creature has flying as long as you control a blue creature.");
...
export const WATCHWING_SCARECROW_SCRIPT: CardScript = {
  oracleId: WATCHWING_SCARECROW.oracleId,
  name: WATCHWING_SCARECROW.name,
  statics: [
    {
