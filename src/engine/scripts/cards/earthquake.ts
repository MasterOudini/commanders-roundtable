// `Earthquake` — "Earthquake deals X damage to each creature without
// flying and each player." Delete's sweep with the flying exemption read
// off DERIVED keywords. D210.
...
export const EARTHQUAKE_SCRIPT: CardScript = {
  oracleId: EARTHQUAKE.oracleId,
