// `Carapace Forger` - a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CARAPACE_FORGER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CARAPACE_FORGER, "Metalcraft — This creature gets +2/+2 as long as you control three or more artifacts.");
...
export const CARAPACE_FORGER_SCRIPT: CardScript = {
  oracleId: CARAPACE_FORGER.oracleId,
  name: CARAPACE_FORGER.name,
  statics: [
    {
