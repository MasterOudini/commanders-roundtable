// `Stampeding Horncrest` - a conditional static (as long as you control another Dinosaur) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STAMPEDING_HORNCREST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STAMPEDING_HORNCREST, "This creature has haste as long as you control another Dinosaur.");
...
export const STAMPEDING_HORNCREST_SCRIPT: CardScript = {
  oracleId: STAMPEDING_HORNCREST.oracleId,
  name: STAMPEDING_HORNCREST.name,
  statics: [
    {
