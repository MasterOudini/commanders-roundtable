// `Dwarfhold Champion` - a conditional static (as long as this creature is equipped) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DWARFHOLD_CHAMPION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DWARFHOLD_CHAMPION, "As long as this creature is equipped, it gets +0/+2.");
...
export const DWARFHOLD_CHAMPION_SCRIPT: CardScript = {
  oracleId: DWARFHOLD_CHAMPION.oracleId,
  name: DWARFHOLD_CHAMPION.name,
  statics: [
    {
