// `Tuktuk Rubblefort` - a layer-6 grant: "Creatures you control have haste". A StaticDef in the shape of the
...
import { TUKTUK_RUBBLEFORT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TUKTUK_RUBBLEFORT, "Defender, reach\nCreatures you control have haste.");
const TEXT = PRINTED.split('\n')[1] as string;

export const TUKTUK_RUBBLEFORT_SCRIPT: CardScript = {
  oracleId: TUKTUK_RUBBLEFORT.oracleId,
  name: TUKTUK_RUBBLEFORT.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
