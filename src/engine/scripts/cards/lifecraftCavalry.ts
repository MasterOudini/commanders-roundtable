// `Lifecraft Cavalry` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LIFECRAFT_CAVALRY } from '../../../data/fixtures/engineCards';
...
export const LIFECRAFT_CAVALRY_SCRIPT: CardScript = {
  oracleId: LIFECRAFT_CAVALRY.oracleId,
  name: LIFECRAFT_CAVALRY.name,
  replacements: [
    {
