// `Basilica Bell-Haunt` - every printed ability proven in its own game: the cost's mark, the pump
...
import { BASILICA_BELL_HAUNT_SCRIPT } from './basilicaBellHaunt';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Basilica Bell-Haunt";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Basilica Bell-Haunt"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([BASILICA_BELL_HAUNT_SCRIPT]),
...
describe("Basilica Bell-Haunt", () => {
  test("When this creature enters: the vocabulary resolves \"Each opponent discards a card and you gain 3 life.\"", () => {
    const { g, life0, p2hand0 } = armed(0);
    let qdL0 = 0;
