// `Horned Sliver` - a layer-6 grant: "All Sliver creatures have trample". A StaticDef in the shape of the
...
import { HORNED_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HORNED_SLIVER, "All Sliver creatures have trample.");
const TEXT = PRINTED;

export const HORNED_SLIVER_SCRIPT: CardScript = {
  oracleId: HORNED_SLIVER.oracleId,
  name: HORNED_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
