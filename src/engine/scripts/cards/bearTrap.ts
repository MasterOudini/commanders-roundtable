// `Bear Trap` - an activation damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BEAR_TRAP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BEAR_TRAP, "Flash\n{3}, {T}, Sacrifice this artifact: It deals 3 damage to target creature.");
const LINES = PRINTED.split('\n');

export const BEAR_TRAP_SCRIPT: CardScript = {
  oracleId: BEAR_TRAP.oracleId,
  name: BEAR_TRAP.name,
  activated: [
    {
      ref: `${BEAR_TRAP.oracleId}#a0`,
