// `Collective Blessing` - a layer-6 anthem: "Creatures you control get +3/+3". A StaticDef in the shape of the
...
import { COLLECTIVE_BLESSING } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(COLLECTIVE_BLESSING, "Creatures you control get +3/+3.");
const TEXT = PRINTED;

export const COLLECTIVE_BLESSING_SCRIPT: CardScript = {
  oracleId: COLLECTIVE_BLESSING.oracleId,
  name: COLLECTIVE_BLESSING.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
