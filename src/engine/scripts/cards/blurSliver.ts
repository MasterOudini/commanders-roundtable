// `Blur Sliver` - a layer-6 grant: "Sliver creatures you control have haste. (They can attack and {T} as soon as they come under your control.)". A StaticDef in the shape of the
...
import { BLUR_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLUR_SLIVER, "Sliver creatures you control have haste. (They can attack and {T} as soon as they come under your control.)");
const TEXT = PRINTED;

export const BLUR_SLIVER_SCRIPT: CardScript = {
  oracleId: BLUR_SLIVER.oracleId,
  name: BLUR_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
