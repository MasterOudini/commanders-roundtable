// `Wu Warship` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WU_WARSHIP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WU_WARSHIP, "This creature can't attack unless defending player controls an Island.");
...
export const WU_WARSHIP_SCRIPT: CardScript = {
  oracleId: WU_WARSHIP.oracleId,
  name: WU_WARSHIP.name,
  combat: [
    {
