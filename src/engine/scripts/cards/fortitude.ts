// `Fortitude` - an activation regenerateAttached, a auraToGraveyard trigger bounceSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FORTITUDE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FORTITUDE, "Enchant creature\nSacrifice a Forest: Regenerate enchanted creature.\nWhen this Aura is put into a graveyard from the battlefield, return it to its owner's hand.");
const LINES = PRINTED.split('\n');

export const FORTITUDE_SCRIPT: CardScript = {
  oracleId: FORTITUDE.oracleId,
  name: FORTITUDE.name,
  activated: [
    {
      ref: `${FORTITUDE.oracleId}#a0`,
