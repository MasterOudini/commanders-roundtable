// `Frightcrawler` - a static threshold, a static cantBlock
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FRIGHTCRAWLER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FRIGHTCRAWLER, "Fear (This creature can't be blocked except by artifact creatures and/or black creatures.)\nThreshold — As long as there are seven or more cards in your graveyard, this creature gets +2/+2 and can't block.");
...
export const FRIGHTCRAWLER_SCRIPT: CardScript = {
  oracleId: FRIGHTCRAWLER.oracleId,
  name: FRIGHTCRAWLER.name,
  combat: [
    {
