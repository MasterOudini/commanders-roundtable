// `Aether Chaser` - every printed ability proven in its own game: the cost's mark, the pump
...
import { AETHER_CHASER_SCRIPT } from './aetherChaser';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Aether Chaser";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Aether Chaser"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([AETHER_CHASER_SCRIPT]),
