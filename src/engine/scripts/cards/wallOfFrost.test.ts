// `Wall of Frost` - every printed ability proven in its own game: the cost's mark, the pump
...
import { WALL_OF_FROST_SCRIPT } from './wallOfFrost';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Wall of Frost";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Wall of Frost"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([WALL_OF_FROST_SCRIPT]),
