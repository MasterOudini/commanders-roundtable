// `Putrid Pals` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PUTRID_PALS } from '../../../data/fixtures/engineCards';
...
export const PUTRID_PALS_SCRIPT: CardScript = {
  oracleId: PUTRID_PALS.oracleId,
  name: PUTRID_PALS.name,
  replacements: [
    {
