// `Lurking Roper` - a static noUntap, a youGainLife trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LURKING_ROPER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LURKING_ROPER, "This creature doesn't untap during your untap step.\nWhenever you gain life, untap this creature.");
const LINES = PRINTED.split('\n');

export const LURKING_ROPER_SCRIPT: CardScript = {
  oracleId: LURKING_ROPER.oracleId,
  name: LURKING_ROPER.name,
  triggers: [
    {
