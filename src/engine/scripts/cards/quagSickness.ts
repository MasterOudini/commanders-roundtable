// `Quag Sickness` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { QUAG_SICKNESS } from '../../../data/fixtures/engineCards';
...
export const QUAG_SICKNESS_SCRIPT: CardScript = {
  oracleId: QUAG_SICKNESS.oracleId,
  name: QUAG_SICKNESS.name,
  statics: [
    {
      abilityId: 'pump-1',
