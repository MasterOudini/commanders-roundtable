...
const TEXT = printed(CULLING_SUN, 'Destroy each creature with mana value 3 or less.');

export const CULLING_SUN_SCRIPT: CardScript = {
  oracleId: CULLING_SUN.oracleId,
  name: CULLING_SUN.name,
  spell: {
    text: TEXT,
