// `Auriok Sunchaser` - a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AURIOK_SUNCHASER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AURIOK_SUNCHASER, "Metalcraft — As long as you control three or more artifacts, this creature gets +2/+2 and has flying.");
...
export const AURIOK_SUNCHASER_SCRIPT: CardScript = {
  oracleId: AURIOK_SUNCHASER.oracleId,
  name: AURIOK_SUNCHASER.name,
  statics: [
    {
