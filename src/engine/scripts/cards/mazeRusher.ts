// `Maze Rusher` - a layer-6 grant: "Multicolored creatures you control have haste". A StaticDef in the shape of the
...
import { MAZE_RUSHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAZE_RUSHER, "Haste\nMulticolored creatures you control have haste.");
const TEXT = PRINTED.split('\n')[1] as string;

export const MAZE_RUSHER_SCRIPT: CardScript = {
  oracleId: MAZE_RUSHER.oracleId,
  name: MAZE_RUSHER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
