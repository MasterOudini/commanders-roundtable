// `Predatory Sliver` - a layer-6 anthem: "Sliver creatures you control get +1/+1". A StaticDef in the shape of the
...
import { PREDATORY_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PREDATORY_SLIVER, "Sliver creatures you control get +1/+1.");
const TEXT = PRINTED;

export const PREDATORY_SLIVER_SCRIPT: CardScript = {
  oracleId: PREDATORY_SLIVER.oracleId,
  name: PREDATORY_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
