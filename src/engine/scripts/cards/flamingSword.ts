// `Flaming Sword` - an Aura (Enchant creature): the enchanted creature gets +1/+0 and has firstStrike.
...
import { FLAMING_SWORD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLAMING_SWORD, "Flash\nEnchant creature\nEnchanted creature gets +1/+0 and has first strike.");
const LINES = PRINTED.split('\n');

export const FLAMING_SWORD_SCRIPT: CardScript = {
  oracleId: FLAMING_SWORD.oracleId,
  name: FLAMING_SWORD.name,
  statics: [
    {
