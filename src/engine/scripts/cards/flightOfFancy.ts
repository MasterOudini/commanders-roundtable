// `Flight of Fancy` - an Aura (Enchant creature): the enchanted creature (on entering: draw 2); has flying.
...
import { FLIGHT_OF_FANCY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLIGHT_OF_FANCY, "Enchant creature\nWhen this Aura enters, draw two cards.\nEnchanted creature has flying.");
const LINES = PRINTED.split('\n');

export const FLIGHT_OF_FANCY_SCRIPT: CardScript = {
  oracleId: FLIGHT_OF_FANCY.oracleId,
  name: FLIGHT_OF_FANCY.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Flight of Fancy - draw two cards",
