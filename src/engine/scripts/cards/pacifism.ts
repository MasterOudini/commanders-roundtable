// `Pacifism` - an Aura (Enchant creature): the enchanted creature cannot attack or block.
...
import { PACIFISM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PACIFISM, "Enchant creature\nEnchanted creature can't attack or block.");
const LINES = PRINTED.split('\n');

export const PACIFISM_SCRIPT: CardScript = {
  oracleId: PACIFISM.oracleId,
  name: PACIFISM.name,
  combat: [
    {
