// `Perish` — "Destroy all green creatures. They can't be regenerated."
...
const TEXT = printed(PERISH, "Destroy all green creatures. They can't be regenerated.");

export const PERISH_SCRIPT: CardScript = {
  oracleId: PERISH.oracleId,
  name: PERISH.name,
  spell: {
    text: TEXT,
