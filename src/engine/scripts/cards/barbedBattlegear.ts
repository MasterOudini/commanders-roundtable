// `Barbed Battlegear` - an Equipment: the equipped creature gets +4/-1.
...
import { BARBED_BATTLEGEAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BARBED_BATTLEGEAR, "Equipped creature gets +4/-1.\nEquip {2}");
const LINES = PRINTED.split('\n');

export const BARBED_BATTLEGEAR_SCRIPT: CardScript = {
  oracleId: BARBED_BATTLEGEAR.oracleId,
  name: BARBED_BATTLEGEAR.name,
  statics: [
    {
