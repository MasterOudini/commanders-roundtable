// `Skorpekh Destroyer` - a artifactEnters trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SKORPEKH_DESTROYER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SKORPEKH_DESTROYER, "Deathtouch\nHyperphase Threshers — Whenever an artifact you control enters, this creature gains first strike until end of turn.");
const LINES = PRINTED.split('\n');

export const SKORPEKH_DESTROYER_SCRIPT: CardScript = {
  oracleId: SKORPEKH_DESTROYER.oracleId,
  name: SKORPEKH_DESTROYER.name,
  triggers: [
    {
      ...
      label: () => "Skorpekh Destroyer - it pumped until end of turn",
