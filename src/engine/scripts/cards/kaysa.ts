// `Kaysa` - a layer-6 anthem: "Green creatures you control get +1/+1". A StaticDef in the shape of the
...
import { KAYSA } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KAYSA, "Green creatures you control get +1/+1.");
const TEXT = PRINTED;

export const KAYSA_SCRIPT: CardScript = {
  oracleId: KAYSA.oracleId,
  name: KAYSA.name,
  statics: [
    {
      abilityId: 'anthem',
