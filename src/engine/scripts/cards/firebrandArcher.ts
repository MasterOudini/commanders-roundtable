// `Firebrand Archer` - a castNoncreature trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FIREBRAND_ARCHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FIREBRAND_ARCHER, "Whenever you cast a noncreature spell, this creature deals 1 damage to each opponent.");

export const FIREBRAND_ARCHER_SCRIPT: CardScript = {
  oracleId: FIREBRAND_ARCHER.oracleId,
  name: FIREBRAND_ARCHER.name,
  triggers: [
    {
      ...
      label: () => "Firebrand Archer - damageOpponents",
