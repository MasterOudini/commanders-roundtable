// `Everdawn Champion` - a CONTINUOUS prevention effect (CR 615, D385): a `PreventionDef` the
...
import { EVERDAWN_CHAMPION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(EVERDAWN_CHAMPION, "Prevent all combat damage that would be dealt to this creature.");

export const EVERDAWN_CHAMPION_SCRIPT: CardScript = {
  oracleId: EVERDAWN_CHAMPION.oracleId,
  name: EVERDAWN_CHAMPION.name,
  prevention: [
    {
      abilityId: 'prevent-0',
      text: PRINTED,
