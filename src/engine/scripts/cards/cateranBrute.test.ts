// `Cateran Brute` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Cateran Brute", "Rampart Crawler"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CATERAN_BRUTE_SCRIPT]),
