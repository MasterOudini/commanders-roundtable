// `Satyr Wayfinder` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Satyr Wayfinder", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SATYR_WAYFINDER_SCRIPT]),
...
describe("Satyr Wayfinder", () => {
  test("When this creature enters: the vocabulary resolves \"Reveal the top four cards of your library. You may put a land card from among them into your hand. Put the rest into your graveyard.\"", () => {
    const { g } = armed(0);
