// `Nim Shrieker` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { NIM_SHRIEKER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIM_SHRIEKER, "Flying\nThis creature gets +1/+0 for each artifact you control.");
...
export const NIM_SHRIEKER_SCRIPT: CardScript = {
  oracleId: NIM_SHRIEKER.oracleId,
  name: NIM_SHRIEKER.name,
  statics: [
    {
      abilityId: 'pump-1',
