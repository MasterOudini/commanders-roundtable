// `Douse` - counter on "Counter target red spell": the adjective is the parser's and the
// validator's (D294). Generated from one table row (D295).

import { DOUSE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DOUSE, "{1}{U}: Counter target red spell.");
const TEXT = PRINTED;

export const DOUSE_SCRIPT: CardScript = {
  oracleId: DOUSE.oracleId,
  name: DOUSE.name,
  activated: [
    {
      ref: `${DOUSE.oracleId}#a0`,
      text: TEXT,
