// `Illusionary Servant` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ILLUSIONARY_SERVANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ILLUSIONARY_SERVANT, "Flying\nWhen this creature becomes the target of a spell or ability, sacrifice it.");
const LINES = PRINTED.split('\n');

export const ILLUSIONARY_SERVANT_SCRIPT: CardScript = {
  oracleId: ILLUSIONARY_SERVANT.oracleId,
  name: ILLUSIONARY_SERVANT.name,
  triggers: [
    {
      ...
      label: () => "Illusionary Servant - sacrificeSelf",
