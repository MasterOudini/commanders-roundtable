// `Oathsworn Giant` - a layer-6 anthem: "Other creatures you control get +0/+2 and have vigilance". A StaticDef in the shape of the
...
import { OATHSWORN_GIANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(OATHSWORN_GIANT, "Vigilance\nOther creatures you control get +0/+2 and have vigilance.");
const TEXT = PRINTED.split('\n')[1] as string;

export const OATHSWORN_GIANT_SCRIPT: CardScript = {
  oracleId: OATHSWORN_GIANT.oracleId,
  name: OATHSWORN_GIANT.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
