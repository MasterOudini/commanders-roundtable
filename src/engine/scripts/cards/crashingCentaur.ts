// `Crashing Centaur` - an activation pumping itself, a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CRASHING_CENTAUR } from '../../../data/fixtures/engineCards';
...
export const CRASHING_CENTAUR_SCRIPT: CardScript = {
  oracleId: CRASHING_CENTAUR.oracleId,
  name: CRASHING_CENTAUR.name,
  activated: [
    {
      ref: `${CRASHING_CENTAUR.oracleId}#a0`,
