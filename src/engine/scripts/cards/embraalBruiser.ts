// `Embraal Bruiser` - a conditional static (as long as you control an artifact) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { EMBRAAL_BRUISER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(EMBRAAL_BRUISER, "This creature enters tapped.\nThis creature has menace as long as you control an artifact.");
...
export const EMBRAAL_BRUISER_SCRIPT: CardScript = {
  oracleId: EMBRAAL_BRUISER.oracleId,
  name: EMBRAAL_BRUISER.name,
  statics: [
    {
