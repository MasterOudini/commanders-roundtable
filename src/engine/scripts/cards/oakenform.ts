// `Oakenform` - an Aura (Enchant creature): the enchanted creature gets +3/+3.
...
import { OAKENFORM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(OAKENFORM, "Enchant creature\nEnchanted creature gets +3/+3.");
const LINES = PRINTED.split('\n');

export const OAKENFORM_SCRIPT: CardScript = {
  oracleId: OAKENFORM.oracleId,
  name: OAKENFORM.name,
  statics: [
    {
