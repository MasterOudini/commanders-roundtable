// `Kessig Dire Swine` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { KESSIG_DIRE_SWINE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KESSIG_DIRE_SWINE, "Delirium — This creature has trample as long as there are four or more card types among cards in your graveyard.");
...
export const KESSIG_DIRE_SWINE_SCRIPT: CardScript = {
  oracleId: KESSIG_DIRE_SWINE.oracleId,
  name: KESSIG_DIRE_SWINE.name,
  statics: [
    {
