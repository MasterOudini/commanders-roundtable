// `Ivy Elemental` - a static entersWithCountersX
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { IVY_ELEMENTAL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(IVY_ELEMENTAL, "This creature enters with X +1/+1 counters on it.");

export const IVY_ELEMENTAL_SCRIPT: CardScript = {
  oracleId: IVY_ELEMENTAL.oracleId,
  name: IVY_ELEMENTAL.name,
  replacements: [
    {
