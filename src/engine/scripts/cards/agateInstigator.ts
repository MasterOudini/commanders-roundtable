// `Agate Instigator` - a anotherCreatureEnters trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AGATE_INSTIGATOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AGATE_INSTIGATOR, "Offspring {1}{R} (You may pay an additional {1}{R} as you cast this spell. If you do, when this creature enters, create a 1/1 token copy of it.)\nWhenever another creature you control enters, this creature deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const AGATE_INSTIGATOR_SCRIPT: CardScript = {
  oracleId: AGATE_INSTIGATOR.oracleId,
  name: AGATE_INSTIGATOR.name,
  triggers: [
    {
      ...
      label: () => "Agate Instigator - damageOpponents",
