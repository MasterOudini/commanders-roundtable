// `Sicken` - an Aura (Enchant creature): the enchanted creature gets -1/-1.
...
import { SICKEN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SICKEN, "Enchant creature\nEnchanted creature gets -1/-1.\nCycling {2} ({2}, Discard this card: Draw a card.)");
const LINES = PRINTED.split('\n');

export const SICKEN_SCRIPT: CardScript = {
  oracleId: SICKEN.oracleId,
  name: SICKEN.name,
  statics: [
    {
