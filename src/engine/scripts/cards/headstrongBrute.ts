// `Headstrong Brute` - a static cantBlock, a conditional static (as long as you control another Pirate) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { HEADSTRONG_BRUTE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HEADSTRONG_BRUTE, "This creature can't block.\nThis creature has menace as long as you control another Pirate.");
...
export const HEADSTRONG_BRUTE_SCRIPT: CardScript = {
  oracleId: HEADSTRONG_BRUTE.oracleId,
  name: HEADSTRONG_BRUTE.name,
  combat: [
    {
