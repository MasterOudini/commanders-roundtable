// `Greatsword` - an Equipment: the equipped creature gets +3/+0.
...
import { GREATSWORD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GREATSWORD, "Equipped creature gets +3/+0.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const GREATSWORD_SCRIPT: CardScript = {
  oracleId: GREATSWORD.oracleId,
