// `Dimir Cluestone` — the sacrifice-draw, spent at activation, drawn at
// resolution.

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { DIMIR_CLUESTONE_SCRIPT } from './dimirCluestone';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CLUESTONE = 'Dimir Cluestone';
...
function game(): { g: Game; stone: InstanceId } {
  const g = startedGame({
    players: 2,
    decks: [[CLUESTONE], []],
    scripts: createRegistry([DIMIR_CLUESTONE_SCRIPT]),
  });
