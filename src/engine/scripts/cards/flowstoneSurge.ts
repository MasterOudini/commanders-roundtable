// `Flowstone Surge` - a layer-6 anthem: "Creatures you control get +1/-1". A StaticDef in the shape of the
...
import { FLOWSTONE_SURGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLOWSTONE_SURGE, "Creatures you control get +1/-1.");
const TEXT = PRINTED;

export const FLOWSTONE_SURGE_SCRIPT: CardScript = {
  oracleId: FLOWSTONE_SURGE.oracleId,
  name: FLOWSTONE_SURGE.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
