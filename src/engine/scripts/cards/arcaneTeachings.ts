// `Arcane Teachings` - the permanent it is attached to HAS a quoted
...
import { ARCANE_TEACHINGS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARCANE_TEACHINGS, "Enchant creature (Target a creature as you cast this. This card enters attached to that creature.)\nEnchanted creature gets +2/+2 and has \"{T}: This creature deals 1 damage to any target.\"");
const LINES = PRINTED.split('\n');

const GRANT = grantedActivated("{T}: This creature deals 1 damage to any target.", `${ARCANE_TEACHINGS.oracleId}#g1`, ARCANE_TEACHINGS.name);
const VOCAB = vocabularyEffects("This creature deals 1 damage to any target.", ARCANE_TEACHINGS.name);
const VOCAB_T = vocabularyTargets("This creature deals 1 damage to any target.");

export const ARCANE_TEACHINGS_SCRIPT: CardScript = {
  oracleId: ARCANE_TEACHINGS.oracleId,
  name: ARCANE_TEACHINGS.name,
  statics: [
    {
