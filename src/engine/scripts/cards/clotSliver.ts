// `Clot Sliver` - every permanent in its scope HAS a quoted
...
import { CLOT_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CLOT_SLIVER, "All Slivers have \"{2}: Regenerate this permanent.\"");

const GRANT = grantedActivated("{2}: Regenerate this permanent.", `${CLOT_SLIVER.oracleId}#g0`, CLOT_SLIVER.name);
const VOCAB = vocabularyEffects("Regenerate this permanent.", CLOT_SLIVER.name);
const VOCAB_T = vocabularyTargets("Regenerate this permanent.");

export const CLOT_SLIVER_SCRIPT: CardScript = {
  oracleId: CLOT_SLIVER.oracleId,
  name: CLOT_SLIVER.name,
  statics: [
    {
      abilityId: 'grant-0',
      text: PRINTED,
