// `Luminous Bonds` - cast on Grizzly Bears it attaches and the enchanted creature cannot attack or block;
...
import { LUMINOUS_BONDS_SCRIPT } from './luminousBonds';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Luminous Bonds";
...
function board(): { g: Game; self: InstanceId; host: InstanceId; other: InstanceId } {
  const g = startedGame({
    ...
    scripts: createRegistry([LUMINOUS_BONDS_SCRIPT]),
  });
  holdEverywhere(g);
