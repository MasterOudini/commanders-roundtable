// `Okina Nightwatch` - a conditional static (as long as you have more cards in hand than each opponent) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { OKINA_NIGHTWATCH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(OKINA_NIGHTWATCH, "As long as you have more cards in hand than each opponent, this creature gets +3/+3.");
...
export const OKINA_NIGHTWATCH_SCRIPT: CardScript = {
  oracleId: OKINA_NIGHTWATCH.oracleId,
  name: OKINA_NIGHTWATCH.name,
  statics: [
    {
