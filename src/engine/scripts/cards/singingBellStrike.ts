// `Singing Bell Strike` - a etb trigger tapAttached, a static attachedNoUntap, a static attachedStatic, an activation vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SINGING_BELL_STRIKE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SINGING_BELL_STRIKE, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.\nEnchanted creature has \"{6}: Untap this creature.\"");
const LINES = PRINTED.split('\n');

const VOCAB_G3 = vocabularyEffects("Untap this creature.", SINGING_BELL_STRIKE.name);
const VOCAB_T_G3 = vocabularyTargets("Untap this creature.");

const GRANT_3 = grantedActivated("{6}: Untap this creature.", `${SINGING_BELL_STRIKE.oracleId}#g3`, SINGING_BELL_STRIKE.name);

export const SINGING_BELL_STRIKE_SCRIPT: CardScript = {
  oracleId: SINGING_BELL_STRIKE.oracleId,
  name: SINGING_BELL_STRIKE.name,
  activated: [
    {
      ref: GRANT_3.ref,
  ...
  triggers: [
    {
      ...
      label: () => "Singing Bell Strike - tapAttached",
