// `Nightstalker Engine` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NIGHTSTALKER_ENGINE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIGHTSTALKER_ENGINE, "Nightstalker Engine's power is equal to the number of creature cards in your graveyard.");
...
export const NIGHTSTALKER_ENGINE_SCRIPT: CardScript = {
  oracleId: NIGHTSTALKER_ENGINE.oracleId,
  name: NIGHTSTALKER_ENGINE.name,
  statics: [
    {
      abilityId: 'cda-0',
      text: PRINTED,
