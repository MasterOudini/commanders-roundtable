// `Mantle of Webs` - an Aura (Enchant creature): the enchanted creature gets +1/+3 and has reach.
...
import { MANTLE_OF_WEBS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MANTLE_OF_WEBS, "Enchant creature\nEnchanted creature gets +1/+3 and has reach. (It can block creatures with flying.)");
const LINES = PRINTED.split('\n');

export const MANTLE_OF_WEBS_SCRIPT: CardScript = {
  oracleId: MANTLE_OF_WEBS.oracleId,
  name: MANTLE_OF_WEBS.name,
  statics: [
    {
