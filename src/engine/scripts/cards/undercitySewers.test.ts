// `Undercity Sewers` — enters tapped, and the entry asks the surveil.

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { UNDERCITY_SEWERS_SCRIPT } from './undercitySewers';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const LAND = 'Undercity Sewers';
...
function entered(): { g: Game; land: InstanceId; revealed: InstanceId[] } {
  const g = startedGame({
    players: 2,
    decks: [[LAND], []],
    scripts: createRegistry([UNDERCITY_SEWERS_SCRIPT]),
  });
