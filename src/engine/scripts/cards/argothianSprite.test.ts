// `Argothian Sprite` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ARGOTHIAN_SPRITE_SCRIPT } from './argothianSprite';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Argothian Sprite";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Argothian Sprite", "Grizzly Bears"], ["Cyclops of One-Eyed Pass", "Memnite"]],
    scripts: createRegistry([ARGOTHIAN_SPRITE_SCRIPT]),
