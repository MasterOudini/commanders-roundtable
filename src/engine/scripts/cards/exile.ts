// `Exile` - a scripted spell: the target clause is the parser's and the validator's
// (D294's adjectives), the rider is this script's. Generated from one table row (D295).

import { EXILE } from '../../../data/fixtures/engineCards';
...
const TEXT = printed(EXILE, "Exile target nonwhite attacking creature. You gain life equal to its toughness.");

export const EXILE_SCRIPT: CardScript = {
  oracleId: EXILE.oracleId,
  name: EXILE.name,
  spell: {
    text: TEXT,
