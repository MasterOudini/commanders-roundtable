// `Paranoid Parish-Blade` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PARANOID_PARISH_BLADE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PARANOID_PARISH_BLADE, "Delirium — This creature gets +1/+0 and has first strike as long as there are four or more card types among cards in your graveyard.");
...
export const PARANOID_PARISH_BLADE_SCRIPT: CardScript = {
  oracleId: PARANOID_PARISH_BLADE.oracleId,
  name: PARANOID_PARISH_BLADE.name,
  statics: [
    {
