// `Brawler's Plate` - an Equipment: the equipped creature gets +2/+2 and has trample.
...
import { BRAWLER_S_PLATE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BRAWLER_S_PLATE, "Equipped creature gets +2/+2 and has trample. (It can deal excess combat damage to the player or planeswalker it's attacking.)\nEquip {4} ({4}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const BRAWLERS_PLATE_SCRIPT: CardScript = {
  oracleId: BRAWLER_S_PLATE.oracleId,
  name: BRAWLER_S_PLATE.name,
  statics: [
    {
