// `Walker of the Grove` - every printed ability proven in its own game: the cost's mark, the pump
...
import { WALKER_OF_THE_GROVE_SCRIPT } from './walkerOfTheGrove';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Walker of the Grove";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Walker of the Grove"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([WALKER_OF_THE_GROVE_SCRIPT]),
...
describe("Walker of the Grove", () => {
  test("When this creature leaves the battlefield: 1 token made", () => {
