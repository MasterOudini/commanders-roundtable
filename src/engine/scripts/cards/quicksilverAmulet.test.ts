// `Quicksilver Amulet` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Quicksilver Amulet", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([QUICKSILVER_AMULET_SCRIPT]),
...
describe("Quicksilver Amulet", () => {
  test("{4}, {T}: the vocabulary resolves \"You may put a creature card from your hand onto the battlefield.\"", () => {
