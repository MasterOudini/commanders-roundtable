// `Leonin Scimitar` - an Equipment: the equipped creature gets +1/+1.
...
import { LEONIN_SCIMITAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LEONIN_SCIMITAR, "Equipped creature gets +1/+1.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const LEONIN_SCIMITAR_SCRIPT: CardScript = {
  oracleId: LEONIN_SCIMITAR.oracleId,
  name: LEONIN_SCIMITAR.name,
  statics: [
    {
