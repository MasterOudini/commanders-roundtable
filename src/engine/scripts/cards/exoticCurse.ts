// `Exotic Curse` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { EXOTIC_CURSE } from '../../../data/fixtures/engineCards';
...
export const EXOTIC_CURSE_SCRIPT: CardScript = {
  oracleId: EXOTIC_CURSE.oracleId,
  name: EXOTIC_CURSE.name,
  statics: [
    {
      abilityId: 'pump-1',
