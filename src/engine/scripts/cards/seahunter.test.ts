// `Seahunter` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Seahunter", "Merfolk of the Pearl Trident"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SEAHUNTER_SCRIPT]),
...
describe("Seahunter", () => {
  test("{3}, {T}: the vocabulary resolves \"Search your library for a Merfolk permanent card, put it onto the battlefield, then shuffle.\"", () => {
