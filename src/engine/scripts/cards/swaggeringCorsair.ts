// `Swaggering Corsair` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SWAGGERING_CORSAIR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SWAGGERING_CORSAIR, "Raid — This creature enters with a +1/+1 counter on it if you attacked this turn.");
...
export const SWAGGERING_CORSAIR_SCRIPT: CardScript = {
  oracleId: SWAGGERING_CORSAIR.oracleId,
  name: SWAGGERING_CORSAIR.name,
  replacements: [
    {
