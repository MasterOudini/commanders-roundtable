// `Ramosian Lieutenant` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ramosian Lieutenant", "Children of Korlis"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RAMOSIAN_LIEUTENANT_SCRIPT]),
