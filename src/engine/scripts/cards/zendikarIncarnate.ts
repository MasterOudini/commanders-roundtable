// `Zendikar Incarnate` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ZENDIKAR_INCARNATE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ZENDIKAR_INCARNATE, "Zendikar Incarnate's power is equal to the number of lands you control.");
...
export const ZENDIKAR_INCARNATE_SCRIPT: CardScript = {
  oracleId: ZENDIKAR_INCARNATE.oracleId,
  name: ZENDIKAR_INCARNATE.name,
  statics: [
    {
      abilityId: 'cda-0',
      text: PRINTED,
