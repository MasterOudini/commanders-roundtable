// `Sporeback Wolf` - a conditional static (as long as it's your turn) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPOREBACK_WOLF } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPOREBACK_WOLF, "During your turn, this creature gets +0/+2.");
...
export const SPOREBACK_WOLF_SCRIPT: CardScript = {
  oracleId: SPOREBACK_WOLF.oracleId,
  name: SPOREBACK_WOLF.name,
  statics: [
    {
