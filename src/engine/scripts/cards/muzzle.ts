// `Muzzle` - a CONTINUOUS prevention effect (CR 615, D385): a `PreventionDef` the
...
import { MUZZLE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MUZZLE, "Enchant creature\nPrevent all damage that would be dealt by enchanted creature.");
const LINES = PRINTED.split(String.fromCharCode(10));

export const MUZZLE_SCRIPT: CardScript = {
  oracleId: MUZZLE.oracleId,
  name: MUZZLE.name,
  prevention: [
    {
      abilityId: 'prevent-1',
