// `Tocasia's Onulet` - a leavesBattlefield trigger gainLife
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TOCASIA_S_ONULET } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TOCASIA_S_ONULET, "When this creature leaves the battlefield, you gain 2 life.\nUnearth {3}{W} ({3}{W}: Return this card from your graveyard to the battlefield. It gains haste. Exile it at the beginning of the next end step or if it would leave the battlefield. Unearth only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const TOCASIAS_ONULET_SCRIPT: CardScript = {
  oracleId: TOCASIA_S_ONULET.oracleId,
  name: TOCASIA_S_ONULET.name,
  triggers: [
    {
      ...
      label: () => "Tocasia's Onulet - gain life",
