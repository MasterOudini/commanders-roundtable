// `Knighthood` - a layer-6 grant: "Creatures you control have first strike". A StaticDef in the shape of the
...
import { KNIGHTHOOD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KNIGHTHOOD, "Creatures you control have first strike.");
const TEXT = PRINTED;
