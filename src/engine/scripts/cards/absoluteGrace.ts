// `Absolute Grace` - a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ABSOLUTE_GRACE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ABSOLUTE_GRACE, "All creatures have protection from black.");
...
const PROT_0_0 = parseProtection("protection from black");

export const ABSOLUTE_GRACE_SCRIPT: CardScript = {
  oracleId: ABSOLUTE_GRACE.oracleId,
  name: ABSOLUTE_GRACE.name,
  statics: [
    {
