// `Anarchy` — "Destroy all white permanents." The first COLOR wipe:
...
const TEXT = printed(ANARCHY, 'Destroy all white permanents.');

export const ANARCHY_SCRIPT: CardScript = {
  oracleId: ANARCHY.oracleId,
  name: ANARCHY.name,
  spell: {
    text: TEXT,
