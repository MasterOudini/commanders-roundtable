// `Loxodon Punisher` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { LOXODON_PUNISHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LOXODON_PUNISHER, "This creature gets +2/+2 for each Equipment attached to it.");
...
export const LOXODON_PUNISHER_SCRIPT: CardScript = {
  oracleId: LOXODON_PUNISHER.oracleId,
  name: LOXODON_PUNISHER.name,
  statics: [
    {
      abilityId: 'pump-0',
