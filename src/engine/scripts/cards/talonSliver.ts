// `Talon Sliver` - a layer-6 grant: "All Sliver creatures have first strike". A StaticDef in the shape of the
...
import { TALON_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TALON_SLIVER, "All Sliver creatures have first strike.");
const TEXT = PRINTED;

export const TALON_SLIVER_SCRIPT: CardScript = {
  oracleId: TALON_SLIVER.oracleId,
  name: TALON_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
