// `Knightly Valor` - an Aura (Enchant creature): the enchanted creature (on entering: 1 token); gets +2/+2 and has vigilance.
...
import { KNIGHTLY_VALOR } from '../../../data/fixtures/engineCards';
...
const TOKEN = tokenRef("Knight|2/2|W|Creature|vigilance");

export const KNIGHTLY_VALOR_SCRIPT: CardScript = {
  oracleId: KNIGHTLY_VALOR.oracleId,
  name: KNIGHTLY_VALOR.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Knightly Valor - create a token",
