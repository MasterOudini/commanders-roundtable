// `Herald of the Dreadhorde` - every printed ability proven in its own game: the cost's mark, the pump
...
import { HERALD_OF_THE_DREADHORDE_SCRIPT } from './heraldOfTheDreadhorde';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Herald of the Dreadhorde";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Herald of the Dreadhorde"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([HERALD_OF_THE_DREADHORDE_SCRIPT]),
...
describe("Herald of the Dreadhorde", () => {
  test("When this creature dies: the vocabulary resolves \"Amass Zombies 2.\"", () => {
