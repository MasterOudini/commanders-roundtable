// `Deep-Sea Serpent` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DEEP_SEA_SERPENT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DEEP_SEA_SERPENT, "This creature can't attack unless defending player controls an Island.");
...
export const DEEP_SEA_SERPENT_SCRIPT: CardScript = {
  oracleId: DEEP_SEA_SERPENT.oracleId,
  name: DEEP_SEA_SERPENT.name,
  combat: [
    {
