// `Trynn, Champion of Freedom` - every printed ability proven in its own game: the cost's mark, the pump
...
import { TRYNN_CHAMPION_OF_FREEDOM_SCRIPT } from './trynnChampionOfFreedom';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Trynn, Champion of Freedom";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Trynn, Champion of Freedom", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([TRYNN_CHAMPION_OF_FREEDOM_SCRIPT]),
...
describe("Trynn, Champion of Freedom", () => {
  test("At the beginning of your end step: 1 token made", () => {
