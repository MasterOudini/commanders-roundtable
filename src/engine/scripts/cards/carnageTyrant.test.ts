// `Carnage Tyrant` - every printed ability proven in its own game: the cost's mark, the pump
...
import { CARNAGE_TYRANT_SCRIPT } from './carnageTyrant';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Carnage Tyrant";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Carnage Tyrant"], ["Cyclops of One-Eyed Pass", "Counterspell"]],
