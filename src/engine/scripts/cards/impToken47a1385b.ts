// `Imp` - a dies trigger damageOpponents
...
const PRINTED = printed(IMP_47A1385B_TOKEN, "When this creature dies, it deals 2 damage to each opponent.");

export const IMP_TOKEN47A1385B_SCRIPT: CardScript = {
  oracleId: IMP_47A1385B_TOKEN.oracleId,
  name: IMP_47A1385B_TOKEN.name,
  triggers: [
    {
      abilityId: 'dies-0',
      text: PRINTED,
