// `Emissary of the Sleepless` - a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { EMISSARY_OF_THE_SLEEPLESS } from '../../../data/fixtures/engineCards';
...
export const EMISSARY_OF_THE_SLEEPLESS_SCRIPT: CardScript = {
  oracleId: EMISSARY_OF_THE_SLEEPLESS.oracleId,
  name: EMISSARY_OF_THE_SLEEPLESS.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Emissary of the Sleepless - token",
