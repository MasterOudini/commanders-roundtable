// `Emeria, the Sky Ruin` - every printed ability proven in its own game: the cost's mark, the pump
...
import { EMERIA_THE_SKY_RUIN_SCRIPT } from './emeriaTheSkyRuin';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Emeria, the Sky Ruin";

type Armed = { g: Game; self: InstanceId; no: InstanceId; life0: number; energy0: number; hand0: number; board0: number; p2life0: number; p2hand0: number; gy0: number; p2gy0: number; lib0: number; vtL1_upkeep_0: InstanceId };
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Emeria, the Sky Ruin", "Grizzly Bears", "Plains", "Plains", "Plains", "Plains", "Plains", "Plains", "Plains"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([EMERIA_THE_SKY_RUIN_SCRIPT]),
  ...
  return { g, self, no, life0, energy0, hand0, board0, p2life0, p2hand0, gy0, p2gy0, lib0, vtL1_upkeep_0 };
}
