// `Demon of Loathing` - every printed ability proven in its own game: the cost's mark, the pump
...
import { DEMON_OF_LOATHING_SCRIPT } from './demonOfLoathing';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Demon of Loathing";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Demon of Loathing"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DEMON_OF_LOATHING_SCRIPT]),
