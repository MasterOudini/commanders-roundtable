// `Crumbling Colossus` - every printed ability proven in its own game: the cost's mark, the pump
...
import { CRUMBLING_COLOSSUS_SCRIPT } from './crumblingColossus';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Crumbling Colossus";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Crumbling Colossus"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([CRUMBLING_COLOSSUS_SCRIPT]),
...
describe("Crumbling Colossus", () => {
  test("When this creature attacks: the vocabulary resolves \"Sacrifice ~ at end of combat.\"", () => {
