// `Viridian Claw` - an Equipment: the equipped creature gets +1/+0 and has firstStrike.
...
import { VIRIDIAN_CLAW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VIRIDIAN_CLAW, "Equipped creature gets +1/+0 and has first strike.\nEquip {1}");
const LINES = PRINTED.split('\n');

export const VIRIDIAN_CLAW_SCRIPT: CardScript = {
  oracleId: VIRIDIAN_CLAW.oracleId,
  name: VIRIDIAN_CLAW.name,
  statics: [
    {
