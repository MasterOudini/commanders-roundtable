// `Scourge Wolf` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SCOURGE_WOLF } from '../../../data/fixtures/engineCards';
...
export const SCOURGE_WOLF_SCRIPT: CardScript = {
  oracleId: SCOURGE_WOLF.oracleId,
  name: SCOURGE_WOLF.name,
  statics: [
    {
