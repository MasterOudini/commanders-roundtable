// `Gleaming Geardrake` - a etb trigger token, a youSacrifice trigger selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GLEAMING_GEARDRAKE } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Gleaming Geardrake - token",
    ...
    },
    {
      ...
      label: () => "Gleaming Geardrake - a counter on it",
