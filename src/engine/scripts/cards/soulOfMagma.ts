// `Soul of Magma` - a castSpiritOrArcane trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SOUL_OF_MAGMA } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SOUL_OF_MAGMA, "Whenever you cast a Spirit or Arcane spell, this creature deals 1 damage to target creature.");

export const SOUL_OF_MAGMA_SCRIPT: CardScript = {
  oracleId: SOUL_OF_MAGMA.oracleId,
  name: SOUL_OF_MAGMA.name,
  triggers: [
    {
      ...
      label: () => "Soul of Magma - damageTarget",
