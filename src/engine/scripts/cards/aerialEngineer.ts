// `Aerial Engineer` - a conditional static (as long as you control an artifact) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AERIAL_ENGINEER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AERIAL_ENGINEER, "As long as you control an artifact, this creature gets +2/+0 and has flying.");
...
export const AERIAL_ENGINEER_SCRIPT: CardScript = {
  oracleId: AERIAL_ENGINEER.oracleId,
  name: AERIAL_ENGINEER.name,
  statics: [
    {
