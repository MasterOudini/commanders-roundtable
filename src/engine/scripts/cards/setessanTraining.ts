// `Setessan Training` - an Aura (Enchant creature you control): the enchanted creature (on entering: draw 1); gets +1/+0 and has trample.
...
import { SETESSAN_TRAINING } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SETESSAN_TRAINING, "Enchant creature you control\nWhen this Aura enters, draw a card.\nEnchanted creature gets +1/+0 and has trample. (It can deal excess combat damage to the player or planeswalker it's attacking.)");
const LINES = PRINTED.split('\n');

export const SETESSAN_TRAINING_SCRIPT: CardScript = {
  oracleId: SETESSAN_TRAINING.oracleId,
  name: SETESSAN_TRAINING.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Setessan Training - draw a card",
