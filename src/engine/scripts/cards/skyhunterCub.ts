// `Skyhunter Cub` - a conditional static (as long as this creature is equipped) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SKYHUNTER_CUB } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SKYHUNTER_CUB, "As long as this creature is equipped, it gets +1/+1 and has flying.");
...
export const SKYHUNTER_CUB_SCRIPT: CardScript = {
  oracleId: SKYHUNTER_CUB.oracleId,
  name: SKYHUNTER_CUB.name,
  statics: [
    {
