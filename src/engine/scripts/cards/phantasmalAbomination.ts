// `Phantasmal Abomination` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PHANTASMAL_ABOMINATION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PHANTASMAL_ABOMINATION, "Defender\nWhen this creature becomes the target of a spell or ability, sacrifice it.");
const LINES = PRINTED.split('\n');

export const PHANTASMAL_ABOMINATION_SCRIPT: CardScript = {
  oracleId: PHANTASMAL_ABOMINATION.oracleId,
  name: PHANTASMAL_ABOMINATION.name,
  triggers: [
    {
      ...
      label: () => "Phantasmal Abomination - sacrificeSelf",
