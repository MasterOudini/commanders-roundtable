// `Duskhunter Bat` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DUSKHUNTER_BAT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DUSKHUNTER_BAT, "Bloodthirst 1 (If an opponent was dealt damage this turn, this creature enters with a +1/+1 counter on it.)\nFlying");
...
export const DUSKHUNTER_BAT_SCRIPT: CardScript = {
  oracleId: DUSKHUNTER_BAT.oracleId,
  name: DUSKHUNTER_BAT.name,
  replacements: [
    {
