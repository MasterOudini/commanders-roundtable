// `Bonescythe Sliver` - a layer-6 grant: "Sliver creatures you control have double strike. (They deal both first-strike and regular combat damage.)". A StaticDef in the shape of the
...
import { BONESCYTHE_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BONESCYTHE_SLIVER, "Sliver creatures you control have double strike. (They deal both first-strike and regular combat damage.)");
const TEXT = PRINTED;

export const BONESCYTHE_SLIVER_SCRIPT: CardScript = {
  oracleId: BONESCYTHE_SLIVER.oracleId,
  name: BONESCYTHE_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
