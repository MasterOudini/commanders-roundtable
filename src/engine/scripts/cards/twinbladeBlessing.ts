// `Twinblade Blessing` - an Aura (Enchant creature): the enchanted creature has doubleStrike.
...
import { TWINBLADE_BLESSING } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TWINBLADE_BLESSING, "Flash (You may cast this spell any time you could cast an instant.)\nEnchant creature\nEnchanted creature has double strike. (It deals both first-strike and regular combat damage.)");
const LINES = PRINTED.split('\n');

export const TWINBLADE_BLESSING_SCRIPT: CardScript = {
  oracleId: TWINBLADE_BLESSING.oracleId,
  name: TWINBLADE_BLESSING.name,
  statics: [
    {
