// `Wayward Servant` - a anotherCreatureEnters trigger drain
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WAYWARD_SERVANT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WAYWARD_SERVANT, "Whenever another Zombie you control enters, each opponent loses 1 life and you gain 1 life.");

export const WAYWARD_SERVANT_SCRIPT: CardScript = {
  oracleId: WAYWARD_SERVANT.oracleId,
  name: WAYWARD_SERVANT.name,
  triggers: [
    {
