// `Primal Frenzy` - an Aura (Enchant creature): the enchanted creature has trample.
...
import { PRIMAL_FRENZY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PRIMAL_FRENZY, "Enchant creature\nEnchanted creature has trample.");
const LINES = PRINTED.split('\n');

export const PRIMAL_FRENZY_SCRIPT: CardScript = {
  oracleId: PRIMAL_FRENZY.oracleId,
  name: PRIMAL_FRENZY.name,
  statics: [
    {
