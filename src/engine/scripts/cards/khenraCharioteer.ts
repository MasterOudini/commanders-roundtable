// `Khenra Charioteer` - a layer-6 grant: "Other creatures you control have trample". A StaticDef in the shape of the
...
import { KHENRA_CHARIOTEER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KHENRA_CHARIOTEER, "Trample\nOther creatures you control have trample.");
const TEXT = PRINTED.split('\n')[1] as string;

export const KHENRA_CHARIOTEER_SCRIPT: CardScript = {
  oracleId: KHENRA_CHARIOTEER.oracleId,
  name: KHENRA_CHARIOTEER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
