// `Muscle Sliver` - a layer-6 anthem: "All Sliver creatures get +1/+1". A StaticDef in the shape of the
...
import { MUSCLE_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MUSCLE_SLIVER, "All Sliver creatures get +1/+1.");
const TEXT = PRINTED;

export const MUSCLE_SLIVER_SCRIPT: CardScript = {
  oracleId: MUSCLE_SLIVER.oracleId,
  name: MUSCLE_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
