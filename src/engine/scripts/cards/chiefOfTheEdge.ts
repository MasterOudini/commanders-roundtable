// `Chief of the Edge` - a layer-6 anthem: "Other Warrior creatures you control get +1/+0". A StaticDef in the shape of the
...
import { CHIEF_OF_THE_EDGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CHIEF_OF_THE_EDGE, "Other Warrior creatures you control get +1/+0.");
const TEXT = PRINTED;

export const CHIEF_OF_THE_EDGE_SCRIPT: CardScript = {
  oracleId: CHIEF_OF_THE_EDGE.oracleId,
  name: CHIEF_OF_THE_EDGE.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
