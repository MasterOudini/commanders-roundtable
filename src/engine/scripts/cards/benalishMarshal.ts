// `Benalish Marshal` - a layer-6 anthem: "Other creatures you control get +1/+1". A StaticDef in the shape of the
...
import { BENALISH_MARSHAL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BENALISH_MARSHAL, "Other creatures you control get +1/+1.");
const TEXT = PRINTED;

export const BENALISH_MARSHAL_SCRIPT: CardScript = {
  oracleId: BENALISH_MARSHAL.oracleId,
  name: BENALISH_MARSHAL.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
