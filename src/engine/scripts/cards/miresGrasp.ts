// `Mire's Grasp` - an Aura (Enchant creature): the enchanted creature gets -3/-3.
...
import { MIRE_S_GRASP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MIRE_S_GRASP, "Enchant creature\nEnchanted creature gets -3/-3.");
const LINES = PRINTED.split('\n');

export const MIRES_GRASP_SCRIPT: CardScript = {
  oracleId: MIRE_S_GRASP.oracleId,
  name: MIRE_S_GRASP.name,
  statics: [
    {
