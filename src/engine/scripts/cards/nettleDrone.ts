// `Nettle Drone` - an activation damageOpponents, a castSpell trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NETTLE_DRONE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NETTLE_DRONE, "Devoid (This card has no color.)\n{T}: This creature deals 1 damage to each opponent.\nWhenever you cast a colorless spell, untap this creature.");
const LINES = PRINTED.split('\n');

export const NETTLE_DRONE_SCRIPT: CardScript = {
  oracleId: NETTLE_DRONE.oracleId,
  name: NETTLE_DRONE.name,
  activated: [
    {
      ref: `${NETTLE_DRONE.oracleId}#a0`,
