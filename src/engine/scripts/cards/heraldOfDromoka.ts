// `Herald of Dromoka` - a layer-6 grant: "Other Warrior creatures you control have vigilance". A StaticDef in the shape of the
...
import { HERALD_OF_DROMOKA } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HERALD_OF_DROMOKA, "Vigilance\nOther Warrior creatures you control have vigilance.");
const TEXT = PRINTED.split('\n')[1] as string;

export const HERALD_OF_DROMOKA_SCRIPT: CardScript = {
  oracleId: HERALD_OF_DROMOKA.oracleId,
  name: HERALD_OF_DROMOKA.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
