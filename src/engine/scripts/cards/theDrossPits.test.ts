// `The Dross Pits` — enters tapped, and the sac-draw eats the land for a card.

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { THE_DROSS_PITS_SCRIPT } from './theDrossPits';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const SPHERE = 'The Dross Pits';
...
function game(): { g: Game; sphere: InstanceId } {
  const g = startedGame({
    players: 2,
    decks: [[SPHERE], []],
    scripts: createRegistry([THE_DROSS_PITS_SCRIPT]),
  });
...
/** Straightens the land (it entered tapped) and funds the {1}{B}. */
