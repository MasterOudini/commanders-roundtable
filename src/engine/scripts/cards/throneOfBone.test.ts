// `Throne of Bone` - every printed ability proven in its own game: the cost's mark, the pump
...
import { THRONE_OF_BONE_SCRIPT } from './throneOfBone';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Throne of Bone";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Throne of Bone", "Grizzly Bears", "Muck Rats", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([THRONE_OF_BONE_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Throne of Bone", () => {
  test("Whenever a player casts a black spell: the vocabulary resolves \"You may pay {1}. If you do, you gain 1 life.\" - the price is declined", () => {
  ...
  test("Whenever a player casts a black spell: the vocabulary resolves \"You may pay {1}. If you do, you gain 1 life.\" - the price is paid", () => {
