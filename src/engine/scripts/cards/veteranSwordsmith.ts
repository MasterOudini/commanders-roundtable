// `Veteran Swordsmith` - a layer-6 anthem: "Other Soldier creatures you control get +1/+0". A StaticDef in the shape of the
...
import { VETERAN_SWORDSMITH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VETERAN_SWORDSMITH, "Other Soldier creatures you control get +1/+0.");
const TEXT = PRINTED;

export const VETERAN_SWORDSMITH_SCRIPT: CardScript = {
  oracleId: VETERAN_SWORDSMITH.oracleId,
  name: VETERAN_SWORDSMITH.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
