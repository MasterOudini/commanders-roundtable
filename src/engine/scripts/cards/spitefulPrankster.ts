// `Spiteful Prankster` - a conditional static (as long as it's your turn) threshold, a anyOtherCreatureDies trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPITEFUL_PRANKSTER } from '../../../data/fixtures/engineCards';
...
export const SPITEFUL_PRANKSTER_SCRIPT: CardScript = {
  oracleId: SPITEFUL_PRANKSTER.oracleId,
  name: SPITEFUL_PRANKSTER.name,
  triggers: [
    {
      ...
      label: () => "Spiteful Prankster - damageTarget",
