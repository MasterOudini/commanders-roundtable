// `Torment` - an Aura (Enchant creature): the enchanted creature gets -3/+0.
...
import { TORMENT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TORMENT, "Enchant creature\nEnchanted creature gets -3/-0.");
const LINES = PRINTED.split('\n');

export const TORMENT_SCRIPT: CardScript = {
  oracleId: TORMENT.oracleId,
  name: TORMENT.name,
  statics: [
    {
