// `Fire Urchin` - a castInstantSorcery trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FIRE_URCHIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FIRE_URCHIN, "Trample\nWhenever you cast an instant or sorcery spell, this creature gets +1/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const FIRE_URCHIN_SCRIPT: CardScript = {
  oracleId: FIRE_URCHIN.oracleId,
  name: FIRE_URCHIN.name,
  triggers: [
    {
      ...
      label: () => "Fire Urchin - it pumped until end of turn",
