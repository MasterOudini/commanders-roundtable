// `Immolation` - an Aura (Enchant creature): the enchanted creature gets +2/-2.
...
import { IMMOLATION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(IMMOLATION, "Enchant creature\nEnchanted creature gets +2/-2.");
const LINES = PRINTED.split('\n');

export const IMMOLATION_SCRIPT: CardScript = {
  oracleId: IMMOLATION.oracleId,
