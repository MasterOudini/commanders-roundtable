// `H.E.R.B.I.E., Lovable Robot` - every printed ability proven in its own game: the cost's mark, the pump
...
import { H_ERBIELOVABLE_ROBOT_SCRIPT } from './hERBIELovableRobot';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "H.E.R.B.I.E., Lovable Robot";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["H.E.R.B.I.E., Lovable Robot", "Divination"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([H_ERBIELOVABLE_ROBOT_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("H.E.R.B.I.E., Lovable Robot", () => {
  test("At the beginning of combat on your turn: surveil 1 asks, and the cards stay on top", () => {
