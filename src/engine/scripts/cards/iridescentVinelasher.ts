// `Iridescent Vinelasher` - a landfall trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { IRIDESCENT_VINELASHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(IRIDESCENT_VINELASHER, "Offspring {2} (You may pay an additional {2} as you cast this spell. If you do, when this creature enters, create a 1/1 token copy of it.)\nLandfall — Whenever a land you control enters, this creature deals 1 damage to target opponent.");
const LINES = PRINTED.split('\n');

export const IRIDESCENT_VINELASHER_SCRIPT: CardScript = {
  oracleId: IRIDESCENT_VINELASHER.oracleId,
  name: IRIDESCENT_VINELASHER.name,
  triggers: [
    {
      ...
      label: () => "Iridescent Vinelasher - damageTarget",
