// `Akiri, Line-Slinger` - a static pumpPer
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AKIRI_LINE_SLINGER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AKIRI_LINE_SLINGER, "First strike, vigilance\nAkiri gets +1/+0 for each artifact you control.\nPartner (You can have two commanders if both have partner.)");
...
export const AKIRI_LINE_SLINGER_SCRIPT: CardScript = {
  oracleId: AKIRI_LINE_SLINGER.oracleId,
  name: AKIRI_LINE_SLINGER.name,
  statics: [
    {
