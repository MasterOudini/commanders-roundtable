// `Tempered Steel` - a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TEMPERED_STEEL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TEMPERED_STEEL, "Artifact creatures you control get +2/+2.");

export const TEMPERED_STEEL_SCRIPT: CardScript = {
  oracleId: TEMPERED_STEEL.oracleId,
  name: TEMPERED_STEEL.name,
  statics: [
    {
