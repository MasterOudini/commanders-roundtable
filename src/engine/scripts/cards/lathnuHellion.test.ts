// `Lathnu Hellion` - every printed ability proven in its own game: the cost's mark, the pump
...
import { LATHNU_HELLION_SCRIPT } from './lathnuHellion';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Lathnu Hellion";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Lathnu Hellion"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([LATHNU_HELLION_SCRIPT]),
...
describe("Lathnu Hellion", () => {
  ...
  test("At the beginning of your end step: the vocabulary resolves \"Sacrifice this creature unless you pay {E}{E}.\" - the price is declined", () => {
  ...
  test("At the beginning of your end step: the vocabulary resolves \"Sacrifice this creature unless you pay {E}{E}.\" - the price is paid", () => {
