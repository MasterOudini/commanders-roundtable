// `Flayed One` - a etb trigger mill
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FLAYED_ONE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLAYED_ONE, "Lifelink\nFlesh Flayer — When this creature enters, mill three cards.");
const LINES = PRINTED.split('\n');

export const FLAYED_ONE_SCRIPT: CardScript = {
  oracleId: FLAYED_ONE.oracleId,
  name: FLAYED_ONE.name,
  triggers: [
    {
      abilityId: 'etb-1',
