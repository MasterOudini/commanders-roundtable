// `Vulshok Morningstar` - an Equipment: the equipped creature gets +2/+2.
...
import { VULSHOK_MORNINGSTAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VULSHOK_MORNINGSTAR, "Equipped creature gets +2/+2.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const VULSHOK_MORNINGSTAR_SCRIPT: CardScript = {
  oracleId: VULSHOK_MORNINGSTAR.oracleId,
  name: VULSHOK_MORNINGSTAR.name,
  statics: [
    {
