// `Flailing Drake` - a blocksOrBecomesBlocked trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FLAILING_DRAKE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLAILING_DRAKE, "Flying\nWhenever this creature blocks or becomes blocked by a creature, that creature gets +1/+1 until end of turn.");
const LINES = PRINTED.split('\n');

const VOCAB_L1 = vocabularyEffects("Target creature gets +1/+1 until end of turn.", FLAILING_DRAKE.name);
const VOCAB_T_L1 = vocabularyTargets("Target creature gets +1/+1 until end of turn.");

export const FLAILING_DRAKE_SCRIPT: CardScript = {
  oracleId: FLAILING_DRAKE.oracleId,
  name: FLAILING_DRAKE.name,
  triggers: [
    {
      ...
      label: () => "Flailing Drake - Target creature gets +1/+1 until end of turn.",
