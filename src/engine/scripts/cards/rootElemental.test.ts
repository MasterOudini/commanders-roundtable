// `Root Elemental` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Root Elemental", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ROOT_ELEMENTAL_SCRIPT]),
...
describe("Root Elemental", () => {
  test("When this creature is turned face up: the vocabulary resolves \"Put a creature card from your hand onto the battlefield.\"", () => {
