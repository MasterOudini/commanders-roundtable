// `Ruin Crab` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ruin Crab"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RUIN_CRAB_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Ruin Crab", () => {
  test("Landfall — Whenever a land you control enters: the vocabulary resolves \"Each opponent mills three cards.\"", () => {
