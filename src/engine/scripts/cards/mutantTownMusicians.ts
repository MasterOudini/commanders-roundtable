// `Mutant Town Musicians` - a anotherCreatureEnters trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MUTANT_TOWN_MUSICIANS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MUTANT_TOWN_MUSICIANS, "Trample\nAlliance — Whenever another creature you control enters, this creature gets +1/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const MUTANT_TOWN_MUSICIANS_SCRIPT: CardScript = {
  oracleId: MUTANT_TOWN_MUSICIANS.oracleId,
  name: MUTANT_TOWN_MUSICIANS.name,
  triggers: [
    {
      ...
      label: () => "Mutant Town Musicians - it pumped until end of turn",
