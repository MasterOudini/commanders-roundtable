// `Cinder Pyromancer` - an activation damageTarget, a castSpell trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CINDER_PYROMANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CINDER_PYROMANCER, "{T}: This creature deals 1 damage to target player or planeswalker.\nWhenever you cast a red spell, you may untap this creature.");
const LINES = PRINTED.split('\n');

export const CINDER_PYROMANCER_SCRIPT: CardScript = {
  oracleId: CINDER_PYROMANCER.oracleId,
  name: CINDER_PYROMANCER.name,
  activated: [
    {
      ref: `${CINDER_PYROMANCER.oracleId}#a0`,
  ...
  triggers: [
    {
      ...
      label: () => "Cinder Pyromancer - untapSelf",
