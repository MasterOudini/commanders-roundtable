// `Scarblade Scout` - a etb trigger mill
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SCARBLADE_SCOUT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SCARBLADE_SCOUT, "Lifelink\nWhen this creature enters, mill two cards. (Put the top two cards of your library into your graveyard.)");
const LINES = PRINTED.split('\n');

export const SCARBLADE_SCOUT_SCRIPT: CardScript = {
  oracleId: SCARBLADE_SCOUT.oracleId,
  name: SCARBLADE_SCOUT.name,
  triggers: [
    {
      abilityId: 'etb-1',
