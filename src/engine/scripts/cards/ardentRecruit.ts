// `Ardent Recruit` - a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ARDENT_RECRUIT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ARDENT_RECRUIT, "Metalcraft — This creature gets +2/+2 as long as you control three or more artifacts.");
...
export const ARDENT_RECRUIT_SCRIPT: CardScript = {
  oracleId: ARDENT_RECRUIT.oracleId,
  name: ARDENT_RECRUIT.name,
  statics: [
    {
