// `Gates of Istfell` - every printed ability proven in its own game: the cost's mark, the pump
...
import { GATES_OF_ISTFELL_SCRIPT } from './gatesOfIstfell';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Gates of Istfell";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Gates of Istfell"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([GATES_OF_ISTFELL_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Gates of Istfell", () => {
  test("{2}{W}{U}{U}, {T}, Sacrifice this land: the vocabulary resolves \"You gain 2 life and draw two cards.\"", () => {
