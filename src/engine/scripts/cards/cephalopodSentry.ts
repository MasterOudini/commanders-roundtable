// `Cephalopod Sentry` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CEPHALOPOD_SENTRY } from '../../../data/fixtures/engineCards';
...
export const CEPHALOPOD_SENTRY_SCRIPT: CardScript = {
  oracleId: CEPHALOPOD_SENTRY.oracleId,
  name: CEPHALOPOD_SENTRY.name,
  statics: [
    {
      abilityId: 'cda-1',
