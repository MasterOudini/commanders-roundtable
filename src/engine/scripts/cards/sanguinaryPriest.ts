// `Sanguinary Priest` - a anotherCreatureDies trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SANGUINARY_PRIEST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SANGUINARY_PRIEST, "Lifelink\nBlood Chalice — Whenever another creature you control dies, this creature deals 1 damage to any target.");
const LINES = PRINTED.split('\n');

export const SANGUINARY_PRIEST_SCRIPT: CardScript = {
  oracleId: SANGUINARY_PRIEST.oracleId,
  name: SANGUINARY_PRIEST.name,
  triggers: [
    {
      ...
      label: () => "Sanguinary Priest - damageTarget",
