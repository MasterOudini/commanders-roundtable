// `Haunted Cloak` - an Equipment: the equipped creature has vigilance, trample, haste.
...
import { HAUNTED_CLOAK } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HAUNTED_CLOAK, "Equipped creature has vigilance, trample, and haste.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const HAUNTED_CLOAK_SCRIPT: CardScript = {
  oracleId: HAUNTED_CLOAK.oracleId,
  name: HAUNTED_CLOAK.name,
  statics: [
    {
