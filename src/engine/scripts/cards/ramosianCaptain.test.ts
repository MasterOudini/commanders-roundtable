// `Ramosian Captain` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ramosian Captain", "Children of Korlis"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RAMOSIAN_CAPTAIN_SCRIPT]),
...
describe("Ramosian Captain", () => {
  test("{5}, {T}: the vocabulary resolves \"Search your library for a Rebel permanent card with mana value 4 or less, put it onto the battlefield, then shuffle.\"", () => {
