// `Ominous Parcel` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ominous Parcel", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([OMINOUS_PARCEL_SCRIPT]),
...
describe("Ominous Parcel", () => {
  ...
  test("{5}, {T}, Sacrifice this artifact: it deals 4 damage to the declared creature", () => {
