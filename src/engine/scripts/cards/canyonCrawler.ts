// `Canyon Crawler` - a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CANYON_CRAWLER } from '../../../data/fixtures/engineCards';
