// `Nylea's Forerunner` - a layer-6 grant: "Other creatures you control have trample". A StaticDef in the shape of the
...
import { NYLEA_S_FORERUNNER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NYLEA_S_FORERUNNER, "Trample\nOther creatures you control have trample.");
const TEXT = PRINTED.split('\n')[1] as string;

export const NYLEAS_FORERUNNER_SCRIPT: CardScript = {
  oracleId: NYLEA_S_FORERUNNER.oracleId,
  name: NYLEA_S_FORERUNNER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
