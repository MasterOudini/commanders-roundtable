// `Tunneling Geopede` - a landfall trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TUNNELING_GEOPEDE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TUNNELING_GEOPEDE, "Landfall — Whenever a land you control enters, this creature deals 1 damage to each opponent.");

export const TUNNELING_GEOPEDE_SCRIPT: CardScript = {
  oracleId: TUNNELING_GEOPEDE.oracleId,
  name: TUNNELING_GEOPEDE.name,
  triggers: [
    {
      ...
      label: () => "Tunneling Geopede - damageOpponents",
