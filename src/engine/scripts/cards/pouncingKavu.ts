// `Pouncing Kavu` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { POUNCING_KAVU } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(POUNCING_KAVU, "Kicker {2}{R} (You may pay an additional {2}{R} as you cast this spell.)\nFirst strike\nIf this creature was kicked, it enters with two +1/+1 counters on it and with haste.");
const LINES = PRINTED.split('\n');


export const POUNCING_KAVU_SCRIPT: CardScript = {
  oracleId: POUNCING_KAVU.oracleId,
  name: POUNCING_KAVU.name,
  replacements: [
    {
