// `Knight's Pledge` - an Aura (Enchant creature): the enchanted creature gets +2/+2.
...
import { KNIGHT_S_PLEDGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KNIGHT_S_PLEDGE, "Enchant creature\nEnchanted creature gets +2/+2.");
const LINES = PRINTED.split('\n');

export const KNIGHTS_PLEDGE_SCRIPT: CardScript = {
  oracleId: KNIGHT_S_PLEDGE.oracleId,
  name: KNIGHT_S_PLEDGE.name,
  statics: [
    {
