// `Airdrop Aeronauts` - a etb trigger gainLife
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AIRDROP_AERONAUTS } from '../../../data/fixtures/engineCards';
...
export const AIRDROP_AERONAUTS_SCRIPT: CardScript = {
  oracleId: AIRDROP_AERONAUTS.oracleId,
  name: AIRDROP_AERONAUTS.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Airdrop Aeronauts - gain life",
