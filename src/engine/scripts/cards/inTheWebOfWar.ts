// `In the Web of War` - a creatureEnters trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { IN_THE_WEB_OF_WAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(IN_THE_WEB_OF_WAR, "Whenever a creature you control enters, it gets +2/+0 and gains haste until end of turn.");

const VOCAB_L0 = vocabularyEffects("Target creature gets +2/+0 and gains haste until end of turn.", IN_THE_WEB_OF_WAR.name);
const VOCAB_T_L0 = vocabularyTargets("Target creature gets +2/+0 and gains haste until end of turn.");

export const IN_THE_WEB_OF_WAR_SCRIPT: CardScript = {
  oracleId: IN_THE_WEB_OF_WAR.oracleId,
  name: IN_THE_WEB_OF_WAR.name,
  triggers: [
    {
      ...
      label: () => "In the Web of War - Target creature gets +2/+0 and gains haste until end of turn.",
