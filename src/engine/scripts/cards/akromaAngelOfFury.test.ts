// `Akroma, Angel of Fury` - every printed ability proven in its own game: the cost's mark, the pump
...
import { AKROMA_ANGEL_OF_FURY_SCRIPT } from './akromaAngelOfFury';
import { advanceUntil, deps, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import { derive } from '../../derive';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Akroma, Angel of Fury";
...
function pt(g: Game, id: InstanceId): [number | null, number | null] {
  const d = deps(createRegistry([AKROMA_ANGEL_OF_FURY_SCRIPT]));
