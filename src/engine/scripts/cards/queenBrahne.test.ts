// `Queen Brahne` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Queen Brahne"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([QUEEN_BRAHNE_SCRIPT, WIZARD_TOKEN04AE24BF_SCRIPT]),
...
describe("Queen Brahne", () => {
  test("Whenever Queen Brahne attacks: the vocabulary resolves \"Create a 0/1 black Wizard creature token with \\\"Whenever you cast a noncreature spell, this token deals 1 damage to each opponent.\\\"\"", () => {
