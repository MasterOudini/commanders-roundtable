// `War Horn` - a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WAR_HORN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WAR_HORN, "Attacking creatures you control get +1/+0.");

export const WAR_HORN_SCRIPT: CardScript = {
  oracleId: WAR_HORN.oracleId,
  name: WAR_HORN.name,
  statics: [
    {
