// `Vulshok Battlegear` - an Equipment: the equipped creature gets +3/+3.
...
import { VULSHOK_BATTLEGEAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(VULSHOK_BATTLEGEAR, "Equipped creature gets +3/+3.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const VULSHOK_BATTLEGEAR_SCRIPT: CardScript = {
  oracleId: VULSHOK_BATTLEGEAR.oracleId,
  name: VULSHOK_BATTLEGEAR.name,
  statics: [
    {
