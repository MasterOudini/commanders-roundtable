// `Sea Monster` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SEA_MONSTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SEA_MONSTER, "This creature can't attack unless defending player controls an Island.");
...
export const SEA_MONSTER_SCRIPT: CardScript = {
  oracleId: SEA_MONSTER.oracleId,
  name: SEA_MONSTER.name,
  combat: [
    {
