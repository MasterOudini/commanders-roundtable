// `Gaea's Anthem` - a layer-6 anthem: "Creatures you control get +1/+1". A StaticDef in the shape of the
...
import { GAEA_S_ANTHEM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GAEA_S_ANTHEM, "Creatures you control get +1/+1.");
const TEXT = PRINTED;

export const GAEAS_ANTHEM_SCRIPT: CardScript = {
  oracleId: GAEA_S_ANTHEM.oracleId,
  name: GAEA_S_ANTHEM.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
