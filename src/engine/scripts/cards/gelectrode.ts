// `Gelectrode` - an activation damageTarget, a castInstantSorcery trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GELECTRODE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GELECTRODE, "{T}: This creature deals 1 damage to any target.\nWhenever you cast an instant or sorcery spell, you may untap this creature.");
const LINES = PRINTED.split('\n');

export const GELECTRODE_SCRIPT: CardScript = {
  oracleId: GELECTRODE.oracleId,
  name: GELECTRODE.name,
  activated: [
    {
      ref: `${GELECTRODE.oracleId}#a0`,
