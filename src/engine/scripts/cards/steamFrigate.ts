// `Steam Frigate` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STEAM_FRIGATE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STEAM_FRIGATE, "This creature can't attack unless defending player controls an Island.");
...
export const STEAM_FRIGATE_SCRIPT: CardScript = {
  oracleId: STEAM_FRIGATE.oracleId,
  name: STEAM_FRIGATE.name,
  combat: [
    {
