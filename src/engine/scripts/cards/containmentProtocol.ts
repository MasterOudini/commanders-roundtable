// `Containment Protocol` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CONTAINMENT_PROTOCOL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CONTAINMENT_PROTOCOL, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const CONTAINMENT_PROTOCOL_SCRIPT: CardScript = {
  oracleId: CONTAINMENT_PROTOCOL.oracleId,
  name: CONTAINMENT_PROTOCOL.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Containment Protocol - tapAttached",
