// `Terrain Generator` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Terrain Generator", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([TERRAIN_GENERATOR_SCRIPT]),
...
describe("Terrain Generator", () => {
  test("{2}, {T}: the vocabulary resolves \"You may put a basic land card from your hand onto the battlefield tapped.\"", () => {
