// `Sever Soul` - a scripted spell: the target clause is the parser's and the validator's
// (D294's adjectives), the rider is this script's. Generated from one table row (D295).

import { SEVER_SOUL } from '../../../data/fixtures/engineCards';
...
const TEXT = printed(SEVER_SOUL, "Destroy target nonblack creature. It can't be regenerated. You gain life equal to its toughness.");

export const SEVER_SOUL_SCRIPT: CardScript = {
  oracleId: SEVER_SOUL.oracleId,
  name: SEVER_SOUL.name,
  spell: {
    text: TEXT,
