// `Hardened-Scale Armor` - an Aura (Enchant creature): the enchanted creature gets +3/+3.
...
import { HARDENED_SCALE_ARMOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HARDENED_SCALE_ARMOR, "Enchant creature\nEnchanted creature gets +3/+3.");
const LINES = PRINTED.split('\n');

export const HARDENED_SCALE_ARMOR_SCRIPT: CardScript = {
  oracleId: HARDENED_SCALE_ARMOR.oracleId,
  name: HARDENED_SCALE_ARMOR.name,
  statics: [
    {
