// `Electrostatic Field` - a castInstantSorcery trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ELECTROSTATIC_FIELD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ELECTROSTATIC_FIELD, "Defender\nWhenever you cast an instant or sorcery spell, this creature deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const ELECTROSTATIC_FIELD_SCRIPT: CardScript = {
  oracleId: ELECTROSTATIC_FIELD.oracleId,
  name: ELECTROSTATIC_FIELD.name,
  triggers: [
    {
      ...
      label: () => "Electrostatic Field - damageOpponents",
