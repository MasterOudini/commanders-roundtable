// `Mercurial Geists` - a castInstantSorcery trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MERCURIAL_GEISTS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MERCURIAL_GEISTS, "Flying\nWhenever you cast an instant or sorcery spell, this creature gets +3/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const MERCURIAL_GEISTS_SCRIPT: CardScript = {
  oracleId: MERCURIAL_GEISTS.oracleId,
  name: MERCURIAL_GEISTS.name,
  triggers: [
    {
      ...
      label: () => "Mercurial Geists - it pumped until end of turn",
