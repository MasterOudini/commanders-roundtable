// `Aether Figment` - a static entersWithCounters, a static cantBeBlocked
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AETHER_FIGMENT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AETHER_FIGMENT, "Kicker {3} (You may pay an additional {3} as you cast this spell.)\nIf this creature was kicked, it enters with two +1/+1 counters on it.\nThis creature can't be blocked.");
const LINES = PRINTED.split('\n');


export const AETHER_FIGMENT_SCRIPT: CardScript = {
  oracleId: AETHER_FIGMENT.oracleId,
  name: AETHER_FIGMENT.name,
  combat: [
    {
