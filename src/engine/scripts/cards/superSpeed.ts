// `Super Speed` - a etb trigger attachedTemp, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SUPER_SPEED } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SUPER_SPEED, "Flash\nEnchant creature\nWhen this Aura enters, enchanted creature gains first strike until end of turn.\nEnchanted creature gets +1/+0 and has haste.");
const LINES = PRINTED.split('\n');

export const SUPER_SPEED_SCRIPT: CardScript = {
  oracleId: SUPER_SPEED.oracleId,
  name: SUPER_SPEED.name,
  triggers: [
    {
      abilityId: 'etb-2',
      ...
      label: () => "Super Speed - attachedTemp",
