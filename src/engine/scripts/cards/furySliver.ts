// `Fury Sliver` - a layer-6 grant: "All Sliver creatures have double strike". A StaticDef in the shape of the
...
import { FURY_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FURY_SLIVER, "All Sliver creatures have double strike.");
const TEXT = PRINTED;

export const FURY_SLIVER_SCRIPT: CardScript = {
  oracleId: FURY_SLIVER.oracleId,
  name: FURY_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
