// `Levitation` - a layer-6 grant: "Creatures you control have flying". A StaticDef in the shape of the
...
import { LEVITATION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LEVITATION, "Creatures you control have flying.");
const TEXT = PRINTED;
