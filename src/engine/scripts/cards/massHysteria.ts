// `Mass Hysteria` - a layer-6 grant: "All creatures have haste". A StaticDef in the shape of the
...
import { MASS_HYSTERIA } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MASS_HYSTERIA, "All creatures have haste.");
const TEXT = PRINTED;

export const MASS_HYSTERIA_SCRIPT: CardScript = {
  oracleId: MASS_HYSTERIA.oracleId,
  name: MASS_HYSTERIA.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
