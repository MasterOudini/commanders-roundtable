// `Quicksilver Behemoth` - every printed ability proven in its own game: the cost's mark, the pump
...
import { QUICKSILVER_BEHEMOTH_SCRIPT } from './quicksilverBehemoth';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Quicksilver Behemoth";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Quicksilver Behemoth"], ["Cyclops of One-Eyed Pass", "Grizzly Bears"]],
    scripts: createRegistry([QUICKSILVER_BEHEMOTH_SCRIPT]),
