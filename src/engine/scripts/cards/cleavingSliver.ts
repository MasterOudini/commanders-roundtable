// `Cleaving Sliver` - a layer-6 anthem: "Sliver creatures you control get +2/+0". A StaticDef in the shape of the
...
import { CLEAVING_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CLEAVING_SLIVER, "Sliver creatures you control get +2/+0.");
const TEXT = PRINTED;

export const CLEAVING_SLIVER_SCRIPT: CardScript = {
  oracleId: CLEAVING_SLIVER.oracleId,
  name: CLEAVING_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
