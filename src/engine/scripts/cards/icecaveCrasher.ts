// `Icecave Crasher` - a landfall trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ICECAVE_CRASHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ICECAVE_CRASHER, "Trample\nLandfall — Whenever a land you control enters, this creature gets +1/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const ICECAVE_CRASHER_SCRIPT: CardScript = {
  oracleId: ICECAVE_CRASHER.oracleId,
  name: ICECAVE_CRASHER.name,
  triggers: [
    {
      ...
      label: () => "Icecave Crasher - it pumped until end of turn",
