// `Clinging Darkness` - an Aura (Enchant creature): the enchanted creature gets -4/-1.
...
import { CLINGING_DARKNESS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CLINGING_DARKNESS, "Enchant creature\nEnchanted creature gets -4/-1.");
const LINES = PRINTED.split('\n');

export const CLINGING_DARKNESS_SCRIPT: CardScript = {
  oracleId: CLINGING_DARKNESS.oracleId,
  name: CLINGING_DARKNESS.name,
  statics: [
    {
