// `Gravblade Heavy` - a conditional static (as long as you control an artifact) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GRAVBLADE_HEAVY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GRAVBLADE_HEAVY, "As long as you control an artifact, this creature gets +1/+0 and has deathtouch.");
...
export const GRAVBLADE_HEAVY_SCRIPT: CardScript = {
  oracleId: GRAVBLADE_HEAVY.oracleId,
  name: GRAVBLADE_HEAVY.name,
  statics: [
    {
