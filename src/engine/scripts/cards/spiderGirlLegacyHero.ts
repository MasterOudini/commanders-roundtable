// `Spider-Girl, Legacy Hero` - a conditional static (as long as it's your turn) threshold, a leavesBattlefield trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPIDER_GIRL_LEGACY_HERO } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPIDER_GIRL_LEGACY_HERO, "During your turn, Spider-Girl has flying.\nWhen Spider-Girl leaves the battlefield, create a 1/1 green and white Human Citizen creature token.");
const LINES = PRINTED.split('\n');
const TOKEN_L1 = tokenRef("Human Citizen|1/1|GW|Creature|");
...
export const SPIDER_GIRL_LEGACY_HERO_SCRIPT: CardScript = {
  oracleId: SPIDER_GIRL_LEGACY_HERO.oracleId,
  name: SPIDER_GIRL_LEGACY_HERO.name,
  triggers: [
    {
      ...
      label: () => "Spider-Girl, Legacy Hero - token",
