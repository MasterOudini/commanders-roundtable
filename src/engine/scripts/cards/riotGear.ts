// `Riot Gear` - an Equipment: the equipped creature gets +1/+2.
...
import { RIOT_GEAR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(RIOT_GEAR, "Equipped creature gets +1/+2.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const RIOT_GEAR_SCRIPT: CardScript = {
  oracleId: RIOT_GEAR.oracleId,
  name: RIOT_GEAR.name,
  statics: [
    {
