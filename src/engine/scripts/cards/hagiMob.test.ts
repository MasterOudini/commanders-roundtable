// `Hagi Mob` - every printed ability proven in its own game: the cost's mark, the pump
...
import { HAGI_MOB_SCRIPT } from './hagiMob';
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Hagi Mob", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([HAGI_MOB_SCRIPT]),
...
describe("Hagi Mob", () => {
  test("Boast — {1}{R}: it deals 1 damage to the declared creature - refused unless this creature attacked this turn", () => {
