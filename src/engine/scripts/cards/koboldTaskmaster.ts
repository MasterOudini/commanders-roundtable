// `Kobold Taskmaster` - a layer-6 anthem: "Other Kobold creatures you control get +1/+0". A StaticDef in the shape of the
...
import { KOBOLD_TASKMASTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KOBOLD_TASKMASTER, "Other Kobold creatures you control get +1/+0.");
const TEXT = PRINTED;

export const KOBOLD_TASKMASTER_SCRIPT: CardScript = {
  oracleId: KOBOLD_TASKMASTER.oracleId,
  name: KOBOLD_TASKMASTER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
