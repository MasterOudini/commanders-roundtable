// `Gnarlwood Dryad` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GNARLWOOD_DRYAD } from '../../../data/fixtures/engineCards';
...
export const GNARLWOOD_DRYAD_SCRIPT: CardScript = {
  oracleId: GNARLWOOD_DRYAD.oracleId,
  name: GNARLWOOD_DRYAD.name,
  statics: [
    {
