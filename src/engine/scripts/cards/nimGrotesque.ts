// `Nim Grotesque` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { NIM_GROTESQUE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIM_GROTESQUE, "This creature gets +1/+0 for each artifact you control.");
...
export const NIM_GROTESQUE_SCRIPT: CardScript = {
  oracleId: NIM_GROTESQUE.oracleId,
  name: NIM_GROTESQUE.name,
  statics: [
    {
      abilityId: 'pump-0',
