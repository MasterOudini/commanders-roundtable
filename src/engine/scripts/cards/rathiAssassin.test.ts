// `Rathi Assassin` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Rathi Assassin", "Rampart Crawler"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RATHI_ASSASSIN_SCRIPT]),
...
describe("Rathi Assassin", () => {
  test("{1}{B}{B}, {T}: the vocabulary resolves \"Destroy target tapped nonblack creature.\"", () => {
