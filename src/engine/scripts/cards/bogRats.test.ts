// `Bog Rats` - every printed ability proven in its own game: the cost's mark, the pump
...
import { BOG_RATS_SCRIPT } from './bogRats';
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Bog Rats", "Grizzly Bears"], ["Cyclops of One-Eyed Pass", "Steel Wall"]],
    scripts: createRegistry([BOG_RATS_SCRIPT]),
