// `Deathgrip` - counter on "Counter target green spell": the adjective is the parser's and the
// validator's (D294). Generated from one table row (D295).

import { DEATHGRIP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DEATHGRIP, "{B}{B}: Counter target green spell.");
const TEXT = PRINTED;

export const DEATHGRIP_SCRIPT: CardScript = {
  oracleId: DEATHGRIP.oracleId,
  name: DEATHGRIP.name,
  activated: [
    {
      ref: `${DEATHGRIP.oracleId}#a0`,
      text: TEXT,
