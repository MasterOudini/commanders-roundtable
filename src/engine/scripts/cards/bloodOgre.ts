// `Blood Ogre` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLOOD_OGRE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLOOD_OGRE, "Bloodthirst 1 (If an opponent was dealt damage this turn, this creature enters with a +1/+1 counter on it.)\nFirst strike (This creature deals combat damage before creatures without first strike.)");
...
export const BLOOD_OGRE_SCRIPT: CardScript = {
  oracleId: BLOOD_OGRE.oracleId,
  name: BLOOD_OGRE.name,
  replacements: [
    {
