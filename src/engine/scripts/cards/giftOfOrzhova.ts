// `Gift of Orzhova` - an Aura (Enchant creature): the enchanted creature gets +1/+1 and has flying, lifelink.
...
import { GIFT_OF_ORZHOVA } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GIFT_OF_ORZHOVA, "Enchant creature\nEnchanted creature gets +1/+1 and has flying and lifelink.");
const LINES = PRINTED.split('\n');

export const GIFT_OF_ORZHOVA_SCRIPT: CardScript = {
  oracleId: GIFT_OF_ORZHOVA.oracleId,
  name: GIFT_OF_ORZHOVA.name,
  statics: [
    {
