// `Mob Justice` — "Mob Justice deals damage to target player or planeswalker
...
export const MOB_JUSTICE_SCRIPT: CardScript = {
  oracleId: MOB_JUSTICE.oracleId,
  name: MOB_JUSTICE.name,
  spell: {
    text: TEXT,
