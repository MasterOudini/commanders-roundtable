// `Firebrand Ranger` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Firebrand Ranger", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([FIREBRAND_RANGER_SCRIPT]),
...
describe("Firebrand Ranger", () => {
  test("{G}, {T}: the vocabulary resolves \"You may put a basic land card from your hand onto the battlefield.\"", () => {
