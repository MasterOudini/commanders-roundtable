// `Jinxed Ring` - every printed ability proven in its own game: the cost's mark, the pump
...
import { JINXED_RING_SCRIPT } from './jinxedRing';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Jinxed Ring";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Jinxed Ring", "Grizzly Bears", "Badlands"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([JINXED_RING_SCRIPT]),
...
describe("Jinxed Ring", () => {
  test("Whenever a nontoken permanent is put into your graveyard from the battlefield: the vocabulary resolves \"This artifact deals 1 damage to you.\"", () => {
