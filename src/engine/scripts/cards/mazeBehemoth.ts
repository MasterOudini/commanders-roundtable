// `Maze Behemoth` - a layer-6 grant: "Multicolored creatures you control have trample". A StaticDef in the shape of the
...
import { MAZE_BEHEMOTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAZE_BEHEMOTH, "Trample\nMulticolored creatures you control have trample.");
const TEXT = PRINTED.split('\n')[1] as string;

export const MAZE_BEHEMOTH_SCRIPT: CardScript = {
  oracleId: MAZE_BEHEMOTH.oracleId,
  name: MAZE_BEHEMOTH.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
