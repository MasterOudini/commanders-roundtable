// `Juniper Order Druid` — the tap straightens a chosen tapped land.

import { describe, expect, test } from 'vitest';
import { replay, stateHash } from '../../log';
import { createRegistry } from '../registry';
import { JUNIPER_ORDER_DRUID_SCRIPT } from './juniperOrderDruid';
import { advanceUntil, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const DRUID = 'Juniper Order Druid';
const FOREST = 'Forest';
...
function answered(): { g: Game; forest: InstanceId } {
  const g = startedGame({
    players: 2,
    decks: [[DRUID, FOREST], []],
    scripts: createRegistry([JUNIPER_ORDER_DRUID_SCRIPT]),
  });
