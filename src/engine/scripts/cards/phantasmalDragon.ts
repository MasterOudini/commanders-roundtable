// `Phantasmal Dragon` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PHANTASMAL_DRAGON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PHANTASMAL_DRAGON, "Flying\nWhen this creature becomes the target of a spell or ability, sacrifice it.");
const LINES = PRINTED.split('\n');

export const PHANTASMAL_DRAGON_SCRIPT: CardScript = {
  oracleId: PHANTASMAL_DRAGON.oracleId,
  name: PHANTASMAL_DRAGON.name,
  triggers: [
    {
      ...
      label: () => "Phantasmal Dragon - sacrificeSelf",
