// `Maze Sentinel` - a layer-6 grant: "Multicolored creatures you control have vigilance". A StaticDef in the shape of the
...
import { MAZE_SENTINEL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MAZE_SENTINEL, "Vigilance\nMulticolored creatures you control have vigilance.");
const TEXT = PRINTED.split('\n')[1] as string;

export const MAZE_SENTINEL_SCRIPT: CardScript = {
  oracleId: MAZE_SENTINEL.oracleId,
  name: MAZE_SENTINEL.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
