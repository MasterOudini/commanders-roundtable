// `Minwu, White Mage` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MINWU_WHITE_MAGE_SCRIPT } from './minwuWhiteMage';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Minwu, White Mage";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Minwu, White Mage", "Cabal Evangel"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MINWU_WHITE_MAGE_SCRIPT]),
...
describe("Minwu, White Mage", () => {
  test("Whenever you gain life: each of its controller's creatures gets 1 +1/+1 counter", () => {
