// `Foul Play` — "Destroy target creature with power 2 or less.
// Investigate." D139's numeric ceiling at the aim; the Clue is the
// CASTER's (a plain "Investigate" belongs to the spell's controller).
// D214.
...
export const FOUL_PLAY_SCRIPT: CardScript = {
  oracleId: FOUL_PLAY.oracleId,
  name: FOUL_PLAY.name,
  spell: {
    text: TEXT,
