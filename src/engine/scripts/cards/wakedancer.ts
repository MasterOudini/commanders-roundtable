// `Wakedancer` - a etb trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WAKEDANCER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WAKEDANCER, "Morbid — When this creature enters, if a creature died this turn, create a 2/2 black Zombie creature token.");
...
export const WAKEDANCER_SCRIPT: CardScript = {
  oracleId: WAKEDANCER.oracleId,
  name: WAKEDANCER.name,
  triggers: [
    {
      abilityId: 'etb-0',
      text: PRINTED,
