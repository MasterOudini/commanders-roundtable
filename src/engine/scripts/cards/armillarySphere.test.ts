// `Armillary Sphere` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Armillary Sphere", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ARMILLARY_SPHERE_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Armillary Sphere", () => {
  test("{2}, {T}, Sacrifice this artifact: the vocabulary resolves \"Search your library for up to two basic land cards, reveal them, put them into your hand, then shuffle.\"", () => {
