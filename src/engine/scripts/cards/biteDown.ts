...
// to target creature or planeswalker you don't control." The one-way bite:
// Ambuscade minus the pump, with the biter's own derived riders. D200.
...
export const BITE_DOWN_SCRIPT: CardScript = {
  oracleId: BITE_DOWN.oracleId,
  name: BITE_DOWN.name,
  spell: {
    text: TEXT,
