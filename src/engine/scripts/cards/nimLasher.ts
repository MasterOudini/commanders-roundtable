// `Nim Lasher` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { NIM_LASHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIM_LASHER, "This creature gets +1/+0 for each artifact you control.");
...
export const NIM_LASHER_SCRIPT: CardScript = {
  oracleId: NIM_LASHER.oracleId,
  name: NIM_LASHER.name,
  statics: [
    {
      abilityId: 'pump-0',
