// `Pennon Blade` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { PENNON_BLADE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PENNON_BLADE, "Equipped creature gets +1/+1 for each creature you control.\nEquip {4} ({4}: Attach to target creature you control. Equip only as a sorcery.)");
...
export const PENNON_BLADE_SCRIPT: CardScript = {
  oracleId: PENNON_BLADE.oracleId,
  name: PENNON_BLADE.name,
  statics: [
    {
      abilityId: 'pump-0',
