// `Heart Sliver` - a layer-6 grant: "All Sliver creatures have haste". A StaticDef in the shape of the
...
import { HEART_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HEART_SLIVER, "All Sliver creatures have haste.");
const TEXT = PRINTED;

export const HEART_SLIVER_SCRIPT: CardScript = {
  oracleId: HEART_SLIVER.oracleId,
  name: HEART_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
