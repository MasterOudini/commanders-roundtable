// `Battlewise Aven` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BATTLEWISE_AVEN } from '../../../data/fixtures/engineCards';
...
export const BATTLEWISE_AVEN_SCRIPT: CardScript = {
  oracleId: BATTLEWISE_AVEN.oracleId,
  name: BATTLEWISE_AVEN.name,
  statics: [
    {
