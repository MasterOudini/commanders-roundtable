// `Enchanted Being` - a CONTINUOUS prevention effect (CR 615, D385): a `PreventionDef` the
...
import { ENCHANTED_BEING } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ENCHANTED_BEING, "Prevent all combat damage that would be dealt to this creature by enchanted creatures.");

export const ENCHANTED_BEING_SCRIPT: CardScript = {
  oracleId: ENCHANTED_BEING.oracleId,
  name: ENCHANTED_BEING.name,
  prevention: [
    {
      abilityId: 'prevent-0',
      text: PRINTED,
