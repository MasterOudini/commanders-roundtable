// `Goblin Gaveleer` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { GOBLIN_GAVELEER } from '../../../data/fixtures/engineCards';
...
export const GOBLIN_GAVELEER_SCRIPT: CardScript = {
  oracleId: GOBLIN_GAVELEER.oracleId,
  name: GOBLIN_GAVELEER.name,
  statics: [
    {
      abilityId: 'pump-1',
