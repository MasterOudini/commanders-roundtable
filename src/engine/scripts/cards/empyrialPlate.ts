// `Empyrial Plate` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { EMPYRIAL_PLATE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(EMPYRIAL_PLATE, "Equipped creature gets +1/+1 for each card in your hand.\nEquip {2}");
...
export const EMPYRIAL_PLATE_SCRIPT: CardScript = {
  oracleId: EMPYRIAL_PLATE.oracleId,
  name: EMPYRIAL_PLATE.name,
  statics: [
    {
      abilityId: 'pump-0',
