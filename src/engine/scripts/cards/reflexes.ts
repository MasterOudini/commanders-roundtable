// `Reflexes` - an Aura (Enchant creature): the enchanted creature has firstStrike.
...
import { REFLEXES } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(REFLEXES, "Enchant creature (Target a creature as you cast this. This card enters attached to that creature.)\nEnchanted creature has first strike. (It deals combat damage before creatures without first strike.)");
const LINES = PRINTED.split('\n');

export const REFLEXES_SCRIPT: CardScript = {
  oracleId: REFLEXES.oracleId,
  name: REFLEXES.name,
  statics: [
    {
