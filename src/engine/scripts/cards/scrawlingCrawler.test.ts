// `Scrawling Crawler` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SCRAWLING_CRAWLER_SCRIPT } from './scrawlingCrawler';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Scrawling Crawler";
...
describe("Scrawling Crawler", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Each player draws a card.\"", () => {
  ...
  test("Whenever an opponent draws a card: the vocabulary resolves \"Target player loses 1 life.\"", () => {
