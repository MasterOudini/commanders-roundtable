// `Storm Fleet Spy` - every printed ability proven in its own game: the cost's mark, the pump
...
import { STORM_FLEET_SPY_SCRIPT } from './stormFleetSpy';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Storm Fleet Spy";
