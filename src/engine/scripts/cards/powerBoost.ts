// `Power Boost` - a layer-6 anthem: "Creatures you control get +1/+0". A StaticDef in the shape of the
...
import { POWER_BOOST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(POWER_BOOST, "Creatures you control get +1/+0.");
const TEXT = PRINTED;

export const POWER_BOOST_SCRIPT: CardScript = {
  oracleId: POWER_BOOST.oracleId,
  name: POWER_BOOST.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
