// `Ranger's Longbow` - an Equipment: the equipped creature gets +2/+1 and has reach.
...
import { RANGER_S_LONGBOW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(RANGER_S_LONGBOW, "Equipped creature gets +2/+1 and has reach.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const RANGERS_LONGBOW_SCRIPT: CardScript = {
  oracleId: RANGER_S_LONGBOW.oracleId,
  name: RANGER_S_LONGBOW.name,
  statics: [
    {
