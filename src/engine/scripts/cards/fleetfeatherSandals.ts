// `Fleetfeather Sandals` - an Equipment: the equipped creature has flying, haste.
...
import { FLEETFEATHER_SANDALS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLEETFEATHER_SANDALS, "Equipped creature has flying and haste.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const FLEETFEATHER_SANDALS_SCRIPT: CardScript = {
  oracleId: FLEETFEATHER_SANDALS.oracleId,
  name: FLEETFEATHER_SANDALS.name,
  statics: [
    {
