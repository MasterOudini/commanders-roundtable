// `Thopter Engineer` - a etb trigger token, a static anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { THOPTER_ENGINEER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(THOPTER_ENGINEER, "When this creature enters, create a 1/1 colorless Thopter artifact creature token with flying.\nArtifact creatures you control have haste. (They can attack and {T} as soon as they come under your control.)");
const LINES = PRINTED.split('\n');
const TOKEN_L0 = tokenRef("Thopter|1/1||Artifact Creature|flying");

export const THOPTER_ENGINEER_SCRIPT: CardScript = {
  oracleId: THOPTER_ENGINEER.oracleId,
  name: THOPTER_ENGINEER.name,
  triggers: [
    {
      abilityId: 'etb-0',
