// `Cradle of Safety` - a etb trigger attachedTemp, a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CRADLE_OF_SAFETY } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Cradle of Safety - attachedTemp",
