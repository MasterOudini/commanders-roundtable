// `Rabid Wombat` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { RABID_WOMBAT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(RABID_WOMBAT, "Vigilance\nThis creature gets +2/+2 for each Aura attached to it.");
...
export const RABID_WOMBAT_SCRIPT: CardScript = {
  oracleId: RABID_WOMBAT.oracleId,
  name: RABID_WOMBAT.name,
  statics: [
    {
      abilityId: 'pump-1',
