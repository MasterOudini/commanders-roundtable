// `Backwoods Survivalists` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BACKWOODS_SURVIVALISTS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BACKWOODS_SURVIVALISTS, "Delirium — This creature gets +1/+1 and has trample as long as there are four or more card types among cards in your graveyard.");
...
export const BACKWOODS_SURVIVALISTS_SCRIPT: CardScript = {
  oracleId: BACKWOODS_SURVIVALISTS.oracleId,
  name: BACKWOODS_SURVIVALISTS.name,
  statics: [
    {
