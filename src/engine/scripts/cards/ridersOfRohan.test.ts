// `Riders of Rohan` - every printed ability proven in its own game: the cost's mark, the pump
...
import { RIDERS_OF_ROHAN_SCRIPT } from './ridersOfRohan';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Riders of Rohan";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Riders of Rohan"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RIDERS_OF_ROHAN_SCRIPT]),
