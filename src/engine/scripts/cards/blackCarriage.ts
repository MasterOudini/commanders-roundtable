// `Black Carriage` - a static noUntap, an activation untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLACK_CARRIAGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLACK_CARRIAGE, "Trample\nThis creature doesn't untap during your untap step.\nSacrifice a creature: Untap this creature. Activate only during your upkeep.");
const LINES = PRINTED.split('\n');

export const BLACK_CARRIAGE_SCRIPT: CardScript = {
  oracleId: BLACK_CARRIAGE.oracleId,
  name: BLACK_CARRIAGE.name,
  activated: [
    {
      ref: `${BLACK_CARRIAGE.oracleId}#a0`,
