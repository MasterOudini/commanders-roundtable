// `One With the Wind` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has flying.
...
import { ONE_WITH_THE_WIND } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ONE_WITH_THE_WIND, "Enchant creature\nEnchanted creature gets +2/+2 and has flying.");
const LINES = PRINTED.split('\n');

export const ONE_WITH_THE_WIND_SCRIPT: CardScript = {
  oracleId: ONE_WITH_THE_WIND.oracleId,
  name: ONE_WITH_THE_WIND.name,
  statics: [
    {
