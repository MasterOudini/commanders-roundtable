// `Flora Colossus` - a static cdaCount
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FLORA_COLOSSUS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLORA_COLOSSUS, "Hexproof (This creature can't be the target of spells or abilities your opponents control.)\nFlora Colossus's power and toughness are each equal to the number of lands you control.");
...
export const FLORA_COLOSSUS_SCRIPT: CardScript = {
  oracleId: FLORA_COLOSSUS.oracleId,
  name: FLORA_COLOSSUS.name,
  statics: [
    {
      abilityId: 'cda-1',
