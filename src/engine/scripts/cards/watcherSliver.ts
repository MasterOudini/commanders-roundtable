// `Watcher Sliver` - a layer-6 anthem: "All Sliver creatures get +0/+2". A StaticDef in the shape of the
...
import { WATCHER_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WATCHER_SLIVER, "All Sliver creatures get +0/+2.");
const TEXT = PRINTED;

export const WATCHER_SLIVER_SCRIPT: CardScript = {
  oracleId: WATCHER_SLIVER.oracleId,
  name: WATCHER_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
