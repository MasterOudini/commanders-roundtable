// `Darksteel Axe` - an Equipment: the equipped creature gets +2/+0.
...
import { DARKSTEEL_AXE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DARKSTEEL_AXE, "Indestructible (Effects that say \"destroy\" don't destroy this Equipment.)\nEquipped creature gets +2/+0.\nEquip {2}");
const LINES = PRINTED.split('\n');

export const DARKSTEEL_AXE_SCRIPT: CardScript = {
  oracleId: DARKSTEEL_AXE.oracleId,
  name: DARKSTEEL_AXE.name,
  statics: [
    {
