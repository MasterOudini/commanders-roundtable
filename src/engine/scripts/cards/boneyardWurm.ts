// `Boneyard Wurm` - a static cdaCount
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BONEYARD_WURM } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BONEYARD_WURM, "Boneyard Wurm's power and toughness are each equal to the number of creature cards in your graveyard.");
...
export const BONEYARD_WURM_SCRIPT: CardScript = {
  oracleId: BONEYARD_WURM.oracleId,
  name: BONEYARD_WURM.name,
  statics: [
    {
      abilityId: 'cda-0',
      text: PRINTED,
