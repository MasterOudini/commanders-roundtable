// `Soul of Migration` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SOUL_OF_MIGRATION_SCRIPT } from './soulOfMigration';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Soul of Migration";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Soul of Migration"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SOUL_OF_MIGRATION_SCRIPT]),
