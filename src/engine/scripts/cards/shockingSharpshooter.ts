// `Shocking Sharpshooter` - a anotherCreatureEnters trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SHOCKING_SHARPSHOOTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHOCKING_SHARPSHOOTER, "Reach\nWhenever another creature you control enters, this creature deals 1 damage to target opponent.");
const LINES = PRINTED.split('\n');

export const SHOCKING_SHARPSHOOTER_SCRIPT: CardScript = {
  oracleId: SHOCKING_SHARPSHOOTER.oracleId,
  name: SHOCKING_SHARPSHOOTER.name,
  triggers: [
    {
      ...
      label: () => "Shocking Sharpshooter - damageTarget",
