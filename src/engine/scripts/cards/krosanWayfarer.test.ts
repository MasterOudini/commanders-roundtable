// `Krosan Wayfarer` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Krosan Wayfarer", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([KROSAN_WAYFARER_SCRIPT]),
...
describe("Krosan Wayfarer", () => {
  test("Sacrifice this creature: the vocabulary resolves \"You may put a land card from your hand onto the battlefield.\"", () => {
