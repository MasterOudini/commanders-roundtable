// `Soul Swallower` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SOUL_SWALLOWER_SCRIPT } from './soulSwallower';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Soul Swallower";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Soul Swallower", "Grizzly Bears", "Forest", "Sol Ring", "Hissing Miasma"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SOUL_SWALLOWER_SCRIPT]),
...
describe("Soul Swallower", () => {
  test("Delirium — At the beginning of your upkeep: it gets 3 +1/+1 counters", () => {
