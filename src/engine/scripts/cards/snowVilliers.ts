// `Snow Villiers` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SNOW_VILLIERS } from '../../../data/fixtures/engineCards';
...
export const SNOW_VILLIERS_SCRIPT: CardScript = {
  oracleId: SNOW_VILLIERS.oracleId,
  name: SNOW_VILLIERS.name,
  statics: [
    {
      abilityId: 'cda-1',
