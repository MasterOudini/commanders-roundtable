// `Vrock` - a endStep trigger loseLifeOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { VROCK } from '../../../data/fixtures/engineCards';
...
export const VROCK_SCRIPT: CardScript = {
  oracleId: VROCK.oracleId,
  name: VROCK.name,
  triggers: [
    {
      abilityId: 'endStep-1',
