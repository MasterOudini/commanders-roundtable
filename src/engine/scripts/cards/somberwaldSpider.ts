// `Somberwald Spider` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SOMBERWALD_SPIDER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SOMBERWALD_SPIDER, "Reach (This creature can block creatures with flying.)\nMorbid — This creature enters with two +1/+1 counters on it if a creature died this turn.");
...
export const SOMBERWALD_SPIDER_SCRIPT: CardScript = {
  oracleId: SOMBERWALD_SPIDER.oracleId,
  name: SOMBERWALD_SPIDER.name,
  replacements: [
    {
