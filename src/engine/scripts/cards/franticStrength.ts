// `Frantic Strength` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has trample.
...
import { FRANTIC_STRENGTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FRANTIC_STRENGTH, "Flash\nEnchant creature\nEnchanted creature gets +2/+2 and has trample.");
const LINES = PRINTED.split('\n');

export const FRANTIC_STRENGTH_SCRIPT: CardScript = {
  oracleId: FRANTIC_STRENGTH.oracleId,
  name: FRANTIC_STRENGTH.name,
  statics: [
    {
