// `Inquisitor's Ox` - a conditional static (as long as there are four or more card types among cards in your graveyard) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { INQUISITOR_S_OX } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(INQUISITOR_S_OX, "Delirium — This creature gets +1/+0 and has vigilance as long as there are four or more card types among cards in your graveyard.");
...
export const INQUISITORS_OX_SCRIPT: CardScript = {
  oracleId: INQUISITOR_S_OX.oracleId,
  name: INQUISITOR_S_OX.name,
  statics: [
    {
