// `Dwarven Patrol` - every printed ability proven in its own game: the cost's mark, the pump
...
import { DWARVEN_PATROL_SCRIPT } from './dwarvenPatrol';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Dwarven Patrol";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Dwarven Patrol", "Grizzly Bears", "Memnite"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([DWARVEN_PATROL_SCRIPT]),
...
describe("Dwarven Patrol", () => {
  ...
  test("Whenever you cast a nonred spell: it untaps", () => {
