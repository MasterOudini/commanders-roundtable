// `Welder Automaton` - an activation damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WELDER_AUTOMATON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WELDER_AUTOMATON, "{3}{R}: This creature deals 1 damage to each opponent.");

export const WELDER_AUTOMATON_SCRIPT: CardScript = {
  oracleId: WELDER_AUTOMATON.oracleId,
  name: WELDER_AUTOMATON.name,
  activated: [
    {
      ref: `${WELDER_AUTOMATON.oracleId}#a0`,
      text: PRINTED,
