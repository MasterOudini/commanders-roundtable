// `Verdant Sun's Avatar` - every printed ability proven in its own game: the cost's mark, the pump
...
import { VERDANT_SUNS_AVATAR_SCRIPT } from './verdantSunsAvatar';
import { advanceUntil, holdEverywhere, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Verdant Sun's Avatar";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Verdant Sun's Avatar", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([VERDANT_SUNS_AVATAR_SCRIPT]),
...
describe("Verdant Sun's Avatar", () => {
  test("Whenever this creature or another creature you control enters: the vocabulary resolves \"You gain life equal to target creature's toughness.\"", () => {
