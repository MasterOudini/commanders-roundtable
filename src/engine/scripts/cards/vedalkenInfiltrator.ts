// `Vedalken Infiltrator` - a static cantBeBlocked, a conditional static (as long as you control three or more artifacts) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { VEDALKEN_INFILTRATOR } from '../../../data/fixtures/engineCards';
...
export const VEDALKEN_INFILTRATOR_SCRIPT: CardScript = {
  oracleId: VEDALKEN_INFILTRATOR.oracleId,
  name: VEDALKEN_INFILTRATOR.name,
  combat: [
    {
