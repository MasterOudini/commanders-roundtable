// `Boon of Emrakul` - an Aura (Enchant creature): the enchanted creature gets +3/-3.
...
import { BOON_OF_EMRAKUL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BOON_OF_EMRAKUL, "Enchant creature\nEnchanted creature gets +3/-3.");
const LINES = PRINTED.split('\n');

export const BOON_OF_EMRAKUL_SCRIPT: CardScript = {
  oracleId: BOON_OF_EMRAKUL.oracleId,
  name: BOON_OF_EMRAKUL.name,
  statics: [
    {
