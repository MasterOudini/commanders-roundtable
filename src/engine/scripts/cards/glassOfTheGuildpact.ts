// `Glass of the Guildpact` - a layer-6 anthem: "Multicolored creatures you control get +1/+1". A StaticDef in the shape of the
...
import { GLASS_OF_THE_GUILDPACT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GLASS_OF_THE_GUILDPACT, "Multicolored creatures you control get +1/+1.");
const TEXT = PRINTED;

export const GLASS_OF_THE_GUILDPACT_SCRIPT: CardScript = {
  oracleId: GLASS_OF_THE_GUILDPACT.oracleId,
  name: GLASS_OF_THE_GUILDPACT.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
