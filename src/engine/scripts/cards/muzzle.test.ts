...
function armed(): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Muzzle", "Grizzly Bears", "Spark Spray"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MUZZLE_SCRIPT]),
  });
  holdEverywhere(g);
