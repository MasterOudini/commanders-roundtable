// `Buoyancy` - an Aura (Enchant creature): the enchanted creature has flying.
...
import { BUOYANCY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BUOYANCY, "Flash\nEnchant creature\nEnchanted creature has flying.");
const LINES = PRINTED.split('\n');

export const BUOYANCY_SCRIPT: CardScript = {
  oracleId: BUOYANCY.oracleId,
  name: BUOYANCY.name,
  statics: [
    {
