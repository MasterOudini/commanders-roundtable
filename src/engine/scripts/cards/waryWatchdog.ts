// `Wary Watchdog` (Dog) — "When this creature enters or dies, surveil 1."
//
// ⚠️ An EXACT-TEXT TWIN of `Wary Thespian`: byte-identical oracle text on two
...
import { WARY_WATCHDOG } from '../../../data/fixtures/engineCards';
...
const TEXT = printed(WARY_WATCHDOG, 'When this creature enters or dies, surveil 1. (Look at the top card of your library. You may put it into your graveyard.)');
...
export const WARY_WATCHDOG_SCRIPT: CardScript = {
  oracleId: WARY_WATCHDOG.oracleId,
  name: WARY_WATCHDOG.name,
  triggers: [
    {
      abilityId: 'enters',
      text: TEXT,
