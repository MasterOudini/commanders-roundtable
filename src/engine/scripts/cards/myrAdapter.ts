// `Myr Adapter` - a VARIABLE PUMP (D387): the delta is COUNTED at each derive
...
import { MYR_ADAPTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MYR_ADAPTER, "This creature gets +1/+1 for each Equipment attached to it.");
...
export const MYR_ADAPTER_SCRIPT: CardScript = {
  oracleId: MYR_ADAPTER.oracleId,
  name: MYR_ADAPTER.name,
  statics: [
    {
      abilityId: 'pump-0',
