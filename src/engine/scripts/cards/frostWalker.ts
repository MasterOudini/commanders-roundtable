// `Frost Walker` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FROST_WALKER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FROST_WALKER, "When this creature becomes the target of a spell or ability, sacrifice it.");

export const FROST_WALKER_SCRIPT: CardScript = {
  oracleId: FROST_WALKER.oracleId,
  name: FROST_WALKER.name,
  triggers: [
    {
      ...
      label: () => "Frost Walker - sacrificeSelf",
