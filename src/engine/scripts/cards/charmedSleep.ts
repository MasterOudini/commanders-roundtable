// `Charmed Sleep` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CHARMED_SLEEP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CHARMED_SLEEP, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const CHARMED_SLEEP_SCRIPT: CardScript = {
  oracleId: CHARMED_SLEEP.oracleId,
  name: CHARMED_SLEEP.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Charmed Sleep - tapAttached",
