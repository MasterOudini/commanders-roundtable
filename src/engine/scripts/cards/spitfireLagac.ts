// `Spitfire Lagac` - a landfall trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPITFIRE_LAGAC } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPITFIRE_LAGAC, "Landfall — Whenever a land you control enters, this creature deals 1 damage to each opponent.");

export const SPITFIRE_LAGAC_SCRIPT: CardScript = {
  oracleId: SPITFIRE_LAGAC.oracleId,
  name: SPITFIRE_LAGAC.name,
  triggers: [
    {
      ...
      label: () => "Spitfire Lagac - damageOpponents",
