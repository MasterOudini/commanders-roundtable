// `Goblin Boarders` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GOBLIN_BOARDERS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GOBLIN_BOARDERS, "Raid — This creature enters with a +1/+1 counter on it if you attacked this turn.");
...
export const GOBLIN_BOARDERS_SCRIPT: CardScript = {
  oracleId: GOBLIN_BOARDERS.oracleId,
  name: GOBLIN_BOARDERS.name,
  replacements: [
    {
