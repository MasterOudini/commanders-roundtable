// `Malcolm, the Eyes` - a secondSpell trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MALCOLM_THE_EYES } from '../../../data/fixtures/engineCards';
