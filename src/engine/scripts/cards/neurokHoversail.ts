// `Neurok Hoversail` - an Equipment: the equipped creature has flying.
...
import { NEUROK_HOVERSAIL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NEUROK_HOVERSAIL, "Equipped creature has flying.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const NEUROK_HOVERSAIL_SCRIPT: CardScript = {
  oracleId: NEUROK_HOVERSAIL.oracleId,
  name: NEUROK_HOVERSAIL.name,
  statics: [
    {
