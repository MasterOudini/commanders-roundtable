// `Mystic Enforcer` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MYSTIC_ENFORCER } from '../../../data/fixtures/engineCards';
...
export const MYSTIC_ENFORCER_SCRIPT: CardScript = {
  oracleId: MYSTIC_ENFORCER.oracleId,
  name: MYSTIC_ENFORCER.name,
  statics: [
    {
