// `Battering Sliver` - a layer-6 grant: "All Sliver creatures have trample". A StaticDef in the shape of the
...
import { BATTERING_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BATTERING_SLIVER, "All Sliver creatures have trample.");
const TEXT = PRINTED;

export const BATTERING_SLIVER_SCRIPT: CardScript = {
  oracleId: BATTERING_SLIVER.oracleId,
  name: BATTERING_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
