// `Festerhide Boar` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FESTERHIDE_BOAR } from '../../../data/fixtures/engineCards';
...
export const FESTERHIDE_BOAR_SCRIPT: CardScript = {
  oracleId: FESTERHIDE_BOAR.oracleId,
  name: FESTERHIDE_BOAR.name,
  replacements: [
    {
