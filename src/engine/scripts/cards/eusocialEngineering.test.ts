// `Eusocial Engineering` - every printed ability proven in its own game: the cost's mark, the pump
...
import { EUSOCIAL_ENGINEERING_SCRIPT } from './eusocialEngineering';
import { advanceUntil, holdEverywhere, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Eusocial Engineering";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Eusocial Engineering"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([EUSOCIAL_ENGINEERING_SCRIPT]),
