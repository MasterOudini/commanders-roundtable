// `Angelic Chorus` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Angelic Chorus", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ANGELIC_CHORUS_SCRIPT]),
...
describe("Angelic Chorus", () => {
  test("Whenever a creature you control enters: the vocabulary resolves \"You gain life equal to target creature's toughness.\"", () => {
