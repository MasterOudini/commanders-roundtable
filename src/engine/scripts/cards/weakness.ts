// `Weakness` - an Aura (Enchant creature): the enchanted creature gets -2/-1.
...
import { WEAKNESS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WEAKNESS, "Enchant creature\nEnchanted creature gets -2/-1.");
const LINES = PRINTED.split('\n');

export const WEAKNESS_SCRIPT: CardScript = {
  oracleId: WEAKNESS.oracleId,
  name: WEAKNESS.name,
  statics: [
    {
