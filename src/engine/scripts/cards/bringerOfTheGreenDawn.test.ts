// `Bringer of the Green Dawn` - every printed ability proven in its own game: the cost's mark, the pump
...
import { BRINGER_OF_THE_GREEN_DAWN_SCRIPT } from './bringerOfTheGreenDawn';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Bringer of the Green Dawn";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Bringer of the Green Dawn"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([BRINGER_OF_THE_GREEN_DAWN_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Bringer of the Green Dawn", () => {
