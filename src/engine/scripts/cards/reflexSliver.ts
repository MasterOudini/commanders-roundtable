// `Reflex Sliver` - a layer-6 grant: "All Sliver creatures have haste". A StaticDef in the shape of the
...
import { REFLEX_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(REFLEX_SLIVER, "All Sliver creatures have haste.");
const TEXT = PRINTED;

export const REFLEX_SLIVER_SCRIPT: CardScript = {
  oracleId: REFLEX_SLIVER.oracleId,
  name: REFLEX_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
