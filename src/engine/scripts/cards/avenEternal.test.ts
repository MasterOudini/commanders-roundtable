// `Aven Eternal` - every printed ability proven in its own game: the cost's mark, the pump
...
import { AVEN_ETERNAL_SCRIPT } from './avenEternal';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Aven Eternal";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Aven Eternal"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([AVEN_ETERNAL_SCRIPT]),
