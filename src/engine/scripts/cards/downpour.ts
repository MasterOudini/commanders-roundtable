// `Downpour` — tap up to three target creatures.
...
const TEXT = printed(DOWNPOUR, 'Tap up to three target creatures.');

export const DOWNPOUR_SCRIPT: CardScript = {
  oracleId: DOWNPOUR.oracleId,
  name: DOWNPOUR.name,
  spell: {
    text: TEXT,
