// `Sliver Hivelord` - a layer-6 grant: "Sliver creatures you control have indestructible. (Damage and effects that say "destroy" don't destroy them.)". A StaticDef in the shape of the
...
import { SLIVER_HIVELORD } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SLIVER_HIVELORD, "Sliver creatures you control have indestructible. (Damage and effects that say \"destroy\" don't destroy them.)");
const TEXT = PRINTED;

export const SLIVER_HIVELORD_SCRIPT: CardScript = {
  oracleId: SLIVER_HIVELORD.oracleId,
  name: SLIVER_HIVELORD.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
