// `Mounted Dreadknight` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MOUNTED_DREADKNIGHT } from '../../../data/fixtures/engineCards';
...
export const MOUNTED_DREADKNIGHT_SCRIPT: CardScript = {
  oracleId: MOUNTED_DREADKNIGHT.oracleId,
  name: MOUNTED_DREADKNIGHT.name,
  replacements: [
    {
