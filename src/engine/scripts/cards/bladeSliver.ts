// `Blade Sliver` - a layer-6 anthem: "All Sliver creatures get +1/+0". A StaticDef in the shape of the
...
import { BLADE_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLADE_SLIVER, "All Sliver creatures get +1/+0.");
const TEXT = PRINTED;

export const BLADE_SLIVER_SCRIPT: CardScript = {
  oracleId: BLADE_SLIVER.oracleId,
  name: BLADE_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
