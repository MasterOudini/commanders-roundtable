// `Holy Strength` - an Aura (Enchant creature): the enchanted creature gets +1/+2.
...
import { HOLY_STRENGTH } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HOLY_STRENGTH, "Enchant creature\nEnchanted creature gets +1/+2.");
const LINES = PRINTED.split('\n');

export const HOLY_STRENGTH_SCRIPT: CardScript = {
  oracleId: HOLY_STRENGTH.oracleId,
  name: HOLY_STRENGTH.name,
  statics: [
    {
