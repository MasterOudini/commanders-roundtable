// `Eidolon of Blossoms` - every printed ability proven in its own game: the cost's mark, the pump
...
const CARD = "Eidolon of Blossoms";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Eidolon of Blossoms", "Hissing Miasma"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([EIDOLON_OF_BLOSSOMS_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Eidolon of Blossoms", () => {
  test("Constellation — Whenever this creature or another enchantment you control enters: a card is drawn", () => {
