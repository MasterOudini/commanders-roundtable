// `Savage Silhouette` - the permanent it is attached to HAS a quoted
...
import { SAVAGE_SILHOUETTE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SAVAGE_SILHOUETTE, "Enchant creature\nEnchanted creature gets +2/+2 and has \"{1}{G}: Regenerate this creature.\"");
const LINES = PRINTED.split("\n");

const GRANT = grantedActivated("{1}{G}: Regenerate this creature.", `${SAVAGE_SILHOUETTE.oracleId}#g1`, SAVAGE_SILHOUETTE.name);
const VOCAB = vocabularyEffects("Regenerate this creature.", SAVAGE_SILHOUETTE.name);
const VOCAB_T = vocabularyTargets("Regenerate this creature.");

export const SAVAGE_SILHOUETTE_SCRIPT: CardScript = {
  oracleId: SAVAGE_SILHOUETTE.oracleId,
  name: SAVAGE_SILHOUETTE.name,
  statics: [
    {
