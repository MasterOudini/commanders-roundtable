// `Angry Rabble` - a castSpell trigger damageOpponents, an activation selfCounter
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ANGRY_RABBLE } from '../../../data/fixtures/engineCards';
  ...
  triggers: [
    {
      ...
      label: () => "Angry Rabble - damageOpponents",
