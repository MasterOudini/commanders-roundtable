// `Keiga, the Tide Star` - every printed ability proven in its own game: the cost's mark, the pump
...
import { KEIGA_THE_TIDE_STAR_SCRIPT } from './keigaTheTideStar';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Keiga, the Tide Star";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Keiga, the Tide Star"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([KEIGA_THE_TIDE_STAR_SCRIPT]),
...
describe("Keiga, the Tide Star", () => {
  test("When Keiga dies: the vocabulary resolves \"Gain control of target creature.\"", () => {
