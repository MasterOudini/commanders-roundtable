// `Elvish Piper` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Elvish Piper", "Grizzly Bears", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ELVISH_PIPER_SCRIPT]),
...
describe("Elvish Piper", () => {
  test("{G}, {T}: the vocabulary resolves \"You may put a creature card from your hand onto the battlefield.\"", () => {
