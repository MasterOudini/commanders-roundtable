// `Qarsi Sadist` - every printed ability proven in its own game: the cost's mark, the pump
...
import { QARSI_SADIST_SCRIPT } from './qarsiSadist';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Qarsi Sadist";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Qarsi Sadist"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([QARSI_SADIST_SCRIPT]),
...
describe("Qarsi Sadist", () => {
  test("When this creature exploits a creature: the vocabulary resolves \"Target opponent loses 2 life and you gain 2 life.\"", () => {
