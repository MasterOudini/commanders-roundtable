// `No-Dachi` - an Equipment: the equipped creature gets +2/+0 and has firstStrike.
...
import { NO_DACHI } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NO_DACHI, "Equipped creature gets +2/+0 and has first strike.\nEquip {3} ({3}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const NO_DACHI_SCRIPT: CardScript = {
  oracleId: NO_DACHI.oracleId,
  name: NO_DACHI.name,
  statics: [
    {
