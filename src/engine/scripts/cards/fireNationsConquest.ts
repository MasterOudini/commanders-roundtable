// `Fire Nation's Conquest` - a layer-6 anthem: "Creatures you control get +1/+0". A StaticDef in the shape of the
...
import { FIRE_NATION_S_CONQUEST } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FIRE_NATION_S_CONQUEST, "Creatures you control get +1/+0.");
const TEXT = PRINTED;

export const FIRE_NATIONS_CONQUEST_SCRIPT: CardScript = {
  oracleId: FIRE_NATION_S_CONQUEST.oracleId,
  name: FIRE_NATION_S_CONQUEST.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
