// `Nexus Wardens` - a creatureEnters trigger gainLife
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NEXUS_WARDENS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NEXUS_WARDENS, "Reach\nConstellation — Whenever an enchantment you control enters, you gain 2 life.");
const LINES = PRINTED.split('\n');

export const NEXUS_WARDENS_SCRIPT: CardScript = {
  oracleId: NEXUS_WARDENS.oracleId,
  name: NEXUS_WARDENS.name,
  triggers: [
    {
