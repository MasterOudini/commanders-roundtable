// `Mardu Blazebringer` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MARDU_BLAZEBRINGER_SCRIPT } from './marduBlazebringer';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Mardu Blazebringer";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Mardu Blazebringer"], ["Cyclops of One-Eyed Pass", "Grizzly Bears"]],
    scripts: createRegistry([MARDU_BLAZEBRINGER_SCRIPT]),
...
describe("Mardu Blazebringer", () => {
  test("When this creature attacks or blocks: the vocabulary resolves \"Sacrifice ~ at end of combat.\" [attacks]", () => {
  ...
  test("When this creature attacks or blocks: the vocabulary resolves \"Sacrifice ~ at end of combat.\" [blocks]", () => {
