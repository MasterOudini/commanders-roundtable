// `Fell Stinger` - every printed ability proven in its own game: the cost's mark, the pump
...
import { FELL_STINGER_SCRIPT } from './fellStinger';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Fell Stinger";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Fell Stinger"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([FELL_STINGER_SCRIPT]),
...
describe("Fell Stinger", () => {
  test("When this creature exploits a creature: the vocabulary resolves \"Target player draws two cards and loses 2 life.\"", () => {
