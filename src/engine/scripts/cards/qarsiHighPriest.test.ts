// `Qarsi High Priest` - every printed ability proven in its own game: the cost's mark, the pump
...
import { QARSI_HIGH_PRIEST_SCRIPT } from './qarsiHighPriest';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Qarsi High Priest";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Qarsi High Priest", "Grizzly Bears", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([QARSI_HIGH_PRIEST_SCRIPT]),
...
describe("Qarsi High Priest", () => {
  test("{1}{B}, {T}, Sacrifice another creature: the vocabulary resolves \"Manifest the top card of your library.\"", () => {
