// `Roil Elemental` - every printed ability proven in its own game: the cost's mark, the pump
...
import { ROIL_ELEMENTAL_SCRIPT } from './roilElemental';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Roil Elemental";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Roil Elemental"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([ROIL_ELEMENTAL_SCRIPT]),
...
describe("Roil Elemental", () => {
  test("Landfall — Whenever a land you control enters: the vocabulary resolves \"Gain control of target creature for as long as you control this creature.\"", () => {
