// `Scrapper Champion` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SCRAPPER_CHAMPION_SCRIPT } from './scrapperChampion';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Scrapper Champion";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Scrapper Champion"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([SCRAPPER_CHAMPION_SCRIPT]),
...
describe("Scrapper Champion", () => {
  ...
  test("Whenever this creature attacks: the vocabulary resolves \"You may pay {E}{E}. If you do, put a +1/+1 counter on ~.\" - the price is declined", () => {
  ...
  test("Whenever this creature attacks: the vocabulary resolves \"You may pay {E}{E}. If you do, put a +1/+1 counter on ~.\" - the price is paid", () => {
