...
const TEXT = printed(GAZE_OF_GRANITE, 'Destroy each nonland permanent with mana value X or less.');

export const GAZE_OF_GRANITE_SCRIPT: CardScript = {
  oracleId: GAZE_OF_GRANITE.oracleId,
  name: GAZE_OF_GRANITE.name,
  spell: {
    text: TEXT,
