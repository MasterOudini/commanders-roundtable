// `Stalwarts of Osgiliath` - every printed ability proven in its own game: the cost's mark, the pump
...
import { STALWARTS_OF_OSGILIATH_SCRIPT } from './stalwartsOfOsgiliath';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Stalwarts of Osgiliath";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Stalwarts of Osgiliath", "Divination"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([STALWARTS_OF_OSGILIATH_SCRIPT]),
...
describe("Stalwarts of Osgiliath", () => {
  test("When this creature enters: the vocabulary resolves \"The Ring tempts you.\"", () => {
  ...
  test("Whenever you draw your second card each turn: it gets 1 +1/+1 counter", () => {
