// `Lobber Crew` - an activation damageOpponents, a castSpell trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { LOBBER_CREW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(LOBBER_CREW, "Defender\n{T}: This creature deals 1 damage to each opponent.\nWhenever you cast a multicolored spell, untap this creature.");
const LINES = PRINTED.split('\n');

export const LOBBER_CREW_SCRIPT: CardScript = {
  oracleId: LOBBER_CREW.oracleId,
  name: LOBBER_CREW.name,
  activated: [
    {
      ref: `${LOBBER_CREW.oracleId}#a0`,
