// `Belligerent Sliver` - a layer-6 grant: "Sliver creatures you control have menace. (They can't be blocked except by two or more creatures.)". A StaticDef in the shape of the
...
import { BELLIGERENT_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BELLIGERENT_SLIVER, "Sliver creatures you control have menace. (They can't be blocked except by two or more creatures.)");
const TEXT = PRINTED;

export const BELLIGERENT_SLIVER_SCRIPT: CardScript = {
  oracleId: BELLIGERENT_SLIVER.oracleId,
  name: BELLIGERENT_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
