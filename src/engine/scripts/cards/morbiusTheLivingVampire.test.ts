// `Morbius the Living Vampire` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MORBIUS_THE_LIVING_VAMPIRE_SCRIPT } from './morbiusTheLivingVampire';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Morbius the Living Vampire";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Morbius the Living Vampire"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MORBIUS_THE_LIVING_VAMPIRE_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Morbius the Living Vampire", () => {
  test("{U}{B}, Exile this card from your graveyard: the vocabulary resolves \"Look at the top three cards of your library. Put one of them into your hand and the rest on the bottom of your library in any order.\"", () => {
