// `Psychic Symbiont` - every printed ability proven in its own game: the cost's mark, the pump
...
import { PSYCHIC_SYMBIONT_SCRIPT } from './psychicSymbiont';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Psychic Symbiont";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Psychic Symbiont"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([PSYCHIC_SYMBIONT_SCRIPT]),
...
describe("Psychic Symbiont", () => {
  test("When this creature enters: the vocabulary resolves \"Target opponent discards a card and you draw a card.\"", () => {
