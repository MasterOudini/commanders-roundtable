// `Rabaroo Troop` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Rabaroo Troop"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RABAROO_TROOP_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Rabaroo Troop", () => {
  test("Landfall — Whenever a land you control enters: the vocabulary resolves \"~ gains flying until end of turn and you gain 1 life.\"", () => {
