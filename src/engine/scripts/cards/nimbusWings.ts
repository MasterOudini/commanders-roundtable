// `Nimbus Wings` - an Aura (Enchant creature): the enchanted creature gets +1/+2 and has flying.
...
import { NIMBUS_WINGS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NIMBUS_WINGS, "Enchant creature\nEnchanted creature gets +1/+2 and has flying.");
const LINES = PRINTED.split('\n');

export const NIMBUS_WINGS_SCRIPT: CardScript = {
  oracleId: NIMBUS_WINGS.oracleId,
  name: NIMBUS_WINGS.name,
  statics: [
    {
