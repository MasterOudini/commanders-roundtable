// `Jackal Pup` - a isDealtCombatDamage trigger vocab, a isDealtNoncombatDamage trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { JACKAL_PUP } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(JACKAL_PUP, "Whenever this creature is dealt damage, it deals that much damage to you.");

const VOCAB_L0 = vocabularyEffects("~ deals that much damage to you.", JACKAL_PUP.name, { memo: true });
const VOCAB_T_L0 = vocabularyTargets("~ deals that much damage to you.");

export const JACKAL_PUP_SCRIPT: CardScript = {
  oracleId: JACKAL_PUP.oracleId,
  name: JACKAL_PUP.name,
  triggers: [
    {
      ...
      label: () => "Jackal Pup - ~ deals that much damage to you.",
