// `Anthem of Champions` - a layer-6 anthem: "Creatures you control get +1/+1". A StaticDef in the shape of the
...
import { ANTHEM_OF_CHAMPIONS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ANTHEM_OF_CHAMPIONS, "Creatures you control get +1/+1.");
const TEXT = PRINTED;

export const ANTHEM_OF_CHAMPIONS_SCRIPT: CardScript = {
  oracleId: ANTHEM_OF_CHAMPIONS.oracleId,
  name: ANTHEM_OF_CHAMPIONS.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
