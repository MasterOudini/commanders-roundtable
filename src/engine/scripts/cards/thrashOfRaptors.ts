// `Thrash of Raptors` - a conditional static (as long as you control another Dinosaur) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { THRASH_OF_RAPTORS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(THRASH_OF_RAPTORS, "As long as you control another Dinosaur, this creature gets +2/+0 and has trample.");
...
export const THRASH_OF_RAPTORS_SCRIPT: CardScript = {
  oracleId: THRASH_OF_RAPTORS.oracleId,
  name: THRASH_OF_RAPTORS.name,
  statics: [
    {
