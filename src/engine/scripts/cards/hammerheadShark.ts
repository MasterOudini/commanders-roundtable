// `Hammerhead Shark` - a static cantAttackUnless
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { HAMMERHEAD_SHARK } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HAMMERHEAD_SHARK, "This creature can't attack unless defending player controls an Island.");
...
export const HAMMERHEAD_SHARK_SCRIPT: CardScript = {
  oracleId: HAMMERHEAD_SHARK.oracleId,
  name: HAMMERHEAD_SHARK.name,
  combat: [
    {
