// `Strength of Lunacy` - a static attachedStatic
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STRENGTH_OF_LUNACY } from '../../../data/fixtures/engineCards';
...
const PROT_1_0 = parseProtection("protection from white");

export const STRENGTH_OF_LUNACY_SCRIPT: CardScript = {
  oracleId: STRENGTH_OF_LUNACY.oracleId,
  name: STRENGTH_OF_LUNACY.name,
  statics: [
    {
