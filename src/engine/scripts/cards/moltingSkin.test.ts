// `Molting Skin` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MOLTING_SKIN_SCRIPT } from './moltingSkin';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Molting Skin";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Molting Skin", "Lightning Bolt"], ["Cyclops of One-Eyed Pass"]],
