// `Dread Specter` - a blocksOrBecomesBlockedBy trigger vocab
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { DREAD_SPECTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DREAD_SPECTER, "Whenever this creature blocks or becomes blocked by a nonblack creature, destroy that creature at end of combat.");

const VOCAB_L0 = vocabularyEffects("Destroy target creature at end of combat.", DREAD_SPECTER.name);
const VOCAB_T_L0 = vocabularyTargets("Destroy target creature at end of combat.");

export const DREAD_SPECTER_SCRIPT: CardScript = {
  oracleId: DREAD_SPECTER.oracleId,
  name: DREAD_SPECTER.name,
  triggers: [
    {
      ...
      label: () => "Dread Specter - Destroy target creature at end of combat.",
