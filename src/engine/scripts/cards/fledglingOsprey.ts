// `Fledgling Osprey` - a conditional static (as long as it's enchanted) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { FLEDGLING_OSPREY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(FLEDGLING_OSPREY, "This creature has flying as long as it's enchanted.");
...
export const FLEDGLING_OSPREY_SCRIPT: CardScript = {
  oracleId: FLEDGLING_OSPREY.oracleId,
  name: FLEDGLING_OSPREY.name,
  statics: [
    {
