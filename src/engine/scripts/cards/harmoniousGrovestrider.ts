// `Harmonious Grovestrider` - a static cdaCount
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { HARMONIOUS_GROVESTRIDER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(HARMONIOUS_GROVESTRIDER, "Ward {2} (Whenever this creature becomes the target of a spell or ability an opponent controls, counter it unless that player pays {2}.)\nHarmonious Grovestrider's power and toughness are each equal to the number of lands you control.");
...
export const HARMONIOUS_GROVESTRIDER_SCRIPT: CardScript = {
  oracleId: HARMONIOUS_GROVESTRIDER.oracleId,
  name: HARMONIOUS_GROVESTRIDER.name,
  statics: [
    {
      abilityId: 'cda-1',
