// `Coruscation Mage` - a castNoncreature trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CORUSCATION_MAGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CORUSCATION_MAGE, "Offspring {2} (You may pay an additional {2} as you cast this spell. If you do, when this creature enters, create a 1/1 token copy of it.)\nWhenever you cast a noncreature spell, this creature deals 1 damage to each opponent.");
const LINES = PRINTED.split('\n');

export const CORUSCATION_MAGE_SCRIPT: CardScript = {
  oracleId: CORUSCATION_MAGE.oracleId,
  name: CORUSCATION_MAGE.name,
  triggers: [
    {
      ...
      label: () => "Coruscation Mage - damageOpponents",
