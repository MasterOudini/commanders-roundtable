// `Banshee of the Dread Choir` - every printed ability proven in its own game: the cost's mark, the pump
...
import { BANSHEE_OF_THE_DREAD_CHOIR_SCRIPT } from './bansheeOfTheDreadChoir';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Banshee of the Dread Choir";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Banshee of the Dread Choir"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([BANSHEE_OF_THE_DREAD_CHOIR_SCRIPT]),
...
describe("Banshee of the Dread Choir", () => {
  test("Whenever this creature deals combat damage to a player: the vocabulary resolves \"Target player discards a card.\"", () => {
