// `Knife` - a conditional static (as long as it's your turn) attachedStatic, an activation draw
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { KNIFE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(KNIFE, "During your turn, equipped creature gets +1/+0 and has first strike.\n{2}, Sacrifice this Equipment: Draw a card.\nEquip {2}");
...
export const KNIFE_SCRIPT: CardScript = {
  oracleId: KNIFE.oracleId,
  name: KNIFE.name,
  activated: [
    {
      ref: `${KNIFE.oracleId}#a0`,
