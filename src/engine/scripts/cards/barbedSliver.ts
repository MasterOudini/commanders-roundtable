// `Barbed Sliver` - every permanent in its scope HAS a quoted
...
import { BARBED_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BARBED_SLIVER, "All Sliver creatures have \"{2}: This creature gets +1/+0 until end of turn.\"");

const GRANT = grantedActivated("{2}: This creature gets +1/+0 until end of turn.", `${BARBED_SLIVER.oracleId}#g0`, BARBED_SLIVER.name);
const VOCAB = vocabularyEffects("This creature gets +1/+0 until end of turn.", BARBED_SLIVER.name);
const VOCAB_T = vocabularyTargets("This creature gets +1/+0 until end of turn.");

export const BARBED_SLIVER_SCRIPT: CardScript = {
  oracleId: BARBED_SLIVER.oracleId,
  name: BARBED_SLIVER.name,
  statics: [
    {
      abilityId: 'grant-0',
      text: PRINTED,
