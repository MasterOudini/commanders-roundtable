// `Gravetiller Wurm` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GRAVETILLER_WURM } from '../../../data/fixtures/engineCards';
...
export const GRAVETILLER_WURM_SCRIPT: CardScript = {
  oracleId: GRAVETILLER_WURM.oracleId,
  name: GRAVETILLER_WURM.name,
  replacements: [
    {
