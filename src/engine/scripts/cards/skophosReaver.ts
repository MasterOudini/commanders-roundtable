// `Skophos Reaver` - a conditional static (as long as it's your turn) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SKOPHOS_REAVER } from '../../../data/fixtures/engineCards';
...
export const SKOPHOS_REAVER_SCRIPT: CardScript = {
  oracleId: SKOPHOS_REAVER.oracleId,
  name: SKOPHOS_REAVER.name,
  statics: [
    {
