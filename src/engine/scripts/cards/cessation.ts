// `Cessation` - a static attachedCombat, a auraToGraveyard trigger bounceSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CESSATION } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CESSATION, "Enchant creature\nEnchanted creature can't attack.\nWhen this Aura is put into a graveyard from the battlefield, return it to its owner's hand.");
const LINES = PRINTED.split('\n');

export const CESSATION_SCRIPT: CardScript = {
  oracleId: CESSATION.oracleId,
  name: CESSATION.name,
  triggers: [
    {
