// `Chained Brute` - a static noUntap, an activation untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CHAINED_BRUTE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CHAINED_BRUTE, "This creature doesn't untap during your untap step.\n{1}, Sacrifice another creature: Untap this creature. Activate only during your turn.");
const LINES = PRINTED.split('\n');

export const CHAINED_BRUTE_SCRIPT: CardScript = {
  oracleId: CHAINED_BRUTE.oracleId,
  name: CHAINED_BRUTE.name,
  activated: [
    {
      ref: `${CHAINED_BRUTE.oracleId}#a0`,
