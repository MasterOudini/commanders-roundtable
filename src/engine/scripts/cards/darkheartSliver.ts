// `Darkheart Sliver` - every permanent in its scope HAS a quoted
...
import { DARKHEART_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(DARKHEART_SLIVER, "All Slivers have \"Sacrifice this permanent: You gain 3 life.\"");

const GRANT = grantedActivated("Sacrifice this permanent: You gain 3 life.", `${DARKHEART_SLIVER.oracleId}#g0`, DARKHEART_SLIVER.name);
const VOCAB = vocabularyEffects("You gain 3 life.", DARKHEART_SLIVER.name);
const VOCAB_T = vocabularyTargets("You gain 3 life.");

export const DARKHEART_SLIVER_SCRIPT: CardScript = {
  oracleId: DARKHEART_SLIVER.oracleId,
  name: DARKHEART_SLIVER.name,
  statics: [
    {
      abilityId: 'grant-0',
      text: PRINTED,
