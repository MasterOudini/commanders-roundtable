// `Tuinvale Guide` - a conditional static (as long as two or more nonland permanents entered the battlefield under your control this turn) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TUINVALE_GUIDE } from '../../../data/fixtures/engineCards';
...
export const TUINVALE_GUIDE_SCRIPT: CardScript = {
  oracleId: TUINVALE_GUIDE.oracleId,
  name: TUINVALE_GUIDE.name,
  statics: [
    {
