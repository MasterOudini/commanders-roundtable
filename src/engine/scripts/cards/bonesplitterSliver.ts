// `Bonesplitter Sliver` - a layer-6 anthem: "All Sliver creatures get +2/+0". A StaticDef in the shape of the
...
import { BONESPLITTER_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BONESPLITTER_SLIVER, "All Sliver creatures get +2/+0.");
const TEXT = PRINTED;

export const BONESPLITTER_SLIVER_SCRIPT: CardScript = {
  oracleId: BONESPLITTER_SLIVER.oracleId,
  name: BONESPLITTER_SLIVER.name,
  statics: [
    {
      abilityId: 'anthem',
      text: TEXT,
