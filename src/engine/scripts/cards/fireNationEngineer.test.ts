// `Fire Nation Engineer` - every printed ability proven in its own game: the cost's mark, the pump
...
import { FIRE_NATION_ENGINEER_SCRIPT } from './fireNationEngineer';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Fire Nation Engineer";

type Armed = { g: Game; self: InstanceId; no: InstanceId; life0: number; hand0: number; board0: number; p2life0: number; p2hand0: number; gy0: number; p2gy0: number; lib0: number; bearsB: InstanceId; vtL0_endStep_0: InstanceId };
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Fire Nation Engineer", "Grizzly Bears", "Cyclops of One-Eyed Pass"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([FIRE_NATION_ENGINEER_SCRIPT]),
  ...
  return { g, self, no, life0, hand0, board0, p2life0, p2hand0, gy0, p2gy0, lib0, bearsB, vtL0_endStep_0 };
}

describe("Fire Nation Engineer", () => {
  test("Raid — At the beginning of your end step: the vocabulary resolves \"Put a +1/+1 counter on another target creature or Vehicle you control.\"", () => {
