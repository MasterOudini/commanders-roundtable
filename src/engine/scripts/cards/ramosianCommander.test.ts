// `Ramosian Commander` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ramosian Commander", "Children of Korlis"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([RAMOSIAN_COMMANDER_SCRIPT]),
...
describe("Ramosian Commander", () => {
  test("{6}, {T}: the vocabulary resolves \"Search your library for a Rebel permanent card with mana value 5 or less, put it onto the battlefield, then shuffle.\"", () => {
