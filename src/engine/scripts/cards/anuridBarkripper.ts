// `Anurid Barkripper` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { ANURID_BARKRIPPER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ANURID_BARKRIPPER, "Threshold — This creature gets +2/+2 as long as there are seven or more cards in your graveyard.");
...
export const ANURID_BARKRIPPER_SCRIPT: CardScript = {
  oracleId: ANURID_BARKRIPPER.oracleId,
  name: ANURID_BARKRIPPER.name,
  statics: [
    {
