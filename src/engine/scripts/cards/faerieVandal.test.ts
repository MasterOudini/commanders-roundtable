// `Faerie Vandal` - every printed ability proven in its own game: the cost's mark, the pump
...
import { FAERIE_VANDAL_SCRIPT } from './faerieVandal';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Faerie Vandal";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Faerie Vandal", "Divination"], ["Cyclops of One-Eyed Pass"]],
