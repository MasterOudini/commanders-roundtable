// `Burrowguard Mentor` - a static cdaCount
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BURROWGUARD_MENTOR } from '../../../data/fixtures/engineCards';
...
export const BURROWGUARD_MENTOR_SCRIPT: CardScript = {
  oracleId: BURROWGUARD_MENTOR.oracleId,
  name: BURROWGUARD_MENTOR.name,
  statics: [
    {
      abilityId: 'cda-1',
