// `Master's Rebuke` — Bite Down's exact printed text on a second oracle id
// (the third id of the family counting Hard-Hitting Question): the one-way
// bite with the biter's own derived riders. D224.

import { MASTER_S_REBUKE } from '../../../data/fixtures/engineCards';
...
export const MASTERS_REBUKE_SCRIPT: CardScript = {
  oracleId: MASTER_S_REBUKE.oracleId,
  name: MASTER_S_REBUKE.name,
  spell: {
    text: TEXT,
