// `Moonlit Lamenter` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MOONLIT_LAMENTER_SCRIPT } from './moonlitLamenter';
import { advanceUntil, deps, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import { derive } from '../../derive';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Moonlit Lamenter";
...
function pt(g: Game, id: InstanceId): [number | null, number | null] {
  const d = deps(createRegistry([MOONLIT_LAMENTER_SCRIPT]));
...
describe("Moonlit Lamenter", () => {
  ...
  test("{1}{W}, Remove a counter from this creature: a card is drawn", () => {
