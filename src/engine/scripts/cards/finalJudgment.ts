...
const TEXT = printed(FINAL_JUDGMENT, 'Exile all creatures.');

export const FINAL_JUDGMENT_SCRIPT: CardScript = {
  oracleId: FINAL_JUDGMENT.oracleId,
  name: FINAL_JUDGMENT.name,
  spell: {
    text: TEXT,
