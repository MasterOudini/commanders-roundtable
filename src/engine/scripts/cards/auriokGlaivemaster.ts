// `Auriok Glaivemaster` - a conditional static (as long as this creature is equipped) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { AURIOK_GLAIVEMASTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(AURIOK_GLAIVEMASTER, "As long as this creature is equipped, it gets +1/+1 and has first strike.");
...
export const AURIOK_GLAIVEMASTER_SCRIPT: CardScript = {
  oracleId: AURIOK_GLAIVEMASTER.oracleId,
  name: AURIOK_GLAIVEMASTER.name,
  statics: [
    {
