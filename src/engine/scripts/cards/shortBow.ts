// `Short Bow` - an Equipment: the equipped creature gets +1/+1 and has vigilance, reach.
...
import { SHORT_BOW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHORT_BOW, "Equipped creature gets +1/+1 and has vigilance and reach.\nEquip {1} ({1}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const SHORT_BOW_SCRIPT: CardScript = {
  oracleId: SHORT_BOW.oracleId,
  name: SHORT_BOW.name,
  statics: [
    {
