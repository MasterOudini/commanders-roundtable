// `Nebula Dragon` - a etb trigger damageTarget
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { NEBULA_DRAGON } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(NEBULA_DRAGON, "Flying\nWhen this creature enters, it deals 3 damage to any target.");
const LINES = PRINTED.split('\n');

export const NEBULA_DRAGON_SCRIPT: CardScript = {
  oracleId: NEBULA_DRAGON.oracleId,
  name: NEBULA_DRAGON.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Nebula Dragon - damageTarget",
