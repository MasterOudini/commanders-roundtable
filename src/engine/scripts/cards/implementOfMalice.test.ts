// `Implement of Malice` - every printed ability proven in its own game: the cost's mark, the pump
...
import { IMPLEMENT_OF_MALICE_SCRIPT } from './implementOfMalice';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Implement of Malice";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Implement of Malice", "Grizzly Bears"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([IMPLEMENT_OF_MALICE_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Implement of Malice", () => {
  test("{B}, Sacrifice this artifact: the vocabulary resolves \"Target player discards a card.\"", () => {
