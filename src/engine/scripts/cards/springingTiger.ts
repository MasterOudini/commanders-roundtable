// `Springing Tiger` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SPRINGING_TIGER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPRINGING_TIGER, "Threshold — This creature gets +2/+2 as long as there are seven or more cards in your graveyard.");
...
export const SPRINGING_TIGER_SCRIPT: CardScript = {
  oracleId: SPRINGING_TIGER.oracleId,
  name: SPRINGING_TIGER.name,
  statics: [
    {
