// `Werefox Bodyguard` - every printed ability proven in its own game: the cost's mark, the pump
...
import { WEREFOX_BODYGUARD_SCRIPT } from './werefoxBodyguard';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Werefox Bodyguard";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Werefox Bodyguard"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([WEREFOX_BODYGUARD_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Werefox Bodyguard", () => {
  test("When this creature enters: the vocabulary resolves \"Exile up to one other target non-Fox creature until this creature leaves the battlefield.\"", () => {
  ...
  test("{1}{W}, Sacrifice this creature: 2 life is gained", () => {
