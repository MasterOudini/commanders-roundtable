// `Seraphic Steed` - a attacksWhileSaddled trigger token
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SERAPHIC_STEED } from '../../../data/fixtures/engineCards';
