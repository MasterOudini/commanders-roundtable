// `Witty Roastmaster` - a anotherCreatureEnters trigger damageOpponents
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WITTY_ROASTMASTER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WITTY_ROASTMASTER, "Alliance — Whenever another creature you control enters, this creature deals 1 damage to each opponent.");

export const WITTY_ROASTMASTER_SCRIPT: CardScript = {
  oracleId: WITTY_ROASTMASTER.oracleId,
  name: WITTY_ROASTMASTER.name,
  triggers: [
    {
      ...
      label: () => "Witty Roastmaster - damageOpponents",
