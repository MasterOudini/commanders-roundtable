// `Sea Monster` - every printed ability proven in its own game: the cost's mark, the pump
...
import { SEA_MONSTER_SCRIPT } from './seaMonster';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Sea Monster";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Sea Monster", "Grizzly Bears"], ["Cyclops of One-Eyed Pass", "Island"]],
