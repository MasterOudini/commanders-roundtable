// `Horizon of Progress` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Horizon of Progress", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([HORIZON_OF_PROGRESS_SCRIPT]),
...
describe("Horizon of Progress", () => {
  test("{3}, {T}: the vocabulary resolves \"You may put a land card from your hand onto the battlefield tapped.\"", () => {
  ...
  test("{1}, {T}, Sacrifice this land: a card is drawn", () => {
