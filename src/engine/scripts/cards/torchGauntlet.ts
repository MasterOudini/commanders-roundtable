// `Torch Gauntlet` - an Equipment: the equipped creature gets +2/+0.
...
import { TORCH_GAUNTLET } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TORCH_GAUNTLET, "Equipped creature gets +2/+0.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const TORCH_GAUNTLET_SCRIPT: CardScript = {
  oracleId: TORCH_GAUNTLET.oracleId,
  name: TORCH_GAUNTLET.name,
  statics: [
    {
