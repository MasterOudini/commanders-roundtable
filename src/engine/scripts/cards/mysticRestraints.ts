// `Mystic Restraints` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { MYSTIC_RESTRAINTS } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MYSTIC_RESTRAINTS, "Flash\nEnchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const MYSTIC_RESTRAINTS_SCRIPT: CardScript = {
  oracleId: MYSTIC_RESTRAINTS.oracleId,
  name: MYSTIC_RESTRAINTS.name,
  triggers: [
    {
      abilityId: 'etb-2',
      ...
      label: () => "Mystic Restraints - tapAttached",
