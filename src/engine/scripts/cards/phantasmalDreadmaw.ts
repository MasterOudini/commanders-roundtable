// `Phantasmal Dreadmaw` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PHANTASMAL_DREADMAW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PHANTASMAL_DREADMAW, "Trample\nWhen this creature becomes the target of a spell or ability, sacrifice it.");
const LINES = PRINTED.split('\n');

export const PHANTASMAL_DREADMAW_SCRIPT: CardScript = {
  oracleId: PHANTASMAL_DREADMAW.oracleId,
  name: PHANTASMAL_DREADMAW.name,
  triggers: [
    {
      ...
      label: () => "Phantasmal Dreadmaw - sacrificeSelf",
