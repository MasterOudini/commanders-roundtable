// `Crossroads Watcher` - a anotherCreatureEnters trigger pumping itself
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CROSSROADS_WATCHER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(CROSSROADS_WATCHER, "Trample\nWhenever another creature you control enters, this creature gets +1/+0 until end of turn.");
const LINES = PRINTED.split('\n');

export const CROSSROADS_WATCHER_SCRIPT: CardScript = {
  oracleId: CROSSROADS_WATCHER.oracleId,
  name: CROSSROADS_WATCHER.name,
  triggers: [
    {
      ...
      label: () => "Crossroads Watcher - it pumped until end of turn",
