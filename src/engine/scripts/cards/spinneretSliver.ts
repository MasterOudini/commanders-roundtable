// `Spinneret Sliver` - a layer-6 grant: "All Sliver creatures have reach". A StaticDef in the shape of the
...
import { SPINNERET_SLIVER } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SPINNERET_SLIVER, "All Sliver creatures have reach.");
const TEXT = PRINTED;

export const SPINNERET_SLIVER_SCRIPT: CardScript = {
  oracleId: SPINNERET_SLIVER.oracleId,
  name: SPINNERET_SLIVER.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
