// `Zephid's Embrace` - an Aura (Enchant creature): the enchanted creature gets +2/+2 and has flying, shroud.
...
import { ZEPHID_S_EMBRACE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(ZEPHID_S_EMBRACE, "Enchant creature\nEnchanted creature gets +2/+2 and has flying and shroud. (It can't be the target of spells or abilities.)");
const LINES = PRINTED.split('\n');

export const ZEPHIDS_EMBRACE_SCRIPT: CardScript = {
  oracleId: ZEPHID_S_EMBRACE.oracleId,
  name: ZEPHID_S_EMBRACE.name,
  statics: [
    {
