// `Ticking Gnomes` - every printed ability proven in its own game: the cost's mark, the pump
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Ticking Gnomes", "Forest", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([TICKING_GNOMES_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Ticking Gnomes", () => {
  test("Sacrifice this creature: it deals 1 damage to the declared creature", () => {
