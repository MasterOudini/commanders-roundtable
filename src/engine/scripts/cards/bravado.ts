// `Bravado` - a VARIABLE PUMP (D386): the delta is COUNTED at each derive
...
import { BRAVADO } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BRAVADO, "Enchant creature\nEnchanted creature gets +1/+1 for each other creature you control.");
...
export const BRAVADO_SCRIPT: CardScript = {
  oracleId: BRAVADO.oracleId,
  name: BRAVADO.name,
  statics: [
    {
      abilityId: 'pump-1',
