// `Pterodon Knight` - a conditional static (as long as you control a Dinosaur) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { PTERODON_KNIGHT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(PTERODON_KNIGHT, "This creature has flying as long as you control a Dinosaur.");
...
export const PTERODON_KNIGHT_SCRIPT: CardScript = {
  oracleId: PTERODON_KNIGHT.oracleId,
  name: PTERODON_KNIGHT.name,
  statics: [
    {
