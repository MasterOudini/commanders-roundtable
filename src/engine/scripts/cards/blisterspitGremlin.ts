// `Blisterspit Gremlin` - an activation damageOpponents, a castNoncreature trigger untapSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLISTERSPIT_GREMLIN } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(BLISTERSPIT_GREMLIN, "{1}, {T}: This creature deals 1 damage to each opponent.\nWhenever you cast a noncreature spell, untap this creature.");
const LINES = PRINTED.split('\n');

export const BLISTERSPIT_GREMLIN_SCRIPT: CardScript = {
  oracleId: BLISTERSPIT_GREMLIN.oracleId,
  name: BLISTERSPIT_GREMLIN.name,
  activated: [
    {
      ref: `${BLISTERSPIT_GREMLIN.oracleId}#a0`,
  ...
  triggers: [
    {
      ...
      label: () => "Blisterspit Gremlin - untapSelf",
