// `Wild Nacatl` - a conditional static (as long as you control a Mountain) threshold, a conditional static (as long as you control a Plains) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WILD_NACATL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(WILD_NACATL, "This creature gets +1/+1 as long as you control a Mountain.\nThis creature gets +1/+1 as long as you control a Plains.");
...
export const WILD_NACATL_SCRIPT: CardScript = {
  oracleId: WILD_NACATL.oracleId,
  name: WILD_NACATL.name,
  statics: [
    {
