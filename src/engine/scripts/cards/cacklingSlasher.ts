// `Cackling Slasher` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { CACKLING_SLASHER } from '../../../data/fixtures/engineCards';
...
export const CACKLING_SLASHER_SCRIPT: CardScript = {
  oracleId: CACKLING_SLASHER.oracleId,
  name: CACKLING_SLASHER.name,
  replacements: [
    {
