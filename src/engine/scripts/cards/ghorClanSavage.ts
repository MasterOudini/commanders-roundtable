// `Ghor-Clan Savage` - a static entersWithCounters
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { GHOR_CLAN_SAVAGE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GHOR_CLAN_SAVAGE, "Bloodthirst 3 (If an opponent was dealt damage this turn, this creature enters with three +1/+1 counters on it.)");
...
export const GHOR_CLAN_SAVAGE_SCRIPT: CardScript = {
  oracleId: GHOR_CLAN_SAVAGE.oracleId,
  name: GHOR_CLAN_SAVAGE.name,
  replacements: [
    {
