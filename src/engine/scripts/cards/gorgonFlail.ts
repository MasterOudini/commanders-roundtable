// `Gorgon Flail` - an Equipment: the equipped creature gets +1/+1 and has deathtouch.
...
import { GORGON_FLAIL } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GORGON_FLAIL, "Equipped creature gets +1/+1 and has deathtouch. (Any amount of damage it deals to a creature is enough to destroy that creature.)\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const GORGON_FLAIL_SCRIPT: CardScript = {
  oracleId: GORGON_FLAIL.oracleId,
  name: GORGON_FLAIL.name,
  statics: [
    {
