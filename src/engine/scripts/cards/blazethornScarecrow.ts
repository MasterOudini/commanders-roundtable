// `Blazethorn Scarecrow` - a conditional static (as long as you control a red creature) threshold, a conditional static (as long as you control a green creature) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { BLAZETHORN_SCARECROW } from '../../../data/fixtures/engineCards';
...
export const BLAZETHORN_SCARECROW_SCRIPT: CardScript = {
  oracleId: BLAZETHORN_SCARECROW.oracleId,
  name: BLAZETHORN_SCARECROW.name,
  statics: [
    {
