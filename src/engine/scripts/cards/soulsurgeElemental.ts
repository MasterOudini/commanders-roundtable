// `Soulsurge Elemental` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SOULSURGE_ELEMENTAL } from '../../../data/fixtures/engineCards';
...
export const SOULSURGE_ELEMENTAL_SCRIPT: CardScript = {
  oracleId: SOULSURGE_ELEMENTAL.oracleId,
  name: SOULSURGE_ELEMENTAL.name,
  statics: [
    {
      abilityId: 'cda-1',
