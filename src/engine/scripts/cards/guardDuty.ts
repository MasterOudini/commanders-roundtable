// `Guard Duty` - an Aura (Enchant creature): the enchanted creature has defender.
...
import { GUARD_DUTY } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(GUARD_DUTY, "Enchant creature\nEnchanted creature has defender.");
const LINES = PRINTED.split('\n');

export const GUARD_DUTY_SCRIPT: CardScript = {
  oracleId: GUARD_DUTY.oracleId,
  name: GUARD_DUTY.name,
  statics: [
    {
