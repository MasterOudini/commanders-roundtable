// `Marauder's Axe` - an Equipment: the equipped creature gets +2/+0.
...
import { MARAUDER_S_AXE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(MARAUDER_S_AXE, "Equipped creature gets +2/+0.\nEquip {2} ({2}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const MARAUDERS_AXE_SCRIPT: CardScript = {
  oracleId: MARAUDER_S_AXE.oracleId,
  name: MARAUDER_S_AXE.name,
  statics: [
    {
