// `Street Riot` - a conditional static (as long as it's your turn) anthem
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STREET_RIOT } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STREET_RIOT, "During your turn, creatures you control get +1/+0 and have trample.");
...
export const STREET_RIOT_SCRIPT: CardScript = {
  oracleId: STREET_RIOT.oracleId,
  name: STREET_RIOT.name,
  statics: [
    {
