// `Serra's Blessing` - a layer-6 grant: "Creatures you control have vigilance. (Attacking doesn't cause them to tap.)". A StaticDef in the shape of the
...
import { SERRA_S_BLESSING } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SERRA_S_BLESSING, "Creatures you control have vigilance. (Attacking doesn't cause them to tap.)");
const TEXT = PRINTED;

export const SERRAS_BLESSING_SCRIPT: CardScript = {
  oracleId: SERRA_S_BLESSING.oracleId,
  name: SERRA_S_BLESSING.name,
  statics: [
    {
      abilityId: 'grant',
      text: TEXT,
