// `Shuko` - an Equipment: the equipped creature gets +1/+0.
...
import { SHUKO } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(SHUKO, "Equipped creature gets +1/+0.\nEquip {0} ({0}: Attach to target creature you control. Equip only as a sorcery.)");
const LINES = PRINTED.split('\n');

export const SHUKO_SCRIPT: CardScript = {
  oracleId: SHUKO.oracleId,
  name: SHUKO.name,
  statics: [
    {
