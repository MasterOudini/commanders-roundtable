// `Starlight Snare` - a etb trigger tapAttached, a static attachedNoUntap
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { STARLIGHT_SNARE } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(STARLIGHT_SNARE, "Enchant creature\nWhen this Aura enters, tap enchanted creature.\nEnchanted creature doesn't untap during its controller's untap step.");
const LINES = PRINTED.split('\n');

export const STARLIGHT_SNARE_SCRIPT: CardScript = {
  oracleId: STARLIGHT_SNARE.oracleId,
  name: STARLIGHT_SNARE.name,
  triggers: [
    {
      abilityId: 'etb-1',
      ...
      label: () => "Starlight Snare - tapAttached",
