// `Sumala Rumblers` - a static cdaPower
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { SUMALA_RUMBLERS } from '../../../data/fixtures/engineCards';
...
export const SUMALA_RUMBLERS_SCRIPT: CardScript = {
  oracleId: SUMALA_RUMBLERS.oracleId,
  name: SUMALA_RUMBLERS.name,
  statics: [
    {
      abilityId: 'cda-0',
