// `Molting Harpy` - every printed ability proven in its own game: the cost's mark, the pump
...
import { MOLTING_HARPY_SCRIPT } from './moltingHarpy';
import { advanceUntil, holdEverywhere, must, put, startedGame } from '../../testing/harness';
import type { Game } from '../../game';
import type { InstanceId } from '../../types/ids';

const CARD = "Molting Harpy";
...
function armed(which: number): Armed {
  const g = startedGame({
    players: 2,
    decks: [["Molting Harpy", "Forest", "Forest"], ["Cyclops of One-Eyed Pass"]],
    scripts: createRegistry([MOLTING_HARPY_SCRIPT]),
  });
  holdEverywhere(g);
...
describe("Molting Harpy", () => {
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {2}.\" - the price is declined", () => {
  ...
  test("At the beginning of your upkeep: the vocabulary resolves \"Sacrifice this creature unless you pay {2}.\" - the price is paid", () => {
