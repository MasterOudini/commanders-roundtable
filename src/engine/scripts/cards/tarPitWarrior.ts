// `Tar Pit Warrior` - a becomesTargeted trigger sacrificeSelf
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { TAR_PIT_WARRIOR } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(TAR_PIT_WARRIOR, "When this creature becomes the target of a spell or ability, sacrifice it.");

export const TAR_PIT_WARRIOR_SCRIPT: CardScript = {
  oracleId: TAR_PIT_WARRIOR.oracleId,
  name: TAR_PIT_WARRIOR.name,
  triggers: [
    {
      ...
      label: () => "Tar Pit Warrior - sacrificeSelf",
