// `Thornwatch Scarecrow` - a conditional static (as long as you control a green creature) threshold, a conditional static (as long as you control a white creature) threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { THORNWATCH_SCARECROW } from '../../../data/fixtures/engineCards';
...
const PRINTED = printed(THORNWATCH_SCARECROW, "This creature has wither as long as you control a green creature. (It deals damage to creatures in the form of -1/-1 counters.)\nThis creature has vigilance as long as you control a white creature.");
const LINES = PRINTED.split('\n');

// "as long as you control a green creature" - read off the state, the PRINTED faces, the turn record, the life totals and the live combat; never derived (D317, D398).
...
export const THORNWATCH_SCARECROW_SCRIPT: CardScript = {
  oracleId: THORNWATCH_SCARECROW.oracleId,
  name: THORNWATCH_SCARECROW.name,
  statics: [
    {
