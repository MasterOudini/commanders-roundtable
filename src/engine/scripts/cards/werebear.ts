// `Werebear` - a static threshold
// until end of turn where it pumps (D194's carrier, D301). Generated from one table row.

import { WEREBEAR } from '../../../data/fixtures/engineCards';
...
export const WEREBEAR_SCRIPT: CardScript = {
  oracleId: WEREBEAR.oracleId,
  name: WEREBEAR.name,
  statics: [
    {
