...
function layerOne(inst: CardInstance, oracle: OracleDb): MutableCharacteristics {
  ...
  const printed: MutableCharacteristics = {
    ...
    // D489 - and one cast by the suspend tick (CR 702.62e).
    keywords: new Set<Keyword>(inst.riotHaste || inst.unearthed || inst.dashed || inst.suspendHaste ? [...face.keywords, 'haste'] : face.keywords),
