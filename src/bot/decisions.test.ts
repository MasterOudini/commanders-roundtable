...
function board(myLife = 40, theirLife = 40): PlayerView {
  return {
    ...
    seatOrder: [ME, FOE],
    seats: {
      [ME]: { playerId: ME, name: 'Me', life: myLife, cmdDamage: {}, poison: 0, energy: 0, ringTempts: 0, ringBearer: null, isMonarch: false, manaPool: {}, lost: false },
      [FOE]: { playerId: FOE, name: 'Foe', life: theirLife, cmdDamage: {}, poison: 0, energy: 0, ringTempts: 0, ringBearer: null, isMonarch: false, manaPool: {}, lost: false },
    },
    cards: {},
    zones: {},
    stack: [],
...
describe('reading the position', () => {
  ...
  test('a third player with a board is not cancelled out by a dead one', () => {
    ...
    view.seats['p3'] = { playerId: 'p3', name: 'Third', life: 40, cmdDamage: {}, poison: 0, energy: 0, ringTempts: 0, ringBearer: null, isMonarch: false, manaPool: {}, lost: false } as never;
